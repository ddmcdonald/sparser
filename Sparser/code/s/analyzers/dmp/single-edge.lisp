...
(defvar CATEGORY::CAPITALIZED)
(defvar CATEGORY::CAPITALIZED-SEQUENCE)
(defvar CATEGORY::CAPITALIZED-WORD)
(defvar CATEGORY::VERB+S)
(defvar CATEGORY::VERB+ED)
(defvar CATEGORY::VERB+ING)
(defvar CATEGORY::VERB+PRESENT)
(defvar CATEGORY::VERB+PASSIVE)
(defvar CATEGORY::INFINITIVE)
(defvar CATEGORY::MODAL)
(defvar CATEGORY::VG)
...
(defvar CATEGORY::NUMBER)
(defvar CATEGORY::NUMERATED-ANAPHOR)
(defvar WORD::|there|)
(defvar CATEGORY::VERB)
(defvar CATEGORY::VERB+S)
(defvar CATEGORY::VERB+ED)
...
(defvar CATEGORY::VG)
(defvar CATEGORY::NP)
(defvar CATEGORY::NP-HEAD)
(defvar CATEGORY::PROPER-NAME)
(defvar CATEGORY::PROPER-NOUN)
