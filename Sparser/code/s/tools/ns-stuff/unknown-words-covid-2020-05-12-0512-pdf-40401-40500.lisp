...
;; created 5/18/20 7:15:25

(in-package :sparser)

;; 3757 extracted as unknown bio-entity
...
("AAV" "ABCG" "ABG" "ACROS" "ADASYN" "ADMET" "AEAEAKAK" "AFB" "AGMP" "AGPT" "AICSEIR" "AIIR" "AIS"
 ...
 "BVDV" "BVV" "BWC" "CAAATGCCAGGAAAAGGA" "CACAUUG" "CASV" "CBRN" "CCDC" "CCTC" "CEPI"
 "CGAGGAATGGAAGTTGGA" "CGG" "CGP" "CHARMM" "CHEMSCORE" "CHR" "CHV" "CJEU" "CLL" "CLSI" "CLSM"
 "CLUSTAL" "COMZ" "COVID" "CSCORE" "CSFV" "CV" "CVFF" "CXR" "CZ" "DAA" "DAKO" "DC" "DENV" "DEPC"
 "DISCO" "DLIARAAKI" "DMEM" "DOAJ" "DSSP" "DTREK" "DWT" "ECMO" "ECR" "ECU" "EEA" "EFTA" "EGM" "EMG"
 "ENN" "EPL" "EQP" "ERRAT" "ESBL" "ESPEC" "EUR" "EV" "EVD" "EYFP" "FASTA" "FASTQ" "FBC" "FEBS"
 "FECV" "FFU" "FGI" "FGPRT" "FGPRTK" "FHV" "FIPV" "FIQ" "FKPB" "FLRGRAYGL" "FMC" "FMDV" "FNA"
 "FPKM" "FPLV" "FPV" "FUO" "GAE" "GDD" "GENOMICA" "GERF" "GG" "GGV" "GHP" "GIBCO" "GII" "GIRO"
 "GISAID" "GMS" "GP" "GPRTK" "GTFRCC" "HAART" "HBSS" "HBTU" "HCW" "HDXMS" "HETATM" "HFNC" "HFOV"
 "HIA" "HIVIG" "HKY" "HPU" "HTLV" "HTV" "HTVS" "HVAC" "IACUC" "IAV" "IBT" "IBV" "ICU" "IDEC" "IDEP"
 "IDRC" "IHME" "IJV" "ILT" "ILTV" "IMAGENET" "IMED" "IMOSFLM" "INNOVA" "IRB" "ISCOM" "ISI" "ISRCTN"
 "ISRE" "IVIG" "JBC" "JEV" "JHMV" "JMK" "JTG" "KFDA" "LACA" "LARIX" "LASV" "LDV" "LETRIST" "LGV"
 "LIGPLOT" "LIGSITE" "LIPS" "LITV" "LMIC" "LOE" "LPQ" "LSAM" "LTR" "LVF" "LVH" "MCB" "MCMV"
 "MEGAHIT" "MEM" "MEMS" "MEWS" "MHA" "MHN" "MHV" "MKE" "MMLV" "MODELLER" "MOI" "MOLCAD"
 "MOLPROBITY" "NAMD" "NAPDH" "NASBA" "NESARC" "NHNH" "NIDPOE" "NIOSH" "NIPD" "NL" "NMEDC" "NOAEL"
 "NORS" "NSH" "NVOC" "NVT" "NWAFU" "NZ" "OD" "OIE" "OMIM" "OQF" "PACER" "PBEQ" "PCLV" "PCO" "PD"
 "PF" "PGSI" "PHASER" "PHDTM" "PHENIX" "PICU" "PLV" "PMV" "POCT" "POINTLESS" "PRCV" "PROCGLM"
 "PROCHECK" "PROD" "PROSITE" "PRRS" "PRRSV" "PSϪ" "PVM" "QA" "QCMD" "QNAT" "QX" "QTL" "RANS"
 "RAPMAD" "RENN" "RFFIT" "RFLP" "RIFIN" "RIGE" "RLU" "RMSF" "ROSC" "RSPU" "RXXS" "SANCO" "SASRS"
 "SBVS" "SCVJ" "SDE" "SEAC" "SEPTEMBER" "SFM" "SFV" "SILI" "SMAP" "SMM" "SMOTE" "SNV" "SOGS"
 "SOIPPA" "SPECS" "SPMS" "SPSS" "SSDI" "STED" "STFT" "SUDV" "SVM" "SWEET" "SYBR" "SYLVIA" "SYSTAT"
 "SZ" "TAKARA" "TBARS" "TBST" "TCID" "TEV" "TFEU" "TFMK" "TGEV" "TIFP" "TMEV" "TNE" "TPSA" "TSB"
 "TTC" "TTCR" "TUNEL" "TURBO" "TWAR" "TWC" "TWH" "UA" "UCSF" "UFMG" "UN" "UNB" "UNF" "UNICZ" "USA"
 "UVGI" "VDJ" "VEE" "VG" "VGG" "VHF" "VJ" "VLSI" "VMRD" "VNA" "VNS" "VV" "WBC" "WFT" "WHU" "WOS"
 "WOSSVC" "WPT" "XIII" "XLSX" "XXIII" "XY" "YBJOM" "YM" "YOLO" "YPCP" "ZELTIA" "ZHWU" "CBER" "HTML"
 "IMMSIM" "§" "§DSD" "§DV" "À" "ÀNTSZ" "ÀTDS" "Â" "Ã" "Ò" "Ó" "Ϫ" "Ϯ" "Ͻ" "Ј" "К" "" "" "" ""
 "" "" "")))
    :test #'equalp))
...
(defparameter *All-Lower-Unknown-Words*
    (remove-duplicates
      (append 
         ...
         '(
("aardwolf" "abcdefg" "abortus" "absorbance" "absorber" "acquis" "acsnano" "acuminata" "additum"
 "adduct" "adeno" "adhatodifolia" "adolescents" "adoptees" "aduncum" "advisories" "aegypti"
 "aepypti" "aeruginosa" "affibody" "africanus" "aftershock" "airsacculitis" "ajustead" "albicans"
 "albopictus" "aleukia" "algal" "algorithm" "algorithms" "alia" "aliments" "alkanethiolate"
 "alkohollagen" "alkyl" "allo" "alloantigen" "allograft" "alloimmune" "alveoli" "amandatine"
 "ambisense" "aminosilane" "amphotericin" "amplicon" "amplicons" "analyser" "analyte" "anastomoses"
 "anerobes" "aneurysm" "aneurysms" "angiitis" "anhydride" "annulatus" "antacids" "antemortem"
 "anthracis" "anticcv" "anticfv" "antichick" "antifade" "antigenemia" "antigenome" "antiinfluenza"
 "antimicrobialresistant" "antiphosphotyrosine" "antirabbit" "antiwart" "api" "applet"
 "appropriateness" "aquires" "aranorosinol" "arbitrariness" "areal" "arenaviruslike" "arisen"
 "armamentarium" "arterivirus" "artifi" "arẽ" "aseptate" "aspartyl" "astrocyt" "atrium" "augmenter"
 "authorise" "autoclaves" "autoimmune" "autoradiography" "autoregulate" "avg" "avirus" "azar"
 "bacille" "bacithracine" "backfi" "bacteriuria" "bafilomycin" "barbershops" "barcode" "baselevel"
 "baumannii" "bbmap" "bbrc" "bc" "beautifulsoup" "begun" "behavenet" "belli" "benefi"
 ...
 "clinicians" "clinico" "clonotypes" "cnidarians" "cnpq" "coanswerers" "cocci" "coccobacilli"
 "coccobacillus" "coccus" "codon" "coevolves" "coiledcoils" "colectomy" "coli" "collectin"
 "colonleukemia" "colorant" "colostra" "colostrum" "commensals" "commonalities" "communautaire"
 "comorbidities" "compet" "competences" "compulsiveness" "concholepas" "confi" "conformers"
 ...
 "cryostat" "cryptococci" "crèches" "cs" "cules" "culicoides" "culties" "culty" "cuniculus"
 "currents" "cuvette" "cyan" "cyanobacteria" "cyclopentadiene" "cylindruria" "cytoarchitecture"
 "cytology" "cytometer" "cytosolnucleus" "dabcyl" "dangerousness" "dataframe" "deadenylases"
 "deconjugates" "deconvolute" "defg" "defgabc" "defi" "deformations" "degranulate" "denature"
 "dence" "densitometer" "der" "dermatitidis" "dermatophytes" "developmenta" "deviance" "dh"
 "diamino" "diaminobenzidine" "diarylquinoline" "diatheses" "diazobenzylidene" "dichroism"
 "dicobalt" "dideoxy" "dienes" "dienophile" "diethyl" "diffi" "difficile" "diffusers" "digitalis"
 "diglicydyl" "dihydrochloride" "diluents" "dimensionless" "dimethylindole" "dimethylsiloxane"
 "dinitrophenylpolymethylenediamine" "dinoflagellates" "diphenylphosphanyl" "diploids" "dipole"
 "disassemble" "discussants" "disinterest" "dispatchers" "dispersers" "dodecapeptide" "domstolen"
 "donovani" "doseeresponse" "doubleblind" "download" "drafters" "drawn" "droplet" "ds" "duce"
 "duodenalis" "duplexes" "dwarfism" "dyad" "dyslipidemia" "dyspnea" "dyspnoea" "dysthymia" "e"
 "ebolaviruses" "echinodermate" "ecohealth" "ectodomain" "edema" "edetate" "effi" "eg" "eigen"
 "eld" "electives" "electret" "electrets" "electro" "electromyography" "email" "emails" "embrapa"
 "encephalomyocarditis" "endnote" "endoribonucleases" "endoscopy" "endotypes" "enhancer"
 "enterococci" "entropy" "enzymology" "eosin" "eosinophilia" "epibromohydrin" "epidermidis"
 "epidermodysplasia" "epididymitis" "epithelium" "epizootiology" "epoxysuccinyl" "equi"
 "equidistance" "equipments" "ergot" "errorprone" "ery" "erythema" "espundia" "estabfish"
 "estimators" "et" "etc" "ethmoid" "ex" "excretors" "exh" "extremes" "extremum" "exudate"
 "exudates" "exurban" "facemasks" "facepiece" "facies" "facto" "fage" "falciparum" "fallouts"
 "fascicularis" "fauna" "feedings" "feelings" "ffectiveness" "ffu" "fi" "fl" "flavi" "flavus"
 "flew" "floatage" "flora" "floridae" "flowchart" "fluoresce" "fluoresces" "fluoroalkylsilane"
 "fluoromethyl" "fluoromodules" "fluorophore" "fomite" "foodborne" "footpads" "fora" "foragers"
 "forcefield" "fowleri" "frac" "fragilis" "frameshift" "frequen" "frozen" "frugivores" "fteen"
 "fulfi" "fulllength" "fulminant" "fumigatus" "functionall" "funder" "funders" "fundsto" "fungemia"
 "fuzziness" "g" "gallbladder" "ganciclovirresistant" "gasper" "gaspers" "gastro" "gegen"
 "gelatinlike" "gelatose" "gengivitis" "genogroup" "genome" "genomewide" "geojson" "geopandas"
 "germline" "gingivalis" "glabrata" "glomeruli" "glomerulosa" "glutaminyl" "glycobiology"
 "glycoconjugates" "glycomoieties" "glycosamine" "glycosciences" "glyoxyl" "glyoxylyl" "gnf"
 "gondii" "gone" "goods" "google" "graclus" "granulomas" "gravis" "grayscale" "groundglass"
 "guineapig" "gures" "hab" "habour" "haematobium" "haematocrit" "haematology" "haematoxilin"
 "haemolytica" "hages" "hairshafts" "haloketones" "handheld" "handtouch" "hanta" "hardline"
 "harmfulness" "heatmap" "hegemon" "helices" "helix" "helpline" "hematuria" "hemoabdomen"
 "heparinlike" "hepatica" "hepato" "heptad" "heteroatoms" "heterophils" "hexamer" "hidden"
 "highdose" "highthroughput" "hilar" "hile" "histolitica" "histology" "histolytica"
 "histopathology" "holdout" "hollows" "homemaker" "homepage" "hominis" "homogenates" "homologies"
 "homoplasy" "homotrimer" "hospitalwide" "hostvirus" "hoteli" "hotspots" "hse" "htm" "html" "http"
 "humanbat" "humanto" "humic" "hwe" "hyalinohyphomyces" "hybridise" "hydatid" "hydrazines"
 "hydrogels" "hydrolyzate" "hydroxydaunomycin" "hyopneumoniae" "hyper" "hyperbilirubinemia"
 "hypercube" "hyperimmune" "hyperproteinaemia" "hyperresponsiveness" "hypha" "hyphae"
 "hyponatraemia" "hyporesponsiveness" "hypovolaemia" "hypoxemia" "icddr" "icmje" "icterus" "iden"
 "identifi" "identifier" "ie" "iger" "igralnice" "ii" "imager" "imbalanceness" "imbalancess"
 "iminochromenes" "immitis" "immsim" "immuneresponse" "immunoassay" "immunocytochemistry"
 "immunodefi" "immunodominance" "immunodominant" "immunodominate" "immunohistochemistry"
 "immunohistology" "immunometabolism" "immunomodulant" "immunopathology" "immunophenotypes"
 "immunospot" "immunosurveillance" "impactful" "incarum" "inclusiveness" "incontact" "indepth"
 "inducers" "ine" "infectiousness" "infl" "influencers" "inhalents" "inhouse" "initializes"
 "inkjet" "inoculum" "inpatients" "insectivores" "insightful" "intensifi" "intercalate"
 "interchain" "intercluster" "interdependencies" "interferonalpha" "internet" "interquartile"
 "interrogans" "interspecies" "interviewees" "intestinalis" "intra" "intraand" "intrachain"
 "intracluster" "intranet" "intratumour" "invariant" "inverter" "iodate" "iodoacetamide" "ionic"
 "iruses" "islandwide" "iso" "isoenzyme" "isoenzymes" "isomer" "isothiazolones" "isotype"
 "israelii" "itive" "iudicata" "iv" "j" "japonicum" "javascript" "jejuni" "jhmi" "jiroveci"
 "jirovecii" "json" "jubatus" "juge" "justifi" "kala" "kansasii" "kappa" "kilobases" "kudus" "kw"
 "kway" "kzd" "kƒ" "l" "lactobacilli" "lambda" "lamblia" "lamellae" "landrace" "largescale"
 "lattes" "lavage" "layperson" "layprovider" "leadquest" "acdlabschem" "leans" "learnt" "lemmas"
 "leprae" "leucopenia" "lewisite" "libitum" "libyca" "licensure" "lifecycle" "lifespan"
 "likeliness" "limbus" "limulus" "lituratus" "lobar" "lockdown" "longipalpis" "lowand" "lowincome"
 "luminance" "luminol" "lymphadenopathy" "lymphoceles" "lymphocytopenia" "lymphopenia" "macbecin"
 "machin" "macranthera" "macroarray" "macrodomain" "macronucleolus" "macrop" "mallei"
 ...
 "panleukopenia" "papovaviruses" "paracrine" "paracrystalline" "parainfluenea" "parainfluenza"
 "parainfluenzae" "parainfluenzaviruses" "paraptosislike" "parasiticus" "parasitology"
 "parasitophorus" "pardus" "parenchyma" "parsers" "particulars" "particulate" "particulates"
 "partite" "parturitions" "parvo" "parvum" "passant" "pathlength" "pathobiology" "pathophysiology"
 "pdf" "pentaloop" "peptido" "peptoid" "peracute" "perfluorocarbon" "perfringens" "perhaps"
 "perihepatitis" "peritoneum" "periurban" "pers" "pestis" "peticheae" "phagy" "pharmacophore"
 "pharmacovigilance" "phenols" "phosphopeptide" "phospothreonine" "photolabile" "photophobia"
 "photoresistant" "phyla" "phyllostomid" "phylogeny" "phytohemagglutin" "pico" "picorna"
 "picornavirologists" "pinworm" "pipecolyl" "pixel" "plasmon" "pleuropneumoniae" "pneumococcus"
 "pneumology" "pointmutations" "pollinators" "polyacetate" "polydipsia" "polyethelyene"
 "polymorphism" "polymorphisms" "ponents" "pong" "posadasii" "posebnih" "positives" "positivesense"
 "postcontact" "postmortem" "posttransplant" "pp" "pre" "precancers" "precipitin" "precyst"
 "prefluorooctane" "preprint" "prese" "presets" "pretest" "pretransplant" "preuse" "prioritise"
 "prirejanje" "proand" "procalcitonin" "prodrome" "professionals" "profi" "progeny" "prostheses"
 "proteinprotein" "proteome" "protomer" "proven" "proventriculus" "pruritis" "pseudocapsule"
 "pseudocenter" "pseudocenters" "pseudocyst" "pseudohyphae" "pseudomallei" "psittaci"
 "psychopathology" "pulldown" "pulmonitis" "purifica" "purpuratus" "pvalue" "pvalues" "pyogenes"
 "pyrimidinone" "pyrocarbonate" "pyromania" "pyuria" "qualifi" "quantitate" "quasi" "quasispecies"
 "queenslandica" "quencher" "questionaire" "quicker" "quinolinones" "quo" "quotationsto" "ranksum"
 "rapporteur" "rarer" "ratifi" "rcsb" "readout" "reaffi" "realityand" "reassortant" "rebreather"
 "recentrifuge" "reclassifi" "recom" "reconfi" "redefi" "reencounter" "refl" "refractile"
 "reliever" "remdesiv" "remdisivir" "repellents" "reper" "replicate" "replicates" "replicon"
 "representativeness" "representatives" "repulsions" "rescore" "researchgate" "histo" "residuals"
 "respec" "responder" "resuh" "reticulum" "retro" "returnees" "reunifi" "reuse" "reveil"
 "rhinoconjunctivitis" "rhinorrhoea" "rhinotracheitis" "ribonucleases" "ricewater"
 "rinoconjunctivitis" "risen" "riskibenefit" "rm" "rmsd" "rnet" "rodlike" "rpm" "ruca" "saccha"
 "samplings" "satisfi" "scarse" "schistosome" "schistosomes" "scientifi" "scissors" "scopus"
 "scotland" "screenshot" "se" "seaborn" "secondbest" "secondround" "selfantigens" "selftissue"
 "selleckchem" "drugbank" "semi" "semiarid" "septae" "septate" "sequelae" "sero" "serogroups"
 "serology" "serotype" "serovars" "serratio" "serumfree" "sessile" "setttings" "sevenrow" "sh"
 "shedders" "shortcuts" "shrublands" "shutoff" "sialoglycans" "sidewalls" "signalto" "signifi"
 "silanols" "silico" "simplex" "simplifi" "sion" "siructures" "sive" "smartphones" "socio" "sof"
 "solids" "soln" "solute" "som" "somni" "sonography" "sorangicin" "spacefill" "spacer" "spacers"
 "specifi" "spectrometer" "spherule" "spherules" "spinulosa" "spongiform" "sporangiophore"
 "sporangium" "squares" "srečo" "stakeholders" "staphylococci" "stents" "stepdown" "stepwise"
 "stercoralis" "stereochemistry" "stereoisomer" "stereoisomers" "sterilise" "sterilizer"
 "stomachaches" "streetlamps" "stressful" "stressors" "stumarium" "subacute" "subclasses"
 "subdistrict" "subdomain" "subdominant" "subgenome" "subgraphs" "subordinates" "subpart"
 "subsample" "subsamples" "subsite" "substituents" "subtilis" "subtree" "subtype" "succes"
 "succinimidyl" "suffi" "suis" "sulfa" "sulfamethopyrazine" "sulfhydryl" "superfi" "superfl"
 "supergraph" "supergraphs" "superhelix" "supermix" "supernatant" "supernatants" "superpose"
 "superpositions" "symptomatology" "synchronise" "syndroms" "synthesise" "sytem" "tachypnea"
 "taken" "tani" "tari" "taxa" "teardrop" "techquines" "telemedicine" "temporise" "tenax" "tenderer"
 "teraflops" "termi" "testifi" "testings" "tetrahydrochloride" "tetrazolium" "thanadequate"
 "therapeuticallyimportant" "therapeuticallyrelevant" "thermo" "thermocouples" "thermocycler"
 "thermoset" "threadworm" "threequarters" "thrombi" "timeframe" "timelines" "tion" "titer" "titers"
 "titrates" "titre" "titres" "tjhe" "tly" "tmc" "tohuman" "toire" "toluenesulfonylhydrazone"
 "tomentella" "tonsillectomy" "toolkits" "toperson" "topology" "torovirus" "tosyl" "tracheostomy"
 "tracheotomy" "trachomatis" "transcriptases" "transcriptome" "transducer" "transfectant"
 "transfrags" "translocon" "transmittance" "transwell" "trematodes" "triage" "trichodysplasia"
 "trichomonad" "trichrome" "trifluoroacetaldehyde" "trifluoroamine"
 ...
 "undefi" "undergoes" "undergone" "understandings" "undertaken" "ungulate" "uniprot" "unjustifi"
 "unmet" "uous" "upwind" "ureter" "uretupamine" "uridines" "uridylyltransferases" "urochordate"
 ...
 "written" "www" "x" "xed" "yl" "ym" "ys" "ysis" "zona" "zoonoses" "zscore" "zygomycetes"
 "zygospores" "¢cv" "§" "§k" "þ" "ƒ" "ϩ" "ϫ" "ϭ" "ϳ" "" "" "" "" "" "" "")))
    :test #'equalp))
...
("ACATs" "ADRs" "ATGs" "Accelrys" "Acinonyx" "Additiona" "Aedes" "Affymetrix" "Aga" "Akaike"
 ...
 "BigDye" "Billerica" "Bimixin" "Binde" "BioEdit" "BioID" "Bioanalyzer" "Biochem" "Biochemi"
 "Bioedit" "Biogen" "Biosearch" "Biosystems" "Biotec" "Biotech" "Biotecnica" "Blastomyces"
 "Blaszczynski" "Bloomberg" "Bloth" "Bn" "Bondolfi" "Bonferroni" "Bordet" "Borsari" "Borsos"
 "Bossaert" "Bouin" "Bowtie" "Brasil" "Breda" "Bristol" "Brönstrup" "Bu" "Buckinghamshire" "Buffy"
 "Bundesminister" "Burban" "Burlingame" "Böttiger" "CAdV" "CDCl" "CGenFF" "COVIDx" "COVNet" "CRoV"
 "Caenorhabditis" "Caffrey" "Calabria" "Caliper" "Cameroun" "Campylobacterjejuni" "Canis" "Cannel"
 "Capellagutiérrez" "Capucci" "Cardiol" "Carlsbad" "Carrington" "Cary" "Casa" "Castren"
 "Caucasians" "Ccentroid" "Cefamezin" "Cefazoline" "CellTrace" "Centro" "Ceva" "Changde"
 "Changzhou" "Charoen" "ChemScore" "ChemiDoc" "Chemicon" "Christenson" "Chromatograms" "Cifone"
 "Cilicytophthoria" "Ciliophora" "Clarifi" "Clayton" "Clinicaltrials" "Clonorchis" "Clontech"
 "Coccidioides" "Cochrane" "Collierville" "Colomer" "ColorTanimoto" "Colquhoun" "Columbia"
 "Comitato" "Commonalities" "Commons" "Conway" "Coomassie" "Coombs" "Corallus" "Coronaviridiae"
 "Corp" "Covance" "Covid" "CrCl" "Crawley" "Creole" "Crimea" "Crocuta" "Crohn" "Cryptococci"
 "Cuffcompare" "Cuffdiff" "Cufflinks" "Cuffmerge" "DALYs" "DEDƒ" "DMCs" "DMVs" "Dahl" "Dako"
 "Dallas" "Dalles" "Danzen" "DarkNet" "Darmstadt" "Darwin" "Dbf" "Deborah" "DelPhi" "Delaunay"
 "Delmarva" "Derevensky" "Deutsche" "Deutscher" "Dextra" "Dickinger" "Dickinson" "Dimorphism"
 "Dirichlet" "Disley" "DocMorris" "Doremalen" "Dowler" "Dreher" "Drezner" "DrugBank" "Dstl"
 ...
 "Emerg" "Emil" "Endsome" "Engdahl" "EpiFlu" "EpiFluTM" "EpiInfo" "Epistemology" "Eq" "Erika"
 "Ernst" "Etico" "Euclidean" "Europeans" "FACScanTM" "FFRs" "FIas" "Fabricius" "Facepiece"
 "Factortame" "Fasciolopis" "Fc" "FeLV" "Felis" "Fermentas" "Ferrero" "FiO" "Ficus" "Finanzen"
 "Finetek" "Finnzymes" "Firenze" "Fitch" "Fite" "Fleischhackl" "Fleischman" "FluView" "Foitik"
 "Folke" "Folketinget" "Folorgi" "Formulatrix" "Forschungsgemeinschaft" "Fourier" "Fridays" "Frio"
 "Fudan" "FuzCav" "Förster" "GCPs" "GHz" "Gambelli" "Gambino" "GamblingCompliance" "GdnHCl"
 "GenBank" "Geneva" "Genewiz" "Gensim" "Gerais" "Gerdin" "Gerstein" "GetCleft" "Gibco" "Giemsa"
 "Gieson" "Giessen" "Gießen" "Gilbertsville" "Gilead" "Giovannni" "GitHub" "Giudici"
 "GlaxoSmithKline" "GloGerm" "Globo" "Glostrup" "Gluteraldehyde" "Glycosciences" "GmbH" "Goethe"
 "Goffe" "Gorica" "Goteborg" "Gouy" "GpppN" "Graclus" "Graecia" "Grande" "Greek" "Greenmonkey"
 "Groeneveld" "Grosso" "Gruinard" "Grâce" "Guangdong" "Guizhou" "Gulmann" "Gunnels" "Göritz"
 "HBGAs" "HCWs" "HKs" "HMMs" "Haemogogus" "Harbin" "Harvard" "Hawan" "Hcensure" "Heilongjiang"
 "Helena" "Hellabrunn" "Hendra" "Hepeviridae" "Hercules" "Hereford" "Hereon" "Herlitz" "Hesperia"
 "Hessen" "HiSeq" "Hialeah" "Highflow" "Hippocrates" "Histology" "Hochfeld" "Hofma" "Hollywood"
 "Holstein" "Holte" "Hopkins" "Horne" "Houston" "Huanan" "Huayitong" "Huisgen" "Hummeler" "Hz"
 "Högsta" "Höner" "Højesteret" "ICFl" "IFNwas" "Ibaraki" "IgOme" "Illumina" "ImageJ" "ImageLab"
 "ImageNet" "Imager" "Immun" "ImmunoResearch" "Immunologicals" "InVivoMAb" "Indies" "Ingelvac"
 "InsightII" "Intel" "InterPro" "InterProScan" "Internet" "Intervet" "Invariant" "Ipswich"
 "Irkutsky" "Irvine" "Isaac" "Isando" "IsoMIF" "Isoenzyme" "Istituto" "Jacobi" "Jak" "Jalview"
 "Janeiro" "Jeddah" "Jena" "Jermann" "JetPRIME" "Jiangsu" "Jizan" "Jochen" "Johns" "Jorgenson"
 "Josepth" "Justitie" "Kaggle" "Kahnawake" "Kalahari" "Kallick" "KanI" "Kaohsiung" "Kaposi" "Keane"
 "Kerlero" "Khomas" "Kinbaid" "KinetAsyst" "Kinyoun" "Kleczkowski" "Koguchi" "Kollmann"
 "Konzessionen" "Kremlin" "Krumnow" "Kruuk" "Kuisma" "Kupffer" "Kuppeveld" "Kyron" "Köhler"
 "LCMVimmune" "LFTs" "LMICs" "LabChip" "LabTech" "Lachmann" "Lactobacillis" "Ladbrokes" "Laemmli"
 "Lambda" "Landesgericht" "Lasergene" "Latin" "Laveran" "Leerformel" "Leibniz" "Leiden" "Lemma"
 "Leondina" "LightCycler" "Lindman" "Linux" "Linz" "Lippert" "Liverpool" "Loeffler" "LogP"
 ...
 "Melinda" "Mellivora" "Mengozzi" "Merck" "Merkel" "Merler" "Mesoniviridae" "Messerli" "MetY"
 "MetYPCP" "MgCl" "MgSO" "Micronesia" "Microplate" "Microsystems" "Millipore" "Miltenyi" "Miltex"
 "Minas" "Mirri" "Mitterrand" "Mitutuyo" "MoMLV" "Mohawk" "Molbiol" "Moloney" "Molossidae"
 "Moneghan" "Montanide" "Moreoever" "Mormoopidae" "Mucoraceae" "Muench" "Multilabel" "Multiorgan"
 "Multisearch" "Muraoka" "Mx" "Myotis" "México" "NNRTIs" "NaClO" "NaHCO" "NaIO" "NaKtide"
 "Nafziger" "NanoChip" "Naperville" "Nationale" "Neighbots" "Nemerof" "Neurobiologists" "Nevadans"
 "Newcastle" "Nexaband" "Nidovirales" "Nisonoff" "Nobel" "Noctilionidae" "Noelken" "Nonhuman"
 "Norcross" "Norsk" "Northampton" "Norwalk" "Novartis" "Novato" "Novoprotein" "Nuremberg"
 "ORFfinder" "Ohishi" "Ohta" "Olmstead" "Olympus" "Omniscript" "Oncology" "Onderstepoort"
 "Onnuriplan" "Onoue" "Oosten" "OpenEye" "Orford" "OriginLab" "Orthohepevirus" "Osaka" "Oslo"
 "OtBu" "Otocyon" "Ottingham" "PBSncRNA" "PGDs" "PLpros" "PMScoremax" "PMScoremin" "PMVc" "PReLU"
 "PRoV" "PSs" "PaCO" "Pairwise" "Pakistanis" "Palazzese" "Panthera" "Papanikolaou"
 "Papillomaviridae" "Paracoccidioides" "Paragonimus" "Paranitrophenyl" "Paraná" "Parasitology"
 "Parke" "Parkinson" "Peberdy" "Peclet" "Penghu" "Pentatrichomonas" "PeproTech" "Perceptrons"
 "Pergamene" "PerkinElmer" "Petaluma" "Peyer" "Pfizer" "Pfx" "Ph" "PhCH" "Pharmacia" "Phaseolus"
 "Phaser" "Phenom" "Phyllostomidae" "Piceno" "Pichinde" "Pico" "Piscataway" "Pittsburgh"
 "Placanica" "Plainfield" "Platyrrhinus" "Plymouth" "PneumoVir" "PocketMatch" "Poisson" "Polynesia"
 "Polyplus" "Ponceau" "Porartevirus" "Porton" "Portuguesa" "PowerUp" "Pradesh" "Prasad" "Prehosp"
 "Pretoria" "PrimeScript" "Primescript" "ProSA" "Promega" "Prostat" "Proteles" "Proteolipid"
 "Psittaciformes" "Psychiatrica" "Psyclub" "PtO" "Pteropus" "Puissochet" "Purdue" "PyVAN"
 "Pyrrolopyrimidines" "Qantas" "QuantStudio" "Questore" "RNAirestrictions" "RNAisuppressors"
 "RNeasy" "Radiopedia" "Rajbari" "Rajneesh" "Raney" "Rangpur" "Raybiotech" "Rebiopsy" "Rechallenge"
 "Recife" "Regione" "Rehm" "Rellina" "Reminade" "Renilla" "RespPRRS" "Reticulum" "Rhinolophus"
 "Rockford" "Rockland" "Rome" "Rosbo" "Rosengren" "Rourke" "Routledge" "Rubitecan" "SNVs" "SOCl"
 "SaO" "Sakura" "Salud" "Sanabandine" "Sandton" "Sanofi" "Saturdays" "Saudi" "Sayre" "Scandinavica"
 "Schiemann" "Schott" "Schrödinger" "Schubach" "Schweizer" "Scopus" "Seeis" "Sehra" "Semliki"
 "Sendai" "Sensorgrams" "Septata" "Sezione" "Shaanxi" "ShapeTanimoto" "Shaper" "Sheater" "Shenzen"
 "Shiga" "Shizuo" "Shochat" "Shree" "Sicilia" "Sidaks" "SimPlot" "Simplot" "Sindbis" "Sirel"
 "SiteAlign" "SiteHopper" "SiteID" "Sjöberg" "Skagit" "Skarr" "SlowFade" "Snock" "SoND" "Solange"
 "Sonderweg" "Sorricchio" "Sorvall" "Sota" "Spearman" "Sperimentale" "Spicoli" "Springfi" "SrrB"
 "Stachybotrys" "Staudinger" "Sthik" "Stoss" "Strasbourg" "Stuttgart" "Sul" "SuperBright"
 "SuperPose" "Superscript" "Supp" "Suppl" "Surg" "Susumu" "Svehag" "Sverdlovsk" "SwaI" "SwissADME"
 "Sybr" "Sydnes" "Syndrom" "Systembolaget" "São" "TAAs" "TFMKs" "TGFis" "Tadarida" "Taichung"
 "Takara" "Talampicillin" "Tangail" "Tanimoto" "Taq" "Teasdale" "Tensilon" "Terminalia" "Tester"
 "Theiler" "Thermo" "Thierer" "Thomson" "Toal" "Tocris" "Toledo" "TomekLink" "TomekLinks"
 "Tomlinson" "Tomohiko" "Tonegawa" "TopHat" "Toronto" "Torrance" "Torre" "Toyama" "TriPure"
 "Tribunale" "Trichotillomania" "Trojan" "TropNetEurope" "TruSeq" "Trypanosomatidae" "Tukey"
 ...
 "WCBs" "Waals" "Walmart" "Waltham" "Warburg" "Wardle" "Warthin" "Wassertheil" "Wavelet" "WeChat"
 "Weibel" "Weissenberg" "Wellcome" "Welle" "Wellesley" "Welte" "Wenchuan" "Westley" "WhatsApp"
 "Whitfield" "Wi" "Wilcoxon" "Wildy" "Willoughby" "Wilmington" "Witt" "Wittchen" "Wlodarczik"
 ...
 "Zooprofilattico" "Zuc" "Zurich" "Zygomycetes" "Zygomycota" "aIso" "advisabIe" "affiFAP"
 "BehaveNet" "bioMérieux" "Biosolids" "Botulinum" "cGPK" "Williamsburg" "chemicaI" "Concholepas"
 "cuVs" "diVerentiate" "diYculties" "eVect" "eVectiveness" "eYcacy" "foUovvr" "gBlock" "gG" "gIII"
 "hARF" "iE" "iQ" "inhibitoOO" "jQuery" "kNN" "Leadquest" "mMachine" "mMessage" "Maybridge"
 "miRISC" "minfDSD" "nRBCs" "ncvRNAs" "oBIFs" "oncomiR" "oncomiRs" "pBAC" "pCAGEN" "pETYycG"
 "pGARV" "pII" "pK" "pLysS" "pN" "pNaKtide" "pTXB" "permP" "piRISC" "rJHMV" "rProtein" "rRT"
 "repHcate" "ResearchGate" "scVI" "Selleckchem" "siRISC" "taniM" "taniMW" "taniNormNodes" "theYycG"
 "traYc" "uL" "UniProt" "usA" "vaHd" "vsRNA" "vsRNAs" "xRSx" "zDV" "Érika" "ÔminorÕ" "ÔmixedÕ"
 "ÔopenÕ" "Ömer" "ϩsgRNA" "ϩssRNA" "ϪsgRNA" "ϪsgRNAs" "Ϯstandard")))
    :test #'equalp))
...
("ALEXANDER" "Ababneh" "Abbott" "Abro" "Achiron" "Acree" "Adams" "Addie" "Adom" "Agusti" "Aharoni"
 ...
 "Lampo" "Lang" "Langrish" "Lanzavecchia" "Laporte" "Larman" "Laskowski" "Lassa" "Laura" "LeFevre"
 "Leahy" "Lehmer" "Lehner" "Lein" "Leroy" "Leung" "Levings" "Liebler" "Ligers" "Linde" "Lipinski"
 "Liu" "Lochmiller" "Lole" "Lorusso" "Louis" "Lowance" "Lozeron" "Luby" "Lucas" "Lucchinetti"
 "Lucio" "Ludwig" "Lugari" "Luis" "Lukk" "Lumsden" "Luo" "MOTT" "Macartney" "Macdonald" "Machamer"
 ...
 "Verheul" "Verçoza" "Viglietta" "Vilar" "Vilella" "Voss" "Vyas" "Wagner" "Walsh" "Warnecke"
...
("!1" "!3" "!5" "#1" "#11160" "#15}" "#16424" "#2" "#293-230" "#3" "#4" "#6" "#7" "#L8754" "&i"
 ...
 "-α-methyl-6-nitropiperonyloxycarbonyl" ". /2020" "./5300hab" "./7400" ".27 m/s" "//sray"
 "0-β-glucosid" "0.1 %Triton X-100" "0.14:0.34:0.43:0.09" "0.2 m/s" "0.350/p" "0.3e2" "0.5 m/s"
 "0.5ug/L" "0.6ºС" "0.734/p" "0006-291X/$" "01652427/95/" "04II" "055:B5" "0:75-quantile"
 "0oligoadenylates" "0·005" "0·20" "0·98" "1%-8%" "1,000+" "1,3,5-hydantoins" "1,3,5-triazines"
 "1,4-butanediol" "1,8-diamine-3,6-dioxaoctane" "1-nitro-2-phenylethane"
 ...
 "1/3" "1/8" "1/80" "1/p" "10,000g" "10.1038/srep11220" "10.1159/000503030" "100/" "1000g" "1000×g"
 "100°C" "100°C." "100°F" "101{125" "106°F" "10^" "10^^" "10a" "10b" "10e12" "10to" "11,42,80e85"
 "11-mercaptoundecyl-tri" "1101 /2020" "11a" "11g/dl" "12,000g" "12/15" "12/29,756" "125°C"
 "126{150" "129SvEv" "12:4-20" "13e15" "13mers" "14,69e74" "14/25" "148amino acid" "14a" "14b"
 "14c" "14d" "15-20-fold" "150.000/" "15e19" "15°C." "16,000×" "16,26,28e30,43"
 "16,27,31e34,39,41,43" "16,32e34" "16,43a" "16-mercaptoundecanoyl-NHS" "16/31" "16e18" "16hpi"
 "17 N95" "17Cl-1" "18b" "19.3°C." "1982a" "1982b" "1983a" "1983b" "1987a" "1989pg143" "1995a"
 "1999a" "1999b" "19e25" "19°C." "1:40-1:80" "1:l" "1BXD" "1cqq" "1E-1H" "1e10" "1e4" "1I-1L"
 "1KQR" "1L1N" "1lvo" "1p9s" "1p9t" "1p9u" "1pa5" "1page" "1q2w" "1RA6" "1st" "1UJ1" "1UK2" "1UK3"
 "1UK4" "1X3" "1{e" "2 /FiO" "2 /τ" "2 h/day" "2+" "2-5A" "2-∆∆C" "2.28E-05" "2.55333e-55"
 "2.76%-14.26%" "2/196" "2/2" "2/3" "2/6" "2/7" "2/group" "20%e35%" "20-dayold" "20-yearold"
 "20.9+27.6" "2000/31" "2001a" "2001b" "2001pg1482" "2002e2003" "2003a" "2003b" "2003pg745" "2005a"
 "2005b" "2006/2007" "2007a" "2007b" "2008a" "2008b" "2009a" "2009b" "2010a" "2010b" "2011_12"
 "20131017/02" "2014a" "2014b" "2015a" "2015b" "2019ncov" "2020-002" "2020a" "2020b" "20a" "20b"
 "20°C." "20·0" "21 ± 1°C." "21.72+/20.43" "21−23°C" "22.05+/20.33" "22°C" "23-80°C" "23°C" "24°C."
 "25.4°C" "25.93+/20.59" "25e100%" "25{50" "25°C" "25°C." "26.90+/20.38" "26/34" "284/917"
 "29°26.0927" "2DWR" "2EBO" "2FYG" "2G12" "2IJD" "2nd_Interview_COVID-19_ECCO_Taskforce_published"
 "2OQ5" "2plusfour8994e" "2XYQ" "2xYT" "2YT" "2·" "2×" "2×2" "2×3" "2Ј-O-methylation" "2Ј-O-MTase"
 "2ЈO" "3 /s" "3+" "3,3-diaminobenzidine" "3,3′,5,5′-Tetramethylbenzidine"
 "3-Amino-9ethyl-carbazole" "3-aminopropyl" "3-Hydroxy-3-methylglutaryl" "3.1A" "3.1™" "3.52E-04"
 "3/29,756" "30/109" "30a" "30°C" "318:727-732" "31°C" "35,36,39e42" "35°C" "37.3℃" "37.5°C."
 "37.5ºC." "37.8°C" "37/319" "370aa" "37°" "37°C" "37°C." "388/00" "38°C." "39/182" "3=" "3ab"
 "3B ." "3C-3D" "3C-like" "3CD" "3CL" "3Cpro" "3D." "3dimensional" "3Dpol" "3Drefine" "3l/minute"
 "3specific" "3T3" "3T3-L1" "3xFLAG" "3xFLAG-tagged" "3×3" "3Ј-5Ј" "3Ј-polyadenylated"
 "3Ј-proximal" "4,5-dimethylthiazol-2-yl" "4,6-diamidine-2-phenylindole" "4-carboxybenzaldehyde"
 "4.37%+/20.28%" "4/228" "4/91" "41°C" "42T>C" "42°C" "42°C." "43b" "45°" "488labeled" "49/62"
 "49e51" "4A ." "4a's" "4a-g" "4B ." "4D." "4DRR" "4DRV" "4DSO" "4F." "4F10" "4G2K"
 "4hydroxy-3-nitrophenylacetyl-chicken" "4°C" "4°C." "4·8%" "4×4" "4×MIC" "4μ8C"
 ...
 "Bcl-xLin" "Bcl2-like" "Bcl2L15" "beats/min" "Becology^" "Bello-Guetiérrez" "belov\\^" "belov^"
 ...
 "CCAAT-enhancer-binding" "ccv-c54" "ccv/canine" "CD19+" "CD27+" "CD3þ" "CD45R" "CD4and" "CD4þ"
 "CD4þCD25þ" "CD4þCD25þFoxp3" "CD4þCD25þFoxp3þ" "CD8þ" "CD8þCD28À" "CDR3s" "CEACAM1a"
 "cell survival/death" "cell/ml" "cells/well" "cellular/immunologic" "CFU/animal" "cfv-c54"
 "cgi-bin" "CGP77116" "cg~6" "Ch5" "change/host" "CHARMM-GUI" "check/test" "chemicals/particles"
 "Chi-squared" "China-like" "Chlor-A-Flush" "CHS-208A" "circovirus-2" "CK/CH/" "CLART®"
 "cleaning/disinfection" "clinical/setting" "Clus-HMC" "CLUSTAL/W" "clusters-B1" "clusters-B2"
 "CMX001" "co-factor" "coiled-coil" "com/" "com/1999-4915/10/12/726/" "com/addict" "com/authors"
 "com/capsules" "com/locate/tmaid" "com/pachterlab/BP_2020" "com/questions" "com/rna"
 "Congo-Crimean" "consulting/technical" "copies/g" "copies/mL" "copies/ng" "Copolymer-1" "COS-7"
 "covid*" "CP-118,556" "CPV-2" "CPV-2a" "CPV-2b" "CPV-2c" "Crimean-Congo" "CRISPR/Cas9"
 "crown-like" "CRW-8" "CTLA-4-B7-1/2" "CTLA4Ig" "CUHK-AG01" "CUHK-AG02" "CUHK-AG03"
 "Culture-HEK 293T cells" "culture/animal" "CURB-65" "CV777" "cyanidin-3" "cyclophosphamide/"
 "cytoplasmic/nuclear" "Cα" "Cα-Cβ" "Cβ" "D+" "D+/R+" "D.S" "D328Oγ" "D336Oγ" "D90A/E92A"
 "Data-Analysis&" "data/knowledge" "day-by-day" "day-to-day" "Dbf2-Mob1" "Dcr-2-mediated"
 "DDBJ/EMBL/" "de-ISG15ylating" "DE\\E" "death-1" "deaths/" "deaths/confirmed"
 "defibrillation/public" "Derp1" "DESC1" "DESC1were" "Dess-Martin" "DExD-box" "DExD/H" "dH6.2"
 "DHF/DSS" "DI-22" "Diaz-Villoslada" "Dicer-2" "Diels-Alder" "Diff-Quik" "dis-Four-point"
 "Discover_3" "distal-eQTL" "dL5" "dL5**" "DNA polymerase®" "DOCK-like"
 "dodecylsulphate-polyacrylamide gel electrophoresis" "DPB1*0401" "DQ355221" "DQ811787" "DQA1*0102"
 "DQB1*0602" "DRB1*1501" "drug-like" "drug/vaccine" "DS/DL2" "DSM-5" "dz1" "D−1" "E-05" "E-1/06"
 "E-3/06" "E-value" "E1-E7" "E289Oδ" "E290Oδ" "E292Oδ" "E301Oδ" "E343Oδ" "E344Oδ" "E7R"
 ...
 "families/" "FAPs/fluorogen" "features/cm 2" "feeding-•" "FFP2" "FFP3" "FG1" "FHV1"
 ...
 "Fucα1-2" "function/dysfunction" "Fungus/Pneumocystis" "G+C" "G.L" "g/" "g/day" "g/dL" "g/L"
 "g/liter" "g/m" "g/ml" "g/mL" "galactin-9" "galectin-like" "GalNAcα1-3" "Galβ1-4GlcNAc"
 "Gasterger-Hückel" "GB2626" "GCCTCGAGTTATTCATC-CCAATCACCGTCT" "GCF_001685135.1"
 "GCGGATCCACAACAACAAGTC-GAACGTGAAC" "Gebert-Rüf" "gene-fragment" "GenISIS/MOSAIC" "gEq/mL" "GFX™"
 "GGTGTTTGATTTGGCCTG-3Ј" "Gloza-Rausch" "Glo™" "glycerol/DMSO" "Goblet/Club" "GOLD-like"
 "gorge-like" "gov/>" "gov/Blast" "gowns/aprons" "GP118" "GP118-specific" "GP21" "GP2s"
 "ground-state" "grov^th" "grow^th" "Gru¨nwald-Giemsa" "GS1783" "GSE12487" "GSE124872" "GT-3"
 "Guandong" "Guillain-Barré" "G~" "H&E" "H+" "H+/A+" "H.J." "H.U." "H1N1/" "H1N1/2009" "H2N2"
 "H5N7" "H7N7" "H7N9" "H9N2" "H:L" "HA-USP15-WT" "hACE2" "HAL1166" "Hap3p" "Hardy-Weinberg"
 "Hasegawa-Kishino-Yano" "HATPase_c" "HBS-EP" "HCDR3" "HCoV229E" "hDPP4" "health/welfare"
 "HEK 293T cells" "HEK-293" "Hela/" "Helsinki--costs" "Hereford-Angus" "HEV-1" "HEV-2" "HEV-3"
 "HEV-3f" "HEV-4" "hexanes/" "hexanes/EtOAc" "HHV-6" "HHV-7" "HHV-8" "his/" "Histopaque-1077"
 "HIV+" "HIV+/HIV+" "HIV2" "HKU-39849" "HKY+G" "HLA-A2" "HLA-A2-restricted" "HLA-A2restricted"
 "HLA-B8" "HLADRB1*1501" "hov\\^" "Hov^ever" "How^ever" "hRL-TK" "Hsieh-Wilson" "HSV-1" "HT29"
 "htm#ctv" "html#terms" "http://biorxiv" "http://bonsai" "http://europa" "http://pymol"
 "http://sysbio" "http://usa" "http://userweb" "http://www" "https://blast" "https://cgenff"
 "https://doi" "https://ecco-ibd" "https://en" "https://github" "https://pypi"
 "https://stackoverflow" "https://www" "https://zinc15" "Huh7" "Humaita-Tubiacanga" "HuN4"
 "Hybond-ECL" "hydrolysis/condensation" "h~maxf2dk" "I-14887" "I/S" "I:C" "IBV-like" "ICD-11"
 "id:1KQR" "iden-•" "IDF0571" "IFITM3_1_F" "IFITM3_2_R" "Ifitm3e/e" "IFN--induced" "IFN--producing"
 "IFN-1b" "IFN-receptor-2" "IFN-α/β" "IFN-β1a" "IFN-␤" "IFN-␥" "IFN1" "IFNAR1/2" "IgA+" "IgG+"
 "IgG1as well as" "IgG2b" "IgG3" "IgGanti-ccv" "IL-10producing" "IL-12R2" "IL-28/29" "IL12p40"
 "ILSVRC-2012" "imipenem/cilastatin" "immunity/health" "In-vitro" "Inception-ResNetV2"
 "Inception-V3" "InceptionResNetV2" "India/" "infec-•" "infected/transformed"
 ...
 "k~3" "L-700417" "L-cGlu-L" "L.K." "L.L." "L/h" "L/min" "L/s" "L/well" "L5*" "Langer-Gould"
 ...
 "misfolded/unfolded" "ml/animal" "ml/kg" "ml/min" "mM/l" "mmol/L" "mol/l" "mole-FIQ"
 ...
 "NC_002976" "NC_004461" "NCI60" "net/" "neutralizing-antibody" "NF-xB" "ng/dose" "NGI-1" "nH1N1"
 ...
 "nsp16" "nsp1a-Rluc" "nsp1α" "NSP1α-luciferase" "nsp1α-Rluc" "nucleic-acid-sequence-based"
 "number-1" "Nε" "O/W" "O15393" "O157:H7" "o30" "OD1" "OD2" "of~20-23" "of~22" "OH-FD100" "OH-FD22"
 "OmpR-like" "oncomiR-addicted" "One-Against-One" "Oneday-old" "or/and" "orf1a" "ORF1a/1b" "orf1ab"
 "ORF1b" "orf7b" "org/" "org/10" "org/10.1101" "org/pdb/" "org/project/selenium/" "org/software"
 ...
 "Personto-person" "pET-32a" "pET22b" "pET28a" "PF00452" "PF13" "PF3" "PFU/cell" "pfu/ml" "PFV-1"
 "pg/ml" "pg171" "pg254" "pg339" "pg407" "pg510" "pg52" "pg59" "pg659" "pg688" "pg697" "pg827"
 "PG9" "pGEX-2T" "pGEX-6P-1" "pGEX-6p-1" "pGL4.74" "pGL4.74-hRL-TK" "pH7.4"
 "pharmaceutical/medical" "PhD-12" "phosphate-buff" "phosphate/" "phRL-TK" "Phylip3.6"
 "physical/biochemical" "physical/chemical" "PI16" "pIICASV-GP2" "pIICASVGP2" "piperacillin/"
 "Piperacillin/tazobactam" "pISRE-Luc" "pJFK3" "pJFK4" "pleural/ascitic" "pNRLuc-nsp14"
 "Pohl-Koppe" "Poisson-Boltzmann" "police/fire" "polylactide/glycolide" "Polymerase™"
 "polynomial-time" "post-NP" "post-zero" "PPE/PRPS" "PRDIII-I" "pre-IND" "present-day" "PRESTO!"
 "problem/issue" "ProBond™" "Profile-3D" "projection-antibody" "promoter/enhancer" "Protein 4a"
 "Protein A+" "Protein A/" "protein A/G" "protein G3BP1" "protein!" "protein-calorie"
 "protein-phosphotungstate" "proteomic/NGS" "PRRSV-1" "PRRSV-2" "PS01259" "PSϪ3.2" "PSϪ4" "PS؊"
 "pTXB1-nsp14" "pUC19" "pUC19-FR-HuFulHEV3f" "pUL56" "Pune" "PV-3Dpol" "PXT1" "python-2.7"
 "python-3" "python-3.7" "pZD-166" "P~NP" "p≤0.05" "Q&A" "Q5®" "q6h" "Q8K459" "QA/QC"
 "Questionaire-9" "quinupristin/dalfopristin" "QX-like" "R&D" "R+" "R.J." "R.M." "R.T." "RA3-6B2"
 "rA59" "Ras-Raf-MEK-ERK" "RB69" "Reagent™" "registrar/" "REGN-EB3" "Reid-Sanden"
 "replication/transcription" "Repligen-RG2077" "represent~80%" "residue H310" "residues H862"
 "ResNet-50" "ResNet50" "resources/tools" "Reverse Transcriptase™" "reviev^" "reviev^ers" "review^"
 "rheumatoid arthritis-like" "ribbon-like" "RIG-I-IPS-1combination" "RIG-I-IPS-1interaction"
 "RIG-I-like" "Rivera-Quinones" "Rlu-fused" "rmIL-4" "Rohowsky-Kochan" "room/cubicle" "rooms/side"
 "RP62A" "rPD-CoV-N" "rPDCoV-N" "rPDCoV-N-ELISA" "RPMI-1640" "RPN1/2" "RQ1a" "RQ1b" "RQ2" "RQ3"
 "RQ3a" "RQ3b" "RQ4" "rs12252" "rtRT-PCR" "rub-ber" "rubella-antibody" "RYDLS-20"
 "S-Gene 3-E-M-Gene" "S-rosettes" "S.A.U" "S/N" "S/P" "S1C" "S1c" "S1D" "S1E" "S1F" "S1G" "S2A"
 "S2B" "S\\fa" "saddle-like" "Santa-Cruz" "Sar55" "sarco/endoplasmic reticulum" "SARS-CoVs-19"
 "SARS-CoVs-2" "SARS-like" "SARS/MERS-CoV" "SARS_AAR07630" "SASRS-CoV-2" "SC-476" "SC10" "SC18"
 "SC20" "SC22-23" "SC22-SC23" "SC27" "SC28" "SD/Mean" "SD16" "SD=0.2" "SD=0.3" "SD=0.4" "SD=0.5"
 "SD=1.6" "SD=12" "SD=4" "SD=4.7" "SD=7.2" "Sec61α" "self-MHC" "sensors/inflammatory"
 "sequences/cm 2" "Ser14=" "SERCA2a" "Serpine1e/e" "serum/the" "seven-nine" "Seven-μm" "sgRNA7"
 "SH-642" "Shapiro-Wilk" "show^" "Si-Pi" "Sialyl-Lex" "sic!" "Sigma-Aldrich" "Sima-Aldrich"
 "site-1" "site-2" "siUSP15-1" "Sixty-three" "SKMCH&RC" "small-envelope glycoprotein"
 "Smart-Lifesciences" "SMOTE+TL" "SNU01" "sources/reservoirs" "South_Korea" "so…" "space/gleaning"
 "SPECS_1" "sponge-like" "sponsor/investigator" "spots/cm" "spring/summer" "Src-418" "SrrB/SrrA"
 "stability/" "state-of-the-art" "state/central" "state/region" "states/regions" "steady-state"
 "Strep-nsp10" "Strep-Tactin" "Strep-Tactin-Sepharose" "Strep-tagged" "Strep-TagII" "STT3A/B"
 "SU-8" "sub-Saharan" "Sunway-1" "Superdex-75" "Susceptible-Exposed-Infected-Removed" "swab/organ"
 "Sybyl6.8" "SYBYL6.9" "symptomatic/unapparent" "System/HRP" "systems‖" "systems…" "SZ-16" "SZ-3"
 "Szent-Gyorgyi" "SZTH-001" "T-2" "T-and" "T-cell-like" "T-or" "T92+G+I" "T:T:T:T" "T:T:T:T-in"
 "taylor@jtgconsulting" "TC1DS0" "TCD50/ml" "TCID50" "TCID50/pig" "TCIDS0" "TCRpeptide-MHC"
 ...
 "tris/glycine" "Triton-100" "Tut7" "TW-JC2" "tw/aids/Molepi/" "TW1" "TW10" "TW3" "tw^o" "TWC3"
 ...
 "viroplasm-like" "virus-like" "virus/HIV-2" "virusantigen-antibody" "vol/vol" "Vorst-case" "VP2"
 "VP7" "VP8" "VP8*" "vprasad@bcm" "VR-953" "VRC01" "vs.100%" "v~0" "v~1" "Vβ" "Vβ14-expressing"
 "Vβ16" "Vβ19" "Vβ5-specific" "w/v" "w/w" "w10-fold" "w^as to" "w^ebsites" "w^ell" "w^ere" "w^hat"
 "w^hether" "w^hich" "w^ho" "w^hose" "w^idespread" "w^ill" "w^ith" "Warthin-Starry" "water/"
 ...
 "~30°C" "~4" "~4-12" "~5" "~50%" "~500,000" "~55" "~56" "~6%" "~6.5" "~64" "~65" "~65-fold" "~70%"
 "~80 %" "~96%" "~ENLYFQG~" "~t" "~V" "~~" "§3" "§3DV" "°C" "±SD" "½½I=ð½I" "¿=" "×3" "×5"
 ...
 "≤Age-contact" "≥1" "≥8" "≥95%" "≥98%" "␤-coronavirus" "␤-CoVs" "␥-32" "，23")))
    :test #'equalp))
...
("aasved" "abandoned" "abbreviated" "abclonal" "abdominal" "abhydrolase" "abided" "ablated"
 ...
 "aflatoxicosis" "agarwal" "agency" "aggarwal" "agglomerative" "agglutination" "aggravated"
 "aggregated" "aggressive" "aggressively" "agilent" "agitation" "agonistic" "agranulocyte" "agreed"
 "agreement" "agricultural" "aguiar" "aided" "aiming" "aired" "alcoholic" "alcoholics"
 "alexaconjugated" "algorithmics" "aligned" "alignment" "alimentary" "aliphatic" "allantoic"
 "alleged" "allegedly" "allelic" "alleviating" "alleviation" "allied" "allocation" "allogeneic"
 "allometric" "alloreactive" "alloreactivity" "allosensitization" "allospecific" "alluded"
 "alopecic" "altered" "altmetric" "altruistic" "altruistically" "alveolar" "amassing" "ambient"
 "ambiguity" "ambiguous" "ambion" "ambitious" "ambivalence" "ambivalent" "ambling" "ambulatory"
 "amebiasis" "amebic" "amebocyte" "ameboma" "amelioration" "amenable" "amendment" "amination"
 "aminosilanized" "aminosilylation" "amniotic" "amorphous" "amounted" "amphiphilic" "anaemic"
 "analgesics" "analytical" "analytics" "anamnestic" "anaphylactic" "anastomotic" "anatomic"
 "ancestor" "ancestral" "ancient" "anecdotal" "anergic" "anerobic" "anesthetics" "anesthetized"
 "angular" "anioncation" "anionic" "annealing" "annotation" "announced" "annual" "annually"
 "annulated" "anogenital" "anomar" "anomeric" "anonymised" "anonymity" "antagonistic" "antagonize"
 "antecedent" "antenatal" "anterior" "anthropogenic" "anthropogenically" "anthropologic"
 "antibacterial" "antibiotics" "antibodytreated" "anticholinesterase" "anticipation"
 "anticoagulation" "antiemetics" "antifibrotic" "antifungal" "antigenic" "antigenically"
 "antigenicity" "antiinfection" "antiinfective" "antilymphocyte" "antiperoxidase" "antipsychotic"
 "antiretroviral" "antiseptic" "antisocial" "antisymmetric" "antithesis" "antituberculous"
 "antitumor" "anxious" "apical" "apologize" "appealing" "appellation" "applicability" "applicable"
 "appointed" "appointment" "apposed" "apposition" "appproximately" "appraisal" "appraised"
 "appreciable" "appreciably" "appreciated" "appreciation" "approached" "approval" "approved"
 "approximability" "approximation" "aquatic" "aqueous" "arabian" "arabidopsis" "arbitrary"
 "archive" "archived" "argument" "argumentation" "arithmetic" "arithmeticharmonic" "aromatic"
 "arranged" "arrayed" "arrival" "arrived" "arsenal" "arterial" "artificial" "artificially"
 "ascending" "ascetic" "ascitic" "ascorbic" "aseptic" "asexual" "ashamed" "asocial" "aspartic"
 "aspergillosis" "aspiration" "assayed" "asserting" "assigned" "assignment" "assist" "assisted"
 "astonishing" "asymmetrical" "asymmetricallyshaped" "asymptomatic" "asymptomatics" "atelectasis"
 "atherogenic" "atherosclerosis" "atherosclerotic" "athletic" "atomic" "atpbinding" "attempting"
 "attending" "attention" "attentive" "attraction" "attractive" "attributable" "attrition"
 "atypical" "audited" "auditing" "auscultation" "authorisation" "authorised" "authorising"
 "authorized" "autochthonous" "autoimmunity" "autoinfection" "autoinfective" "autologous"
 "automated" "automatic" "automatically" "automation" "autonomous" "autonomously" "autophagic"
 "autophagosomal" "autoreactive" "auxiliary" "auxilliary" "availability" "available" "averaged"
 "avidity" "avoidable" "avoiding" "awaiting" "awarding" "axonal" "backcrossed" "backed"
 "backtracking" "bacteraemic" "bacteremic" "bacterial" "bacterially" "bactericidal" "bagged"
 "balanced" "banakar" "banding" "banned" "barred" "basement" "basepairing" "basolateral" "bateared"
 "baylor" "bdependent" "beading" "behaving" "behavioral" "behavioural" "behring" "belonging"
 "benchmarking" "benefited" "benevolent" "besieging" "betting" "biased" "bibliographic"
 "bibliometric" "bidirectional" "biering" "bifunctional" "bifurcation" "bilateral" "biliary"
 "binary" "bination" "binned" "binomial" "bioacoustics" "bioactivity" "bioavailability"
 "biochemical" "biodegradable" "biodistribution" "biodiversity" "bioinformatic" "bioinformatically"
 "bioinformatics" "biologic" "biologics" "bioluminescence" "biomed" "biomedical" "biopanning"
 "biopathogenic" "bioprocessing" "biopsied" "biosecurity" "biosensor" "biostatistics"
 "bioterrorist" "biotic" "biotopped" "bipartioniting" "bipartitioning" "biphasic" "bipolar"
 "biweekly" "blackbacked" "blamed" "blastogenic" "blastomycosis" "bleeding" "blooded" "bloodtinged"
 "blunted" "boardcertified" "bodily" "boehring" "boeing" "boiled" "bolivian" "bombarded" "bonding"
 "bordering" "boronic" "bounded" "bracketed" "bragging" "branched" "brandly" "brasiliensis"
 "brazilian" "breastfed" "breathing" "breed" "breeding" "brevity" "brewing" "broadening"
 "brochiolization" "bronchial" "bronchoalveolar" "bronchodilating" "bronchoscopic" "brucellosis"
 "bubonic" "buccal" "buffered" "bureaucratic" "bursectomized" "buying" "calcify" "calculated"
 "calculation" "calculator" "calendar" "calibrator" "cally" "cancelation" "canceled" "cancellation"
 "cancelling" "candidal" "candidiasis" "candled" "cantly" "cantonal" "cantor" "capacity" "capensis"
 "capillary" "capital" "capmimicking" "capped" "capsular" "captivated" "captive" "caracal"
 "carbonylation" "carboxylic" "carboxymethylated" "carcinogenicity" "cardinal" "cardiogenic"
 "cardiologist" "cardiopulmonary" "cardiotonic" "cardiovascular" "caregiving" "carried" "cascaded"
 "caspasecleaved" "casted" "casual" "catalysed" "catalytically" "catalyticinactive" "catarrhal"
 "catastrophic" "categorical" "categorised" "categorization" "categorized" "catheterization"
 "caucasian" "caudal" "causality" "causation" "causative" "caution" "cautious" "cautiously"
 "cavbase" "caveolar" "cavitary" "cavitating" "cavitation" "cavity" "cayetanensis" "ceased"
 "celled" "cellmediated" "celullar" "centered" "centrality" "centralize" "centred" "centric"
 "centrifugal" "centrifuged" "centrilobular" "cereal" "cerebrospinal" "certified" "cervical"
 "cessation" "cfselabeled" "chancellor" "chanelling" "chaotic" "characterisation" "characterised"
 "characteristic" "characteristics" "charcoal" "charitable" "chasing" "chemiluminescence"
 "chemiluminescent" "chemoattractive" "chemoembolisation" "chemoselective" "chloridecoated"
 "chlorination" "chlorinesolution" "chnical" "chongqing" "chorioallantoic" "christian" "chromatic"
 "chromomycosis" "chronological" "ciency" "ciently" "ciliary" "ciliated" "ciliostasis" "circadian"
 "circular" "circulating" "circulation" "circulatory" "circumvent" "citation" "clarification"
 "clarify" "clarity" "classic" "classical" "classically" "classification" "classify"
 "claustrophobic" "cleared" "cleaved" "clicking" "climbing" "clinic" "clinician" "clinics"
 "cloacal" "cloned" "clonorchiasis" "clonotyping" "closing" "clumped" "cluttered" "coagulase"
 "coalescence" "coalescing" "coalition" "coated" "coccidian" "coccidioidomycosis" "cocobacillary"
 ...
 "crossreactivity" "crowding" "crucian" "crushed" "cryopreserved" "cryptococcal" "cryptococcosis"
 "cryptogenic" "cryptosporidiosis" "crystallization" "crystallize" "crystallographic" "cterminal"
 "cuffing" "cultivated" "culturable" "cultural" "culturally" "cumulative" "cumulatively" "cunical"
 "curated" "curling" "currency" "cursory" "curtailed" "curtailment" "cushion" "cutaneous"
 "cyanosis" "cyanuric" "cycloaddition" "cynical" "cystic" "cytoadherence" "cytocentrifuged"
 "cytologic" "cytologist" "cytomegaly" "cytopathic" "cytotoxicity" "daergic" "dangerous" "daqing"
 "daring" "dashed" "dated" "dcvinfected" "deadenylation" "deadly" "debility" "debridement"
 "decapping" "deceased" "deceived" "deception" "decided" "decision" "decisis" "declaration"
 "declared" "decoded" "decompensating" "decompensation" "decomposing" "decomposition"
 "deconjugated" "decontaminated" "decontamination" "deconvoluting" "dedicated" "deducted" "deemed"
 "deepening" "deepsequencing" "defence" "defending" "defensive" "deferrable" "defibrillation"
 "defibrillator" "defined" "definitive" "definitively" "deformability" "deformity" "degenerated"
 "dehydrated" "dehydration" "deionized" "deliberately" "delineated" "delineation" "delinquency"
 "delivered" "dematiaceous" "democratic" "demographic" "demographical" "demographics"
 "demonstration" "demyelinating" "demyelination" "denaturation" "denatured" "denaturing"
 "dendritic" "dendrogram" "denervated" "denial" "denomination" "density" "dental" "dentritic"
 "deoxyribonucleic" "department" "dependable" "dependently" "depicted" "deployable" "deployed"
 "deployment" "depolarized" "deposited" "deposition" "depressed" "depression" "deprivation"
 "deprotection" "deprotonated" "deprotonation" "derepressible" "derivation" "derivatization"
 "derivatized" "derivatizing" "dermal" "dermally" "dermatological" "derogation" "descent"
 "descriptive" "descriptor" "desirable" "desired" "desperately" "destabilization" "destabilize"
 "destained" "destroyed" "destruction" "destructive" "deterioration" "deterministic" "detriment"
 "detrimental" "devalued" "devastating" "deviation" "deviatoric" "devising" "devitalized" "devoted"
 "diabetic" "diabetics" "diagnosed" "diagnosis" "diagnostic" "diagnostically" "diagnostics"
 "diagonal" "diagrammatic" "diagrammed" "dialysis" "diapedesis" "diaphanizing" "diarrheaaffected"
 "diarrheal" "diarrheic" "diarrhoeal" "diazotrophic" "dicision" "dictionary" "dielectric" "dietary"
 "differed" "differentiable" "differentially" "diffracting" "diffraction" "diffrent" "diffusion"
 "diffusive" "digestive" "digging" "digital" "digitally" "dilated" "dilation" "diligence"
 "diligently" "diluted" "dilution" "dimensionality" "dimensionally" "diminution" "dimorphic"
 "dioxaoctanoic" "dirccted" "directional" "directionality" "director" "disability" "disable"
 "disagreement" "disallowed" "disappeared" "disapply" "disapproval" "disapproved" "disassembled"
 "discarded" "discernible" "disciplinary" "disciplinesworking" "discoloration" "discontentment"
 ...
 "envisaged" "envisioned" "enzymelinked" "enzymic" "eosinophilic" "epidemic" "epidemics"
 "epidemiologic" "epidemiological" "epidemiologically" "epidural" "epigenetically" "episcleral"
 "epistemic" "epitopecontaining" "eponymous" "equality" "equation" "equilibrated" "equilibration"
 "equimolar" "equipment" "equipped" "equitable" "equity" "equivocal" "eradicated" "eradication"
 "erderived" "erratic" "erratically" "erroneous" "ersistent" "erythrocytic" "erythrophagocytosis"
 "escalating" "escalation" "esophageal" "espoused" "essential" "esterified" "estimated"
 "estimation" "ethical" "ethics" "ethnic" "ethnicity" "ethylenediaminetetraacetic" "etiologic"
 "etiological" "etiologically" "euclidian" "eulerian" "eurasian" "eusocial" "euthanasized"
 "euthanized" "evaluation" "evaporated" "evaporation" "evasion" "evective" "evector"
 "evidencebased" "evidencing" "evident" "evidential" "evocative" "evolution" "evolutionary"
 "evolvement" "evolving" "exacerbation" "exaggerated" "excellent" "exception" "exceptional"
 "exceptionally" "excised" "excision" "excitation" "excitement" "exciting" "exclusion" "excrement"
 "excreting" "excretion" "excysting" "execution" "executive" "exemplified" "exhaled" "exhaustion"
 "exhaustive" "exhaustively" "exhibited" "exhibitor" "existent" "exogenous" "exogenously"
 "exoribonuclease" "exotic" "expansion" "expansionist" "expansive" "expectedly" "expectoration"
 "expedient" "expedited" "expelled" "expending" "expensionist" "expensive" "experiencing"
 "experimentation" "experimented" "expiration" "expiratory" "explicitly" "exploitation" "exploited"
 "exploration" "exploratory" "explosion" "explosive" "exponential" "exponentially" "expressively"
 "expressly" "extemporaneous" "extemporary" "extension" "external" "extinction" "extinguished"
 ...
 "lamarckian" "laminar" "larval" "laryngeal" "lastly" "latency" "latently" "lateral" "launched"
 "laundering" "lawfully" "lawlor" "layered" "lcmvencoded" "ldvinfected" "leaching" "leaving"
 "legalised" "legalized" "legible" "legislation" "legislative" "legislator" "legitimately"
 "leishmaniasis" "lemmatization" "lenient" "leniently" "lensassociated" "lentiviral"
 "leptospirosis" "lessening" "lethality" "leucocytosis" "leukocytosis" "leukosis" "leveraging"
 "liability" "liable" "liberal" "liberalisation" "liberalised" "liberally" "liberating"
 "liberation" "library" "licence" "licensed" "lifescience" "lifethreatening" "ligament" "liganded"
 "lightning" "likened" "linearized" "lingering" "lipoperoxidation" "lipophilic" "liposomal"
 "litigation" "lived" "loathing" "lobbying" "lobular" "localisation" "localised" "localiztion"
 "located" "lodged" "logistic" "logistical" "logistics" "longed" "longevity" "longitudinal"
 "longsuspected" "looping" "lopsided" "lowly" "lowmelting" "lowspeed" "lucrative" "lumbar"
 "luminescence" "luminescent" "lying" "lymphatic" "lymphatics" "lymphocytic" "lymphocytosis"
 "lymphogranuloma" "lymphopenic" "lymphoplasmatic" "lymphoproliferative" "lymphotrophic"
 "lymphotropic" "lyophilized" "lysosomotropic" "macroscopic" "macrovascular" "macular"
 "maculopapular" "magnetic" "magnetics" "magnification" "majority" "malariologist" "malaysian"
 "malfunctioning" "manageable" "managed" "management" "managingyourorganisation" "mandatory"
 "mandible" "manipulation" "manned" "manual" "manually" "manufacturing" "marginal" "marginalised"
 "margination" "marked" "marketed" "marketing" "markovic" "massive" "massively" "mated" "material"
 "maternal" "maternally" "maternity" "mathematical" "matriculated" "mattered" "maturation"
 "maturity" "maxillofacial" "maximisation" "maximize" "measlesvectored" "mechanical" "mechanics"
 "mechanistics" "medication" "medicinal" "mediumsized" "melancholic" "melioidosis" "melitensis"
 "membraneenclosed" "membranous" "memetic" "meningeal" "meningococcal" "mental" "mented"
 "mercaptohexadecanoic" "merging" "merial" "mesenteric" "messaging" "messling" "metaanalysis"
 "metabolomics" "metagenomic" "metallic" "metanalysis" "metered" "methodological" "meticulous"
 "metric" "metrics" "mhcrestricted" "microangiopathic" "microarrayed" "microbial" "microbiologic"
 "microbiological" "microbiologist" "microcephalic" "microcephaly" "microelectromechanical"
 "microenvironment" "microfabrication" "microfluidic" "microfluidics" "micromirror" "micropanned"
 "microscopic" "microscopically" "microthomic" "microtubuleassociated" "microvascular"
 "microwaving" "midsection" "migratory" "miliary" "military" "mimetic" "mimetics" "mimicking"
 "mineral" "mingled" "miniaturisation" "miniaturization" "miniaturized" "minimal" "minimisation"
 "minimised" "minimization" "minimize" "mining" "minority" "mirrored" "misannotation"
 "misclassification" "misclassified" "misconception" "misdiagnosed" "misdiagnosis" "misfolded"
 "misincorporation" "misleading" "mispairing" "misreading" "misrepresent" "missing" "mission"
 "mistrusted" "mitigation" "mitotic" "mixed" "mladenovic" "modeled" "modelling" "moderation"
 "modifiable" "modular" "modularity" "modulator" "modulatory" "mogreactive" "mokhtarian"
 "molecularly" "moment" "mondal" "monetary" "monitor" "monitored" "monitoring" "monoclinic"
 "monoclonal" "monographic" "monomeric" "monomorphic" "mononuclear" "mononucleosis" "monophyletic"
 "monopolar" "monopolist" "monopolistic" "monopoly" "monovalent" "morality" "morally" "morbidity"
 "morphogenetic" "morphologic" "motivated" "motivation" "motivational" "mottled" "movable"
 "movement" "mrnadecapping" "mucociliary" "mucocutaneous" "mucolytic" "mucopurulent" "mucosal"
 "multicolor" "multicomponent" "multidimensional" "multidisciplinary" "multifaceted"
 "multifactorial" "multifocal" "multifunctional" "multilateral" "multilobar" "multilobular"
 "multinucleation" "multiplexing" "multiplication" "multiplicity" "multiplying" "multivalent"
 "multivariable" "municipal" "municipality" "muscular" "mutational" "mutator" "mycobacterial"
 "mycosis" "mycotic" "myelinreactive" "myelomonocytic" "myocardial" "namibian" "nancial" "nancing"
 "nanthakumar" "narcotics" "narrowed" "narrowly" "nasaloropharyngeal" "nasoorbital"
 "nasopharyngeal" "nated" "nationalisation" "nationality" "nblast" "nding" "neatly" "necessity"
 "necropsied" "negating" "negation" "negatively" "negativeselecting" "negativity" "neglected"
 "negligible" "negligibly" "negotiated" "neonatal" "neosynthesized" "nephropathogenic"
 "nephrotoxicity" "nervous" "nested" "neural" "neuroadaptation" "neuroadaptive" "neurobiological"
 "neurocysticercosis" "neurodegeneration" "neurodegenerative" "neurogenic" "neuroinvasion"
 "neurologic" "neurological" "neurologically" "neuromuscular" "neuronal" "neuroprotection"
 "neuroprotective" "neurotrophic" "neurotropic" "neutral" "neutralisation" "neutralising"
 "neutrophilic" "nicipal" "nioshpublished" "nition" "nitric" "nocturnal" "nodular" "noised"
 "nominated" "nonactivated" "nonadjuvanted" "nonarticulated" "nonclinical" "noncombining"
 "noncontagious" "nonconventional" "noncovalence" "noncovalent" "nondegradative" "nondestructive"
 "nondiabetic" "nondimorphic" "nondividing" "nondomestic" "nonenveloped" "nonessential"
 "nonexistent" "nonfluorescent" "nonhematopoietic" "nonhomologous" "nonimmunosuppressed"
 "noninfectious" "nonintubated" "noninvasive" "nonlinear" "nonnative" "nonnutrient" "nonparametric"
 "nonpathogenic" "nonpharmaceutical" "nonphototoxic" "nonphysiological" "nonresident"
 "nonrespiratory" "nonrodent" "nonsensemediated" "nonsialylated" "nonspecific" "nonspecifically"
 "nonstimulated" "nonstructural" "nontraditional" "nontuberculous" "nonvaccinated" "nonviable"
 "nonviral" "noradrenergic" "normalisation" "normalised" "normality" "normalization" "normalize"
 "normocytic" "northcentral" "nosocomial" "nosocomially" "nostalgically" "notation" "notational"
 "noticeable" "notifiable" "notification" "notify" "notion" "notorious" "nterminal" "nuanced"
 "nucleating" "nucleic" "nucleofector" "nucleolar" "nucleophilic" "nucleosidebased" "numbered"
 "numbering" "numeric" "numerical" "nutrition" "nutritional" "objectionable" "objective"
 "objectivised" "obliquely" "obscured" "observable" "observational" "obstetrics" "obstructed"
 "obstruction" "obstructive" "obtainable" "occasion" "occasional" "occluded" "occupation"
 "occupational" "occupied" "oesophageal" "offence" "offered" "offering" "official" "officially"
 "offspring" "oilemulsion" "olfactory" "oligoclonal" "oligomeric" "oligosaccharyltransferase"
 "oligosymptomatic" "omnipresent" "oncogeneaddicted" "oncologic" "oncological" "onychomycosis"
 "opened" "ophthalmic" "opportunistic" "opportunistically" "opposing" "opposition" "opsonisation"
 "opted" "optical" "optician" "opticospinal" "optics" "optimal" "optimisation" "optimised"
 "optimistic" "optimization" "optimized" "optimizing" "option" "optional" "orally" "orangeophilic"
 "orbital" "orchestration" "ordered" "ordinarily" "ordinary" "organellar" "organic" "organisation"
 "organisational" "organisationsmostly" "organised" "organization" "organized" "organoleptically"
 "organotypic" "oriental" "oriented" "oronasal" "oronasally" "oropharyngeal" "orpharyngeal"
 "orthogonality" "orthologous" "oscillating" "oscillatory" "osmolarity" "osmosensor" "osmosis"
 "osmotic" "outdoor" "outlined" "outpatient" "outperformed" "outstanding" "ovarian"
 "overactivation" "overarching" "overcoating" "overcoming" "overcrowded" "overeating"
 "overemphasis" "overemphasized" "overestimated" "overextension" "overfitting" "overhydration"
 "overimmunosuppressed" "overimmunosuppression" "overlooked" "overly" "overlying" "overmatching"
 "overpopulation" "overproduced" "overrepresentation" "overriding" "oversampling" "overseeing"
 "overspending" "overtaking" "overtly" "overwhelming" "overwhelmingly" "overzealous" "owing"
 "owned" "oxidative" "oxidatively" "oxidized" "oxygenation" "ozonation" "packed" "padding"
 "paediatric" "palliating" "pallor" "palmitoylthioesterase" "palpation" "pandemic" "pandemics"
 ...
 "peptidomimetics" "perceived" "perception" "perforation" "perfusion" "perianal" "peribronchiolar"
 ...
 "phagocytosed" "phainjected" "pharmaceutical" "pharmaceutically" "pharmacodynamic"
 "pharmacodynamics" "pharmacokinetic" "pharmacokinetics" "pharmacologic" "pharmacologically"
 "pharmacophoric" "pharmocophoric" "pharyngeal" "phenolics" "phenotypic" "phenotyping"
 "philanthropic" "phosphatebuffered" "phosphoacceptor" "phosphochelator" "phosphoimaging"
 "phosphokinase" "phosphomolybdic" "phosphorimaging" "phosphospecific" "phosphotungstic"
 "phosphotylation" "photoacoustic" "photoaffinity" "photocrosslinking" "photographic"
 "photographically" "photoinduced" "photolithographic" "photopatternable" "photoresist"
 "photostability" "photostable" "photoswitching" "phototoxicity" "phrase" "phrasing" "phred"
 "phusion" "phylogenetic" "phylogenetically" "phylogentically" "physician" "physicochemical"
 "physics" "physiosorption" "picornaviral" "piezoelectrics" "pigment" "pigmented" "pinpointing"
 "pituitaryadrenal" "pivotal" "pivotally" "placental" "plaguecontaminated" "planar" "planktonic"
 "planned" "plastic" "plasticity" "plastics" "plateauing" "plated" "plausibility" "plausible"
 "pleaded" "pleased" "pleasurable" "pleiotropic" "pleomorphic" "pleural" "plotly" "plpexpressing"
 "plumanalytics" "plumbing" "pluripotent" "pneumatic" "pneumococcal" "pneumocystosis" "pneumonic"
 "poised" "poisoned" "polarisable" "polarity" "polarization" "polarized" "political" "politically"
 ...
 "pubmed" "punctual" "punishable" "purchased" "purebred" "purged" "purity" "purposively" "pursuing"
 ...
 "sentence" "separable" "separation" "septic" "septicaemic" "sequencevariation" "sequentially"
 ...
 "seroprevalence" "serosanguineous" "serotyped" "serous" "settlement" "severity" "sexual" "shaking"
 "shaped" "shared" "shedding" "shielding" "shifting" "shined" "shipping" "shopping" "shortcoming"
...
("abandon" "abate" "abates" "abattoir" "abbreviation" "abbreviations" "abdomen" "abrasion"
 ...
 "arrowhead" "arrowheads" "art" "artery" "article" "ascertain" "ascribe" "aside" "aspirate"
 "assessor" "assessors" "asset" "assistance" "assurance" "assure" "asterisk" "astute" "asymmetry"
 "ate" "athlete" "athletes" "atlas" "atmosphere" "atom" "atoms" "attack" "attain" "attendance"
 ...
 "careful" "carnivore" "carnivores" "carpenter" "carpenters" "carriage" "carrier" "carriers" "cars"
 "cart" "carter" "cartoon" "carts" "caseload" "casino" "cassette" "castle" "casualty" "cat"
 "catalogue" "catalyst" "catapult" "catapults" "catch" "cattle" "caught" "cave" "caveat" "caves"
 "ceiling" "ceilings" "census" "centrifuge" "century" "certificate" "certificates" "chain" "chair"
 "chairman" "chamber" "chamberlain" "chameleon" "channel" "chapter" "chapters" "character"
 "characters" "charge" "charities" "charity" "chart" "charter" "cheap" "cheaper" "check" "cheetah"
 "chemical" "chemicals" "chemist" "chemistry" "chemists" "cherry" "chest" "chic" "chick" "chicken"
 "chief" "child" "childhood" "chill" "chills" "chocolate" "choice" "choir" "choose" "chose"
 "church" "circle" "circles" "circuit" "circumscribe" "circumstance" "circumstances" "cite"
 "citizen" "citizens" "citizenship" "civet" "civil" "civilian" "civilians" "civilization"
 "civilizations" "claim" "claims" "clamp" "clan" "clandestine" "clans" "clash" "class" "classes"
 "clay" "clean" "cleaner" "clear" "clearance" "clearer" "cleft" "climate" "clip" "clips" "closure"
 "closures" "cloth" "clothe" "clothes" "club" "clubs" "clue" "coach" "coarse" "cocktail"
 "coefficient" "coefficients" "cognizant" "cohort" "coincide" "cold" "collaborate" "collaborator"
 "collaborators" "colleague" "colleagues" "collector" "collectors" "college" "colonies" "colony"
 "colorless" "column" "coma" "combat" "combine" "come" "comfort" "command" "commander"
 "commentaries" "commentary" "commit" "committee" "commonplace" "communicate" "communities"
 "community" "compact" "compartment" "compartments" "compass" "compassionate" "compilation"
 "compilations" "complain" "complaint" "complaints" "completeness" "compliance" "compliant"
 "complication" "complications" "composite" "compound" "computer" "concept" "concepts" "concise"
 "concomitant" "concordant" "concrete" "condemn" "confederate" "conference" "conferences"
 "conflict" "conflicts" "conform" "conforms" "confront" "conglomerate" "congregate" "congregates"
 "congress" "congresses" "conjecture" "connect" "conquest" "consciousness" "consensus"
 "conservancies" "conservancy" "consist" "consists" "consortium" "constant" "constants"
 "constituent" "constituents" "constrain" "constraint" "construction" "constructions" "consultant"
 "consumer" "consumers" "contact" "contacts" "contemplate" "contend" "contingencies" "contingency"
 "contort" "contradict" "contributor" "contributors" "controller" "controversy" "converge"
 "conversation" "conversations" "cool" "cooler" "cope" "copy" "copyright" "copyrights" "cord"
 "cordon" "cordons" "cornea" "cornflower" "coronet" "corpse" "corpses" "corpus" "corpuscle"
 "corpuscles" "correct" "corroborate" "corroborates" "corrupt" "corse" "cosmos" "cost" "cotton"
 "cottontail" "cough" "coulter" "council" "counsel" "counsels" "count" "counteract"
 "countermeasure" "countermeasures" "counterpart" "counterparts" "countless" "counts" "county"
 "coupon" "coupons" "courier" "course" "court" "courtroom" "courts" "cover" "coverage" "covert"
 "coy" "coyote" "coyotes" "crack" "crackle" "crackles" "cracks" "cram" "crater" "craters" "crave"
 "cravings" "crease" "creases" "creator" "creators" "credit" "crepitation" "crepitations" "crevice"
 "crevices" "crick" "cricket" "crime" "cripple" "crises" "crisis" "crisp" "criteria" "criterion"
 "criticism" "crop" "cross" "crossfire" "crown" "crude" "crystalline" "cube" "cubic" "cubicle"
 "culprit" "cult" "cumbersome" "cummerbund" "cup" "cupboard" "curb" "cure" "curriculum" "curtain"
 "curtains" "curvature" "curve" "curves" "custom" "customer" "customers" "cut" "cutoff" "cylinder"
 "cylinders" "cynicism" "dairy" "damp" "damper" "danger" "dangers" "dark" "daughter" "daytime"
 "deafness" "deal" "dealt" "dean" "debate" "debris" "decade" "decay" "decipher" "deck" "decks"
 "decline" "decoy" "deep" "default" "defendant" "defense" "defenses" "deficit" "deficits"
 "definition" "definitions" "defy" "deg" "degree" "deliberate" "deliberation" "deliberations"
 "delicacy" "delicate" "delirium" "deliver" "delivery" "dell" "delta" "demand" "demands" "demon"
 "den" "denote" "dens" "dense" "dent" "dentist" "dentists" "dents" "deny" "depart" "deploy"
 "deposit" "deposits" "depth" "deputy" "dermatology" "derogate" "derogates" "descendant"
 "descendants" "desert" "deserts" "deserve" "design" "designate" "designates" "designation"
 "designations" "desperate" "destination" "destinations" "destroy" "destroys" "detach" "detaches"
 "detector" "detectors" "deter" "deteriorate" "deteriorates" "developer" "developers" "deviant"
 "deviate" "device" "devices" "devoid" "dextrose" "diabetes" "dialogue" "diameter" "diarrhoea"
 "diary" "dichotomy" "dictate" "dictates" "dictum" "diet" "differ" "differentiate" "difficulties"
 "difficulty" "dilemma" "dioxide" "dire" "directive" "directives" "dirt" "dirty" "disadvantage"
 "disadvantages" "disagree" "disallow" "disappearance" "disaster" "disasters" "discern" "discharge"
 "discipline" "disciplines" "disclose" "disclosure" "discomfort" "disconnect" "discontinue"
 "discordant" "discourse" "discover" "discoveries" "discovery" "discrepancies" "discrepancy"
 "discuss" "disfavour" "disfavours" "dish" "dishes" "dishonest" "disinfect" "disinfectant"
 "disinfectants" "disintegrate" "disjoint" "dismiss" "dismisses" "disorientate" "disparate"
 "dispatch" "disperse" "disproportionate" "dispute" "disputes" "disquiet" "disregard"
 "dissertation" "dissertations" "dissimilarities" "dissimilarity" "distance" "distances"
 "distemper" "distress" "district" "disturbance" "disturbances" "diver" "diverge" "divers"
 "diversifies" "diversify" "divert" "dizziness" "doctrine" "dome" "dominance" "don" "donation"
 "donations" "donkey" "donor" "door" "dosage" "dose" "dot" "dots" "doubt" "doubtful" "doubtless"
 "downturn" "draft" "drain" "drainage" "draw" "drawback" "drawbacks" "drawings" "dress" "dressings"
 "drew" "drift" "drill" "drive" "driver" "drivers" "dromedaries" "dromedary" "drove" "dry" "dryer"
 "dual" "duck" "ducks" "duct" "ducts" "due" "dump" "duodenum" "duplex" "duty" "dwell" "dwellings"
 "dysentery" "eagle" "ear" "earthquake" "ease" "easy" "eat" "echo" "ecology" "economist"
 "economists" "economy" "ecosystem" "ecosystems" "editorial" "editorials" "educate" "effectiveness"
 "efflux" "effort" "effusion" "effusions" "egg" "eggs" "eggshell" "elastomer" "elastomers" "elder"
 "electrode" "electrodes" "electrolyte" "elegance" "element" "elements" "elite" "else" "elsewhere"
 "emanate" "emerge" "emotion" "emotions" "employ" "employee" "employees" "employer" "empower"
 "empty" "emulsion" "emulsions" "enclosure" "encompass" "encompasses" "encounter" "encounters"
 "encourage" "encyclopedia" "endanger" "endangers" "endeavour" "endless" "endorse" "enema" "enemas"
 "enemy" "energy" "engine" "engulf" "enroll" "ensemble" "ensembles" "ensure" "enteritis"
 "enthusiasm" "entirety" "entities" "entity" "entrench" "enumerate" "enumerates" "environment"
 "environments" "epicenter" "epicenters" "epidemiologist" "epidemiologists" "epidemiology"
 "episode" "equal" "equate" "equates" "equivalent" "equivalents" "ere" "error" "etch" "etiology"
 "eucalyptus" "euphoria" "euthanasia" "evade" "evades" "evaluate" "eve" "evergreen" "everyday"
 "everywhere" "eves" "evil" "evoke" "evokes" "exacerbate" "exact" "exam" "exceed" "exceeds"
 "excess" "exchanger" "exchangers" "exclude" "execute" "exempt" "exemption" "exemptions" "exercise"
 "exercises" "exert" "exerts" "exhaust" "expand" "expatriate" "expectancy" "expectation"
 "expectations" "expenditure" "expense" "expert" "expertise" "explicit" "explore" "expose"
 "exposure" "exposures" "exquisite" "extant" "extend" "extends" "extra" "extrapolate" "fa" "fab"
 "face" "facet" "facilities" "facility" "facsimile" "factories" "factory" "faculty" "fade"
 "failure" "fair" "faithful" "falcon" "fall" "far" "farm" "farmer" "farmers" "farmhouse"
 "farmhouses" "farmland" "fatal" "father" "fatigue" "fatty" "favourite" "fear" "fearful" "feast"
 "feather" "feathers" "febrile" "fed" "fee" "feedback" "feeder" "feeders" "feedlot" "feedlots"
 "feel" "feet" "feline" "fell" "fellow" "felt" "femur" "feral" "ferret" "ferrets" "fertile" "fetal"
 "fetch" "feverish" "fiber" "field" "fieldwork" "fig" "fight" "fighter" "fighters" "fillip" "film"
 "filter" "filters" "final" "fine" "finger" "fingerprint" "fingers" "fingertip" "fingertips"
 "finite" "fire" "firm" "fitness" "flaccid" "flagellate" "flagellates" "flame" "flap" "flaps"
 "flask" "flat" "flea" "fleas" "fling" "float" "flock" "floor" "flow" "fluke" "flukes" "flung"
 "foam" "foamy" "focal" "focus" "fold" "follower" "followers" "foot" "footprint" "force" "forearm"
 "foremost" "forerunner" "foresee" "formalin" "format" "formica" "formula" "formulate" "forth"
 "forum" "foster" "fourfold" "fowl" "fox" "foxes" "fracture" "fractures" "fragile" "framework"
 "frank" "fraud" "freedom" "freeman" "freeze" "fresh" "freshwater" "friend" "frontier" "frontiers"
 "frontline" "fruitful" "fulfil" "fulfill" "fulfills" "future" "fuzzy" "gadget" "gadgets" "gall"
 "gambler" "gamma" "gap" "gaps" "garage" "garages" "garden" "gargle" "gargles" "gastritis"
 "gateway" "gather" "gathering" "gatherings" "gauge" "gay" "gear" "geese" "gelatin" "gelatine"
 "gender" "genera" "gentle" "genus" "geography" "geometry" "giant" "giants" "gift" "gifts" "girl"
 "glance" "gland" "glanders" "glassware" "globe" "glossaries" "glossary" "glove" "gloves" "go"
 "goal" "goblet" "goggle" "goggles" "golden" "goodies" "goody" "goose" "gorge" "gorilla" "gorillas"
 "gospel" "governance" "gown" "grade" "graft" "grain" "grand" "grant" "grants" "graph" "grassland"
 "grasslands" "grateful" "gratitude" "great" "greater" "greedy" "grey" "greyhound" "grid" "griffin"
 "grille" "grind" "gross" "grosser" "ground" "groundwater" "group" "groupings" "grove" "guarantee"
 "guard" "guards" "guess" "guest" "guests" "guidance" "guide" "guideline" "guidelines" "guild"
 "guilds" "guilt" "guilty" "guinea" "gulf" "gull" "gulls" "gun" "gut" "guy" "habit" "habitat"
 "habits" "haemorrhage" "hairpin" "halfway" "hall" "hallmark" "halogen" "halt" "hamper" "hampers"
 "hand" "handbook" "handful" "handkerchief" "handkerchiefs" "handler" "handlers" "handover" "hank"
 ...
 "linen" "lion" "lions" "lip" "lips" "listlessness" "liter" "lithography" "litre" "litter"
 "livestock" "load" "loadings" "loath" "lobe" "locale" "locales" "lock" "locus" "loftiness" "lofty"
 "log" "logarithm" "logic" "logs" "lone" "loneliness" "longterm" "loose" "looser" "lope" "lopes"
 "lot" "lotteries" "lottery" "lotto" "loyalty" "luck" "luggage" "lump" "lymph" "machine"
 "machinery" "machines" "magazine" "magic" "magnitude" "main" "mainland" "maker" "makers"
 "malachite" "malaise" "malaria" "manager" "managers" "mandate" "maneuver" "maneuvers" "manifest"
 "manifestation" "manifestations" "manifold" "manikin" "manikins" "manipulate" "mankind"
 "manoeuvre" "manpower" "mantel" "manufacturer" "manure" "manuscript" "map" "maps" "march" "margin"
 "margins" "marine" "mark" "marker" "market" "marketplace" "markings" "marrow" "marsupial"
 "marsupials" "martin" "martins" "mason" "master" "matrix" "matt" "matter" "matters" "mature" "maw"
 "maximise" "maximum" "meal" "meals" "meaning" "meaningful" "meaningless" "meanings" "meantime"
 "meanwhile" "measles" "meat" "mediator" "mediators" "medicine" "meet" "meetings" "membership"
 "mentor" "mentors" "mercer" "mere" "merit" "mesh" "message" "messages" "messenger" "metal"
 "methodology" "metropolitan" "micro" "microbiology" "microchip" "micron" "microwave" "mid" "midst"
 "midwestern" "migrant" "mild" "mildness" "milieu" "milk" "millennium" "miller" "millions"
 "mimicry" "mind" "mindful" "mini" "minimum" "minister" "ministry" "minor" "mirror" "mirrors"
 "miscarriage" "misfortune" "misinterpretation" "misinterpretations" "miss" "misshapen" "mistake"
 "mistaken" "mistakes" "misunderstand" "misunderstood" "misuse" "mite" "mitigate" "mobile" "mock"
 "moderate" "modern" "modest" "module" "moiety" "moist" "moisture" "mold" "mollusc" "molluscs"
 "money" "monies" "monkey" "monograph" "monographs" "monopolies" "monopoly" "mood" "moral" "morbid"
 "morphology" "mortar" "mortars" "mosquito" "mosquitoes" "mother" "motive" "motives" "motor"
 "mount" "mountain" "mouth" "mule" "mules" "multilayer" "multiple" "multiples" "multitude" "mumps"
 "music" "mustard" "myriad" "mysteries" "mystery" "nab" "nabs" "nail" "nails" "naive" "narrative"
 "narratives" "nasal" "natal" "nation" "nations" "nationwide" "native" "natives" "nature" "nausea"
 "navy" "necessitate" "neck" "needle" "negotiation" "negotiations" "neighbor" "neighborhood"
 "neighbors" "nerve" "net" "nets" "network" "newborn" "newspaper" "newspapers" "niche" "niches"
 "node" "nodes" "nodule" "nodules" "noise" "nomenclature" "nonetheless" "nonsense" "nonwoven"
 "norm" "norms" "nose" "notebook" "notebooks" "noteworthy" "notice" "nourish" "nourishes" "nova"
 "novelty" "nowadays" "nuance" "nuances" "nurse" "nurseries" "nursery" "nut" "nuts" "obdurate"
 "obey" "obligate" "obligation" "obligations" "oblige" "observer" "obstacle" "obstacles" "obviate"
 ...
 "pest" "petal" "peter" "pharmaceuticals" "pharmacist" "pharmacists" "pharmacologist"
 "pharmacologists" "pharmacology" "pharmacy" "pharyngitis" "phase" "pheasant" "phenomena"
 "phenomenon" "phobia" "phone" "photo" "photograph" "photographs" "photography" "photolithography"
 "photon" "phylum" "physician" "physicians" "physicist" "physicists" "physiology" "pi" "pick"
 "picture" "piece" "pierce" "pigeon" "pigeons" "piglet" "piglets" "pilgrim" "pilgrims" "pill"
 "pillar" "pillars" "pillow" "pillows" "pills" "pin" "pins" "pioneer" "pioneers" "piper" "pit"
 "pits" "placebo" "placenta" "plague" "plain" "plaintiff" "planet" "plaque" "plateau" "platform"
 "player" "players" "pleadings" "plenty" "plethora" "plexus" "plot" "plots" "plug" "plum" "plume"
 "plumes" "ply" "plywood" "pocket" "point" "poker" "polar" "police" "policies" "policy"
 "policymaker" "policymakers" "polio" "politician" "politicians" "pollard" "polyester"
 "polypropylene" "polystyrene" "polyvinyl" "pone" "pool" "poor" "poorer" "pornography" "port"
 "porter" "ports" "possess" "possesses" "post" "poster" "poultry" "poverty" "powder" "power"
 "practice" "practices" "practise" "practitioner" "prayer" "prayers" "precaution" "precautions"
 "precedent" "precedents" "precise" "preclude" "precursor" "precursors" "predator" "predators"
 "predecessor" "predecessors" "predispose" "predominance" "predominant" "predominate"
 "predominates" "prefer" "prefers" "premature" "premier" "premise" "preoccupation" "preoccupations"
 "preparedness" "presidencies" "presidency" "pressman" "pressure" "prestige" "presume" "prevail"
 "pride" "prides" "primacy" "primer" "principle" "principles" "print" "prism" "pristine" "privacy"
 "private" "prize" "problem" "procedure" "proceed" "proceedings" "producer" "product" "products"
 "professionalism" "profile" "profiles" "profit" "profound" "program" "programme" "programs"
 "progress" "prohibit" "prone" "propel" "properties" "property" "prophylaxis" "proportionate"
 "prospect" "protocol" "prototype" "protrusion" "protrusions" "provider" "proxies" "proxy" "pseudo"
 "psychiatrist" "psychiatrists" "psychiatry" "psychologist" "psychologists" "psychology"
 "publisher" "pug" "pulse" "pump" "punch" "puncture" "puppy" "purchaser" "pure" "purport"
 "purports" "purpose" "purposeful" "purse" "pursuit" "pustule" "pustules" "pyramid" "python"
 "quadruplicate" "quantum" "quarantine" "quarrel" "quell" "quest" "questionnaire" "quick" "quinine"
 "quit" "quitter" "quitters" "rabies" "radiogram" "radiograms" "radiograph" "radiographs"
 "radiography" "radiologist" "radiologists" "radiology" "radiotherapy" "radius" "raft" "rafts"
 "rail" "rainfall" "raj" "rale" "rales" "ranking" "rankings" "rapport" "rash" "rationale" "ray"
 "reader" "readers" "readiness" "ready" "real" "rearrangement" "rearrangements" "reason"
 "reasonableness" "reassess" "reassurance" "reassure" "rebind" "rebound" "recall" "receipt"
 "receiver" "recipient" "recipients" "reciprocal" "reciprocals" "recommendation" "recommendations"
 "reconcile" "reconsider" "record" "records" "recover" "recovery" "rectangle" "recur" "redeem"
 "redefine" "redesign" "redundancy" "reeve" "reeves" "reexamine" "referee" "referees" "reference"
 "references" "referendum" "reflect" "reflux" "refuge" "refugee" "regard" "regardless" "regime"
 "regimen" "regimens" "regimes" "register" "registrar" "registrars" "registry" "regress"
 "reinforce" "reinforces" "reiterate" "reject" "rejects" "relate" "relative" "relatives" "relax"
 "relentless" "relevance" "relevant" "reliance" "reluctance" "reluctant" "remainder" "remark"
 "remedy" "remember" "remembrance" "reminisce" "remit" "remnant" "remote" "render" "renew" "repair"
 "repertoire" "reporter" "reptile" "reptiles" "rescue" "rescuer" "research" "researcher"
 "researchers" "resemblance" "resemble" "resembles" "reserve" "reserves" "reservoir" "reside"
 ...
 "restaurant" "restaurants" "restless" "restlessness" "restore" "restraint" "restrict"
 "restriction" "restrictions" "resultant" "resume" "retard" "retriever" "revenue" "reversion"
 "reversions" "review" "reviewer" "reviewers" "revise" "revisit" "reward" "rhesus" "rheumatoid"
 "rhino" "rhythm" "rhythms" "ribbon" "rice" "richness" "ride" "rift" "right" "rights" "rigid"
 "rigor" "rim" "ringer" "ringworm" "rink" "rise" "risk" "risky" "roadblock" "roam" "robot" "robust"
 "robustness" "rock" "rocket" "rockets" "rocky" "rod" "rods" "roe" "room" "root" "rosette"
 ...
 "stone" "stones" "stood" "stool" "stopgap" "stopgaps" "storage" "storm" "story" "straight"
 ...
 "swallow" "sweat" "sweats" "swine" "swollen" "symmetry" "symposia" "symposium" "synergy"
 "syntheses" "synthesis" "syringe" "tablet" "tablets" "tackle" "tackles" "tact" "take" "talk"
 "tandem" "tang" "tank" "tanks" "tap" "tape" "taper" "tapes" "tapeworm" "tapeworms" "taps" "task"
 "taste" "tasteless" "tastes" "taught" "taxi" "taxonomy" "teach" "teacher" "teal" "team" "tear"
 "tease" "technician" "technicians" "technique" "techniques" "technology" "teenager" "teenagers"
 ...
 "tine" "tiny" "tip" "tire" "tires" "tolerant" "toll" "tomography" "tone" "tonsil" "tonsillitis"
 "tonsils" "took" "tool" "tools" "topic" "topmost" "total" "tough" "tour" "tourism" "tourist"
 "tourists" "tournament" "tournaments" "tourniquet" "tours" "toxic" "toxicology" "toy" "toys"
 "trace" "trachea" "tract" "trade" "trainer" "trainers" "trait" "traits" "transcript" "transcripts"
