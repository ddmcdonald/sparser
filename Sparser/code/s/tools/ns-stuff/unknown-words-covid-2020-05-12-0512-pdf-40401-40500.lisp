...
;; created 6/19/20 1:47:40

(in-package :sparser)

;; 3726 extracted as unknown bio-entity
...
("AAV" "ABCG" "ABG" "ACROS" "ADASYN" "ADMET" "AEAEAKAK" "AFB" "AGMP" "AGPT" "AICSEIR" "AIIR" "AIS"
 "AIV" "ANSYS" "APTT" "ARMWG" "ARRIAH" "ARV" "ASGT" "ASHRAE" "ASLV" "ATCC" "AUGGAAGGUCAA" "AUROC"
 "AVMA" "BALT" "BARBARA" "BBB" "BC" "BIOVIA" "BMGF" "BMJ" "BMM" "BPAP" "BRD" "BRDC" "BRMAC" "BRSV"
 "BSE" "BSIF" "BVDV" "BVV" "BWC" "CAAATGCCAGGAAAAGGA" "CACAUUG" "CASV" "CBER" "CBRN" "CCDC" "CCTC"
 "CEPI" "CGAGGAATGGAAGTTGGA" "CGG" "CGP" "CHARMM" "CHEMSCORE" "CHR" "CHV" "CJEU" "CLL" "CLSI"
 "CLSM" "CLUSTAL" "COMZ" "CSCORE" "CSFV" "CV" "CVFF" "CXR" "CZ" "DAA" "DAKO" "DC" "DENV" "DEPC"
 ...
 "FPKM" "FPLV" "FPV" "FUO" "GAE" "GDD" "GENOMICA" "GERF" "GG" "GGTGTTTGATTTGGCCTG" "GGV" "GHP"
 "GIBCO" "GII" "GIRO" "GISAID" "GMS" "GP" "GPRTK" "GTFRCC" "HAART" "HBSS" "HBTU" "HCW" "HDXMS"
 "HETATM" "HFNC" "HFOV" "HIA" "HIVIG" "HKY" "HPU" "HTLV" "HTML" "HTV" "HTVS" "HVAC" "IAV" "IBT"
 "IBV" "ICU" "IDEC" "IDEP" "IDRC" "IHME" "IJV" "ILT" "ILTV" "IMAGENET" "IMED" "IMMSIM" "IMOSFLM"
 "INNOVA" "ISCOM" "ISI" "ISRCTN" "ISRE" "IVIG" "JBC" "JEV" "JHMV" "JMK" "JTG" "KFDA" "LACA" "LARIX"
 "LASV" "LDV" "LETRIST" "LGV" "LIGPLOT" "LIGSITE" "LIPS" "LITV" "LMIC" "LOE" "LPQ" "LSAM" "LTR"
 "LVF" "LVH" "MCB" "MCMV" "MEGAHIT" "MEM" "MEMS" "MEWS" "MHN" "MHV" "MKE" "MMLV" "MODELLER" "MOI"
 "MOLCAD" "MOLPROBITY" "NAMD" "NAPDH" "NASBA" "NESARC" "NHNH" "NIDPOE" "NIOSH" "NIPD" "NL" "NMEDC"
 "NOAEL" "NORS" "NSH" "NVOC" "NVT" "NWAFU" "NZ" "OD" "OIE" "OMIM" "OQF" "PACER" "PBEQ" "PCLV" "PCO"
 "PD" "PF" "PGSI" "PHASER" "PHDTM" "PHENIX" "PICU" "PLV" "PMV" "POCT" "POINTLESS" "PRCV" "PROCGLM"
 "PROCHECK" "PROSITE" "PRRS" "PRRSV" "PSϪ" "PVM" "QA" "QCMD" "QNAT" "QX" "QTL" "RANS" "RAPMAD"
 "RENN" "RFFIT" "RFLP" "RIFIN" "RIGE" "RLU" "RMSF" "ROSC" "RSPU" "RXXS" "SANCO" "SBVS" "SCVJ" "SDE"
 "SEAC" "SEPTEMBER" "SFM" "SFV" "SILI" "SMAP" "SMM" "SMOTE" "SNV" "SOGS" "SOIPPA" "SPECS" "SPMS"
 "SPSS" "SSDI" "STED" "STFT" "SUDV" "SVM" "SWEET" "SYBR" "SYLVIA" "SYSTAT" "SZ" "TBARS" "TBST"
 "TCID" "TEV" "TFEU" "TFMK" "TGEV" "TIFP" "TMEV" "TNE" "TPSA" "TTC" "TTCR" "TUNEL" "TURBO" "TWAR"
 "TWC" "TWH" "TAKARA" "TSB" "UA" "UCSF" "UFMG" "UN" "UNB" "UNF" "UNICZ" "USA" "UVGI" "VDJ" "VEE"
 "VG" "VGG" "VHF" "VJ" "VLSI" "VMRD" "VNA" "VNS" "VV" "WBC" "WFT" "WHU" "WOS" "WOSSVC" "WPT" "XIII"
 "XLSX" "XXIII" "XY" "YBJOM" "YM" "YOLO" "YPCP" "ZELTIA" "ZHWU" "§" "§DSD" "§DV" "À" "ÀNTSZ" "ÀTDS"
 "Â" "Ã" "Ò" "Ó" "Ϫ" "Ϯ" "Ͻ" "Ј" "К" "" "" "" "" "" "" ""))
    :test #'equalp))
...
("aardwolf" "abcdefg" "abortus" "absorbance" "absorber" "acdlabschem" "acquis" "acsnano"
 ...
 "azar" "b" "bacille" "bacithracine" "backfi" "bacteriuria" "bafilomycin" "barbershops" "barcode"
 ...
 "dinoflagellates" "dioxaoctane" "diphenylphosphanyl" "diploids" "dipole" "disassemble"
 "discussants" "disinterest" "dispatchers" "dispersers" "dodecapeptide" "domstolen" "donovani"
 "doseeresponse" "doubleblind" "download" "drafters" "drawn" "droplet" "drugbank" "ds" "duce"
 ...
 "ex" "excretors" "exh" "extremes" "extremum" "exudate" "exudates" "exurban" "f" "facemasks"
 ...
 "fragilis" "frameshift" "frequen" "frozen" "frugivores" "fteen" "fucosyl" "fulfi" "fulllength"
 "fulminant" "fumigatus" "functionall" "funder" "funders" "fundsto" "fungemia" "fuzziness"
 "gallbladder" "ganciclovirresistant" "gasper" "gaspers" "gastro" "gegen" "gelatinlike" "gelatose"
 "gengivitis" "genogroup" "genome" "genomewide" "geojson" "geopandas" "germline" "gingivalis"
 "glabrata" "glomeruli" "glomerulosa" "glutaminyl" "glycobiology" "glycoconjugates" "glycomoieties"
 ...
 "sevenrow" "sh" "shedders" "shortcuts" "shrublands" "shutoff" "sialoglycans" "sialyl" "sidewalls"
 ...
 "written" "www" "x" "xed" "ym" "ys" "ysis" "zona" "zoonoses" "zscore" "zygospores" "¢cv" "§" "§k"
 "þ" "ƒ" "ϩ" "ϫ" "ϭ" "ϳ" "" "" "" "" "" "" ""))
    :test #'equalp))
...
("ACATs" "ADRs" "ATGs" "Accelrys" "Acinonyx" "Additiona" "Aedes" "Affymetrix" "Aga" "Akaike"
 ...
 "Dimorphism" "Dirichlet" "Disley" "DocMorris" "Doremalen" "Dowler" "Dpol" "Dreher" "Drezner"
 "DrugBank" "Dstl" "Dulbecco" "Durham" "DyLight" "DynamicStudios" "Düsseldorf" "Dƒ" "Dƒd" "DƒmƒDV"
 "ECtHR" "EIDs" "ESound" "Echocardiography" "Ectoparasites" "Edward" "Eidgenössische" "Eiken"
 "Emballonuridae" "Emerg" "Emil" "Endsome" "Engdahl" "EpiFluTM" "EpiInfo" "Epistemology" "Eq"
 "Erika" "Ernst" "Etico" "Euclidean" "Europeans" "FACScanTM" "FFRs" "FIas" "Fabricius" "Facepiece"
 ...
 "Geneva" "Genewiz" "Gensim" "Gerais" "Gerdin" "Gerstein" "GetCleft" "Gibco" "Giemsa" "Gieson"
 "Giessen" "Gießen" "Gilbertsville" "Gilead" "Giovannni" "Giudici" "GloGerm" "Globo" "Glostrup"
 "Gluteraldehyde" "Glycosciences" "GmbH" "Goethe" "Goffe" "Gorica" "Goteborg" "Gouy" "GpppN"
 "Graclus" "Graecia" "Grande" "Greek" "Greenmonkey" "Groeneveld" "Grosso" "Gruinard" "Grâce"
 "Guangdong" "Guizhou" "Gulmann" "Gunnels" "Göritz" "HBGAs" "HCWs" "HKs" "HMMs" "Haemogogus"
 "Harbin" "Harvard" "Hawan" "Hcensure" "Heilongjiang" "Helena" "Hellabrunn" "Hendra" "Hepeviridae"
 "Hercules" "Hereford" "Hereon" "Herlitz" "Hesperia" "Hessen" "HiSeq" "Hialeah" "Highflow"
 "Hippocrates" "Histology" "Hochfeld" "Hofma" "Hollywood" "Holstein" "Holte" "Hopkins" "Horne"
 "Houston" "Huanan" "Huayitong" "Huisgen" "Hummeler" "Högsta" "Höner" "Højesteret" "ICFl" "IFNwas"
 "Ibaraki" "IgOme" "Illumina" "ImageJ" "ImageLab" "Imager" "Immun" "ImmunoResearch"
 "Immunologicals" "InVivoMAb" "Indies" "Ingelvac" "InsightII" "Intel" "InterPro" "InterProScan"
 "Internet" "Intervet" "Invariant" "Ipswich" "Irkutsky" "Irvine" "Isaac" "Isando" "IsoMIF"
 "Isoenzyme" "Istituto" "Jacobi" "Jak" "Jalview" "Janeiro" "Jeddah" "Jena" "Jermann" "JetPRIME"
 "Jiangsu" "Jizan" "Jochen" "Johns" "Jorgenson" "Josepth" "Justitie" "Kaggle" "Kahnawake"
 "Kalahari" "Kallick" "KanI" "Kaohsiung" "Kaposi" "Keane" "Kerlero" "Khomas" "Kinbaid" "KinetAsyst"
 "Kinyoun" "Kleczkowski" "Koguchi" "Kollmann" "Konzessionen" "Kremlin" "Krumnow" "Kruuk" "Kuisma"
 "Kupffer" "Kuppeveld" "Kyron" "Köhler" "LCMVimmune" "LFTs" "LMICs" "LabChip" "LabTech" "Lachmann"
 "Lactobacillis" "Ladbrokes" "Laemmli" "Lambda" "Landesgericht" "Lasergene" "Latin" "Laveran"
 "Leerformel" "Leibniz" "Leiden" "Lemma" "Leondina" "LightCycler" "Lindman" "Linux" "Linz"
 "Lippert" "Liverpool" "Loeffler" "LogP" "Lombardia" "Lonza" "Loprazolam" "Loto" "Lumdsen"
 "Luminol" "Lurasidone" "Lushan" "Lutzomyia" "Lyme" "Länder" "MAGPs" "Maastricht" "Macgene"
 "Macroarrays" "Madhya" "Madrid" "Mammalogists" "Mannheim" "Mannweiler" "Mapificatipn" "Mapitope"
 "Marianna" "Markov" "Markus" "Massimiliano" "Massspectrometry" "Mastigophora" "Mateo" "Mato"
 "Maxillofac" "Mayer" "Mazák" "MeNPoc" "MedCalc" "Melinda" "Mellivora" "Mengozzi" "Merkel" "Merler"
 "Mesoniviridae" "Messerli" "MetY" "MetYPCP" "MgCl" "MgSO" "Micronesia" "Microplate" "Microsystems"
 "Millipore" "Miltenyi" "Miltex" "Minas" "Mirri" "Mitterrand" "Mitutuyo" "MoMLV" "Mohawk" "Molbiol"
 "Moloney" "Molossidae" "Moneghan" "Montanide" "Moreoever" "Mormoopidae" "Mucoraceae" "Muench"
 "Multilabel" "Multiorgan" "Multisearch" "Muraoka" "Mx" "México" "NNRTIs" "NaHCO" "NaIO" "NaKtide"
 ...
 "Norcross" "Norsk" "Northampton" "Norwalk" "Novato" "Novoprotein" "Nuremberg" "ORFfinder" "Ohishi"
 "Ohta" "Olmstead" "Olympus" "Omniscript" "Oncology" "Onderstepoort" "Onnuriplan" "Onoue" "Oosten"
 ...
 "Sehra" "Selleckchem" "Semliki" "Sendai" "Sensorgrams" "Septata" "Sezione" "Shaanxi"
 "ShapeTanimoto" "Shaper" "Sheater" "Shenzen" "Shiga" "Shizuo" "Shochat" "Shree" "Sicilia" "Sidaks"
 "SimPlot" "Simplot" "Sindbis" "Sirel" "SiteAlign" "SiteHopper" "SiteID" "Sjöberg" "Skagit" "Skarr"
 "SlowFade" "Snock" "SoND" "Solange" "Sonderweg" "Sorricchio" "Sorvall" "Sota" "Spearman"
 "Sperimentale" "Spicoli" "Springfi" "SrrB" "Stachybotrys" "Staudinger" "Sthik" "Stoss"
 "Strasbourg" "Stuttgart" "Sul" "SuperBright" "SuperPose" "Superscript" "Supp" "Suppl" "Surg"
 "Susumu" "Svehag" "Sverdlovsk" "SwaI" "SwissADME" "Sybr" "Sydnes" "Syndrom" "Systembolaget" "São"
 "TAAs" "TFMKs" "TGFis" "Tadarida" "Taichung" "Takara" "Talampicillin" "Tangail" "Tanimoto" "Taq"
 "Teasdale" "Tensilon" "Terminalia" "Tester" "Theiler" "Thermo" "Thierer" "Thomson" "Toal" "Tocris"
 "Toledo" "TomekLink" "TomekLinks" "Tomlinson" "Tomohiko" "Tonegawa" "TopHat" "Toronto" "Torrance"
 "Torre" "Toyama" "TriPure" "Tribunale" "Trojan" "TropNetEurope" "Trypanosomatidae" "Tukey" "Tulsa"
 "Tübingen" "UAs" "Uberlândia" "Uieda" "Universidade" "Universitario" "Uppsala" "Uttar" "Uvalde"
 "VVimmune" "VacLoks" "Vacutainer" "Valencia" "Vectastain" "Vegas" "Veneto" "Verband" "Verona"
 "Verwaltungsgericht" "Vespertilionidae" "Vespertiolionidae" "Vetem" "Veterinaria" "Veterinario"
 "Vetkefizina" "Vetsuisse" "Vijan" "Vina" "Virgen" "Vol" "VolSite" "Vrenken" "Vydac" "WCBs" "Waals"
 "Walmart" "Waltham" "Warburg" "Wardle" "Warthin" "Wassertheil" "Wavelet" "Weibel" "Weissenberg"
 "Wellcome" "Welle" "Wellesley" "Welte" "Wenchuan" "Westley" "Whitfield" "Wi" "Wilcoxon" "Wildy"
 "Williamsburg" "Willoughby" "Wilmington" "Witt" "Wittchen" "Wlodarczik" "WoSSVC" "Woodroof"
 "Wusterhausen" "Wyckoff" "Xanthium" "Xeon" "XholI" "YpfP" "YycF" "YycG" "ZMapp" "Zeiss" "Zenatti"
 "Zeneca" "Zeturf" "Zhigao" "Zhongnan" "Zhongshan" "Zinberg" "Zmapp" "Zooprofilattico" "Zuc"
 "Zurich" "aIso" "advisabIe" "affiFAP" "BehaveNet" "Trichotillomania" "bioMérieux" "Biosolids"
 "Botulinum" "cGPK" "chemicaI" "Concholepas" "Crocuta" "cuVs" "diVerentiate" "diYculties" "eVect"
 "eVectiveness" "eYcacy" "foUovvr" "gBlock" "gG" "gIII" "hARF" "iE" "iQ" "inhibitoOO" "jQuery"
 "kNN" "Leadquest" "mMachine" "mMessage" "Maybridge" "miRISC" "minfDSD" "Myotis" "nRBCs" "ncvRNAs"
 "oBIFs" "oncomiR" "oncomiRs" "pBAC" "pCAGEN" "pCINeo" "pETYycG" "pGARV" "pII" "pK" "pLysS"
 "pNaKtide" "pTXB" "permP" "piRISC" "rJHMV" "rProtein" "rRT" "repHcate" "ResearchGate" "scVI"
 "Scopus" "siRISC" "taniM" "taniMW" "taniNormNodes" "theYycG" "traYc" "uL" "usA" "vaHd" "vsRNA"
 "vsRNAs" "xFLAG" "xRSx" "Érika" "ÔminorÕ" "ÔmixedÕ" "ÔopenÕ" "Ömer" "ϩsgRNA" "ϩssRNA" "ϪsgRNA"
 "ϪsgRNAs" "Ϯstandard"))
    :test #'equalp))
...
("ALEXANDER" "Ababneh" "Abbott" "Abro" "Achiron" "Acree" "Adams" "Addie" "Adom" "Agusti" "Aharoni"
 ...
 "Meyers" "Michael" "Minguela" "Miyamoto" "Moalem" "Monney" "Montgomery" "Moore" "Morris" "Mourão"
 "Mrksich" "Mukhopadhyay" "Muller" "Munn" "Muraro" "Musette" "Myers" "Müller" "Naesens" "Nager"
 "Nahar" "Nakagawa" "Nakamura" "Nanni" "Naqi" "Narin" "Naspitz" "Navara" "Ndifuna" "Neil" "Nelson"
 "Newbold" "Newell" "Newman" "Newton" "Nguyen" "Nichol" "Nicholls" "Nie" "Nielsen" "Niesters" "Nii"
 "Nipah" "Nogueira" "Nolan" "Nunes" "Nunn" "Oany" "Oertelis" "Ogata" "Ohinata" "Ojala" "Ojansivu"
 "Okino" "Oksenberg" "Oliveira" "Olson" "Olsson" "Onouchi" "Organtini" "Ornato" "Otsuki" "Ouyang"
 "Ozturk" "PUI" "Pacheco" "Palermo" "Paltrinieri" "Panitch" "Parlos" "Parrish" "Parveen" "Pasteur"
 "Patel" "Pattabiraman" "Patterson" "Pauli" "Pearson" "Pedersen" "Peiris" "Pelfrey" "Pell" "Pena"
 "Pereira" "Perini" "Perlman" "Petry" "Pfeffer" "Phillips" "Phromnoi" "Planzer" "Pollock" "Posada"
 "Povey" "Prineas" "Promkuntod" "Purpari" "Pérez" "Qiagen" "QIAGEN" "Raad" "Rabinovich" "Racke"
 "Raggi" "Rahman" "Rahtu" "Raine" "Ramachandran" "Raman" "Ramasundram" "Ramella" "Ramirez"
 "RansohoV" "Reichard" "Reinke" "Reis" "Reiskind" "Reiter" "Reshi" "Reynolds" "Richardson"
 "Richmond" "Richter" "Riegel" "Ringler" "Rio" "Rizzi" "Robson" "Roche" "Rockhill" "Rodrigues"
 "Rodriguez" "Rogers" "Roncarolo" "Roque" "Rothman" "Rowe" "Ruf" "Rupprecht" "Russo" "Sabatos"
 "Sah" "Saif" "Saji" "Sali" "Sanna" "Sapats" "Sarma" "Sartore" "Saunders" "Sazzad" "Sc" "Scalco"
 "Scarano" "Schalk" "Schaller" "Schalm" "Scheid" "Schindler" "Schmidt" "Scholz" "Schopman"
 "Schreiber" "Schrijver" "Schultz" "Schutkowski" "Schuurs" "Schwartz" "Schwarz" "Schweitzer" "Seah"
 "Seeberger" "Seger" "Selin" "Selmaj" "Seo" "Seto" "Shaffer" "Shapshak" "Shimazaki" "Shulla"
 "Shulman" "Si" "Sielaff" "Simmons" "Sindern" "Sippl" "Sirinarumitr" "Sliwoski" "Smits" "Sorensen"
 "Sparkes" "Stadecker" "Stanley" "Stecher" "Steckler" "Stenglein" "Stephens" "Stoddart" "Straube"
 "Stroeymeyt" "Sumi" "Sung" "Surh" "Szabo" "TU" "Taharaguchi" "Tai" "Takeda" "Takeuchi" "Talbot"
 "Tambone" "Tamura" "Teixeira" "Teleshova" "Tella" "Thachil" "Thierfelder" "Thomas" "Tian"
 "Tijssen" "Tingpalapong" "Toffan" "Tomassini" "Tomek" "Tompkins" "Toney" "Toro" "Touihri" "Towner"
 "Trapp" "Traugott" "Travers" "Triboulet" "Trott" "Truyen" "Tschirren" "Tucciarone" "Turmelle"
 "Tyler" "Uehara" "Ullah" "Underdahl" "Urbani" "Utz" "Vaillant" "Valenzuela" "Vandenbark"
 "Vandenberghe" "Vanderlugt" "Velazco" "Veldhoen" "Vennema" "Verheul" "Verçoza" "Viglietta" "Vilar"
 "Vilella" "Voss" "Vyas" "WBF" "Wagner" "Walsh" "Warnecke" "Waterhouse" "Watson" "Webb" "Webster"
 "Weidner" "Weiss" "Wenfu" "Wenzel" "Wertheimer" "Westbrook" "Whipp" "Whitney" "Wiederstein"
 "Wilcox" "Wilhelm" "Wilkinson" "William" "Williams" "Wilson" "Windhagen" "Winssinger"
 "Winterfield" "Woldehiwet" "Wolfe" "Wong" "Woode" "Woodroofe" "Woolhouse" "Worldometer" "Wu"
 "Wucherpfennig" "Wund" "Xiang" "Xie" "Xu" "Yagi" "Yamaguchi" "Yang" "Yao" "Yeates" "Yednock" "Yeh"
 "Yeung" "Yi" "Yong" "Yosef" "Youssef" "Yu" "Yudong" "Zaki" "Zamvil" "Zanaty" "Zeng" "Zhan" "Zhang"
 "Zhao" "Zheng" "Zhong" "Zhou" "Zhu" "Zhuang" "Ziemssen" "Zou" "Zuk" "Milstein"))
    :test #'equalp))
...
(defparameter BIO-ENTITY-covid-2020-05-12-0512-PDF-40401-40500
    (remove-duplicates
      (append 
         ...
         '
("!1" "!3" "!5" "#1" "#11160" "#15}" "#16424" "#2" "#293-230" "#3" "#4" "#6" "#7" "#L8754"
 "$1 billion" "$3,000" "$38.5-40" "$39" "$5-6" "$50" "$50 m" "$7,000" "&i" ")/fluorogen" ")/r"
 ")/signal" ")/Tween" "**" "***" "*+" "*Includes" "+/-standard" "+15" "+1A" "+RNA" "--that"
 "-1,1,1-trifluoropropan-2-one" "-1B-1C" "-4-phenyl-1,1,1trifluorobutan-2-one"
 "-ATCCTCCAAGGAGGCTATGC-3" "-C:C:G:C" "-CGG-immunized" "-COMZ-" "-D-" "-diamidino-2-phenylindole"
 "-GCCTGACATCTGAGGACTCTGC-3" "-GCGAATTCTGGATCGTTGTT-3" "-meth-yltransferase" "-NOE-" "-NS2"
 "-O-methylation" "-OPN-" "-TCTCCAGTTTCGGCTGAATCC-3" "-TGAGACCGAGGCTAGATGCC-3" "-USP15-WT"
 ...
 "0oligoadenylates" "0·005" "0·20" "0·98" "1 µg/ml" "1,000+" "1,3,5-hydantoins" "1,3,5-triazines"
 "1,4-butanediol" "1,8-diamine-3,6-dioxaoctane" "1-nitro-2-phenylethane"
 "1-thio-␤-Dgalactopyranoside" "1-trifluorobutan-2-one" "1.140/4.78" "1.1Â10" "1.67GHz" "1/" "1/10"
 "1/100" "1/1000" "1/20" "1/200" "1/2019" "1/3" "1/8" "1/80" "1/p" "10.1038/srep11220"
 "10.1159/000503030" "100/" "1000×g" "100°C" "100°C." "100°F" "101{125" "106°F" "10^" "10^^" "10a"
 "10b" "10e12" "10to" "11,42,80e85" "11-mercaptoundecyl-tri" "1101 /2020" "11a" "11g/dl" "12/15"
 "12/29,756" "125°C" "126{150" "129SvEv" "12:4-20" "13.2 g/" "13e15" "13mers" "14,69e74"
 "14.9 g/dL" "14/25" "148amino acid" "14a" "14b" "14c" "14d" "15-20-fold" "15.5 g/dL" "150.000/"
 "15e19" "15°C." "16,000×" "16,26,28e30,43" "16,27,31e34,39,41,43" "16,32e34" "16,43a"
 "16-mercaptoundecanoyl-NHS" "16/31" "16e18" "16hpi" "17 N95" "17Cl-1" "18b" "19.3°C." "1982a"
 "1982b" "1983a" "1983b" "1987a" "1989pg143" "1995a" "1999a" "1999b" "19e25" "19°C." "1:40-1:80"
 "1:l" "1BXD" "1cqq" "1e10" "1e4" "1I-1L" "1KQR" "1L1N" "1lvo" "1p9s" "1p9t" "1p9u" "1pa5" "1page"
 "1q2w" "1RA6" "1st" "1UJ1" "1UK2" "1UK3" "1UK4" "1X3" "1{e" "2 /FiO" "2 /τ" "2 h/day" "2+" "2-5A"
 "2-∆∆C" "2.55333e-55" "2/2" "2/3" "2/6" "2/7" "2/group" "20 g/m" "20%e35%" "20-dayold"
 "20-yearold" "20.9+27.6" "200 g/liter" "2000/31" "2001a" "2001b" "2001pg1482" "2002e2003" "2003a"
 "2003b" "2003pg745" "2005a" "2005b" "2006/2007" "2007a" "2007b" "2008a" "2008b" "2009a" "2009b"
 "2010a" "2010b" "2011_12" "20131017/02" "2014a" "2014b" "2015a" "2015b" "2019ncov" "2020a" "2020b"
 "20a" "20b" "20°C." "20·0" "21 ± 1°C." "21.72+/20.43" "21−23°C" "22.05+/20.33" "22°C" "23-80°C"
 "23°C" "24°C." "25 g/L" "25.4°C" "25.93+/20.59" "25e100%" "25{50" "25°C" "25°C." "26 g/L."
 "26.90+/20.38" "26/34" "28 g/L." "284/917" "29°26.0927" "2DWR" "2EBO" "2FYG" "2G12" "2IJD"
 "2nd_Interview_COVID-19_ECCO_Taskforce_published" "2OQ5" "2plusfour8994e" "2XYQ" "2xYT" "2YT" "2·"
 "2×" "2×2" "2×3" "2Ј-O-methylation" "2Ј-O-MTase" "2ЈO" "3 /s" "3 g/day" "3+"
 "3,3-diaminobenzidine" "3,3′,5,5′-Tetramethylbenzidine" "3-Amino-9ethyl-carbazole" "3-aminopropyl"
 "3-Hydroxy-3-methylglutaryl" "3.1A" "3.1™" "3/29,756" "30 µg/ml" "30/109" "30a" "30°C"
 "318:727-732" "31°C" "35,36,39e42" "35°C" "37.3℃" "37.5°C." "37.5ºC." "37.8°C" "37/319" "370aa"
 "37°" "37°C" "37°C." "388/00" "38°C." "39/182" "3=" "3ab" "3B ." "3C-like" "3CD" "3CL" "3Cpro"
 "3D." "3dimensional" "3Dpol" "3Drefine" "3l/minute" "3specific" "3T3" "3T3-L1" "3xFLAG"
 "3xFLAG-tagged" "3×3" "3Ј-5Ј" "3Ј-polyadenylated" "3Ј-proximal" "4 g/dL"
 "4,5-dimethylthiazol-2-yl" "4,6-diamidine-2-phenylindole" "4-carboxybenzaldehyde" "4.37%+/20.28%"
 "4/91" "41°C" "42T>C" "42°C" "42°C." "43b" "45°" "488labeled" "49/62" "49e51" "4A ." "4a's" "4a-g"
 "4B ." "4D." "4DRR" "4DRV" "4DSO" "4F." "4F10" "4G2K" "4hydroxy-3-nitrophenylacetyl-chicken" "4°C"
 "4°C." "4·8%" "4×4" "4×MIC" "4μ8C" "5,5tetramethylbenzidine" "5.2/5.3" "5.2/5.3þ" "5/7" "5/80"
 "50 /g" "50 /mL" "50°C" "51{75" "52ЊC" "53e55" "56e58" "56°C" "57,74e76" "57.30%+/24.15%" "5="
 "5a-h" "5A/G" "5ab" "5d-e" "5e25%" "5e8" "5´-CACAAUAGAUACAAUUGAA-3´" "5´-CACAUUG"
 "5´-CUCUUGAGAAUGUGCCGAU-3´" "5´-UUCUCCGAACGUGUCACGUTT-3´" "5·5%" "5·7%" "5×106" "5×5" "5Ј-3Ј"
 "5Ј-capped" "5Ј-CATATGCGGCTCTGATGGCTTGAAACTG-3Ј" "5Ј-CCTGTCCTTCCACTCTACCATC-3Ј"
 ...
 "6 /mL" "6-azidohexylamine" "6-O-alkylguanine-fluorophore" "6/" "6/29" "6/group" "60°C" "610aa"
 "630P-NS2" "630×" "63×" "65°C" "68ЊC" "6_8_Surveys" "6_Publication" "6A-C" "6a-d" "6D10" "6e-h"
 "6e8" "6LU7" "6·1%" "7 /g" "7 /ml" "7,47,65e67" "7/210" "70/30" "70°C" "72%e84.9%" "75°C" "76{100"
 "793/B" "7e9" "8 /ml" "8-epi-PGF2α" "8.53/12.325" "8.9Â10" "80/480" "80/60" "80U/L" "80°C" "85°C"
 "86e90" "8mer" "9 /g" "9 /L" "9-11-day-old" "90/50" "90e95%" "95%/5%" "95/284" "95°C" "95ЊC"
 "96well" "99°41.0774" "9cfr113.35" "9mers" "9residue" ":hat" ":~3km" ":~m" "<0.00001" "<0.05" "<1"
 "<10" "<100°C" "<100°C." "<150" "<18" "<20" "<26%" "<30%" "<40" "<48.5" "<5" "<500" "<6" "<80%"
 "<http://asparagin" "<http://blast" ">1 m" ">1-2" ">10" ">10-fold" ">1000" ">15" ">200" ">220"
 ">24 h" ">30" ">300" ">38" ">4" ">4 h" ">5" ">50" ">50%" ">51" ">6" ">60 %" ">65°C" ">7" ">70%"
 ">70°C" ">7700" ">8000" ">85%" ">90%" ">95%" "@O" "\\1%" "\\E" "\\fa" "\\fab" "\\S" "\\X"
 "\\|0.2|" "^NOAEL" "^The" "^These" "^Toxic" "a /0" "A&F" "A+/H+" "A-family" "A-infected" "A-or"
 "A-trisaccharide" "A-type" "A/" "A/B" "A/G" "A/S" "A/WSN" "A11R" "A11R>E7R" "Abou-Zahr"
 "absence/presence" "acceptor/donor" "ACE2/high" "Acelullar/Virus" "acid-labile"
 "activated/caspasecleaved" "acyl-enzyme" "AG7088" "AG7088-bound" "AGC/GUAAU" "Age-repro" "AGPs…"
 "air/CO" "Al-Mulla" "Al-Tawfiq" "Align123" "allo-cross-reactivity" "allov\\^s" "allov^" "allow^s"
 "amine-NHS" "analyte-receptor" "and/" "and128" "and~19-21" "Angus-Hereford" "anti-A-type"
 "anti-and" "anti-apoptotic" "anti-atherogenic" "anti-Atype" "anti-B cell" "anti-bacterial"
 "anti-biotin" "anti-BrdU" "anti-ccv" "anti-ccv-c54" "Anti-CD154-dependent" "anti-cfv"
 "anti-cfv-c54" "Anti-CMV" "anti-Coronavirus" "anti-CoV" "anti-COVID-19" "anti-coY-c54"
 "anti-death" "anti-digoxigenin" "anti-dog" "anti-fade" "anti-feline" "anti-gambling" "anti-H"
 "anti-H2" "anti-HA" "anti-His-tag" "Anti-IBV" "anti-IgG1" "anti-inflammatory" "anti-M13"
 "anti-microbial" "anti-mouse" "anti-PDCoV" "anti-phosphor-IRF3" "anti-phosphor-NF-κ"
 "anti-phosphoribosome" "anti-phosphotyrosine" "anti-pig" "anti-porcine" "anti-rabbit" "Anti-RBC"
 "anti-Renilla" "anti-Sialyl-LeX" "anti-swine" "anti-T-lymphocyte" "anti-T." "anti-thrombotic"
 "Anti-TNF" "anti-tussive" "anti-viral" "anti-virals" "Antibodies-Anti-GFP" "anticcv-c54"
 "anticfv-c54" "antigen-MHC" "antigen/pathogen" "antigens/peptides" "an~2-fold" "an~2-to" "an~22"
 "approximately two-fold" "April-July" "area^and" "arenavirus-like" "are~24-30"
 "artemether/lumefantrine" "articles/sources" "as-yet" "AT1R-NADPH" "ATCC12228" "ATF6n"
 "AUGGAAGGUCAA-3´" "August-September" "author/funder" "author´s" "auto-antibodies" "auto-antibody"
 "autophagosome-like" "Avila-Flores" "AY451856-AY451963" "AY702975" "AY864800" "AY864800/AY864801"
 "a~70" "Að0Þ" "b /0" "B.A." "B.V." "B.V.V." "B=B" "BA^as" "Bacteria/Streptococcus" "Baecher-Allan"
 ...
 "Benjamini-Hochberg" "Benzyloxycarbonyl-L" "betw^een" "BFL-1/A1" "Bfl-1/A1" "BH3-like"
 "BH3containing" "BH3only" "BH4containing" "BHK-Tet-SARS-N" "BHRF1" "Bid-like" "Bio-Rad"
 "Biochemi-cal&" "biotin-streptavidin" "biotin/streptavidin" "BKVVP1" "BLAST/n" "blood/brain"
 "BMLF1" "BMS-188667" "Boa3" "Boc-γGlu" "Borderline-1" "bowtie2" "breaths/" "breaths/min"
 "Brunet-Rossinni" "BTA13" "BTA15" "BTA17" "BTA18" "BTA3" "bugs!" "Burban^" "BX53" "Bα" "B€" "C*"
 "C3H" "c3HTdr" "C57BL/6" "C57Bl/6" "C57BL6" "C57Bl6" "C@O" "ca/" "CaHV-1" "Cal99"
 "Calmette-Guérin" "canonical/other" "capping/protection" "carbohydrate-lectin"
 "carbohydrate-protein" "cat /K" "Caucasian/Hispanic" "cavity/nasaloropharyngeal" "Cbz-Ala-Val-Leu"
 "CC-BY-NC-ND" "CCAAT-enhancer-binding" "ccv-c54" "ccv/canine" "CD19+" "CD27+" "CD3þ" "CD4and"
 "CD4þ" "CD4þCD25þ" "CD4þCD25þFoxp3" "CD4þCD25þFoxp3þ" "CD8þ" "CD8þCD28À" "CDR3s" "CEACAM1a"
 "cell survival/death" "cell/ml" "cells/well" "cellular/immunologic" "CFU/animal" "cfv-c54"
 "cgi-bin" "CGP77116" "cg~6" "change/host" "CHARMM-GUI" "check/test" "chemicals/particles"
 ...
 "CMX001" "co-factor" "coiled-coil" "com/" "com/addict" "com/authors" "com/capsules"
 "com/locate/tmaid" "com/pachterlab/BP_2020" "com/questions" "com/rna" "Congo-Crimean"
 "consulting/technical" "copies/g" "copies/mL" "copies/ng" "Copolymer-1" "covid*" "CPV-2a" "CPV-2b"
 "CPV-2c" "Crimean-Congo" "CRISPR/Cas9" "crown-like" "CRW-8" "CTLA-4-B7-1/2" "CTLA4Ig" "CUHK-AG01"
 "CUHK-AG02" "CUHK-AG03" "Culture-HEK 293T cells" "culture/animal" "CURB-65" "CV777"
 "cyclophosphamide/" "cytoplasmic/nuclear" "Cα" "Cα-Cβ" "Cβ" "D+" "D+/R+" "D.S" "D328Oγ" "D336Oγ"
 "D90A/E92A" "Data-Analysis&" "data/knowledge" "day-by-day" "day-to-day" "Dbf2-Mob1"
 "Dcr-2-mediated" "DDBJ/EMBL/" "de-ISG15ylating" "DE\\E" "deaths/" "deaths/confirmed"
 "defibrillation/public" "Derp1" "DESC1were" "Dess-Martin" "DExD-box" "DExD/H" "dH6.2" "DHF/DSS"
 "Diaz-Villoslada" "Diels-Alder" "Diff-Quik" "dis-Four-point" "Discover_3" "distal-eQTL" "dL5"
 "dL5**" "DNA polymerase®" "DOCK-like" "dodecylsulphate-polyacrylamide gel electrophoresis"
 "DPB1*0401" "DQ355221" "DQ811787" "DQA1*0102" "DQB1*0602" "DRB1*1501" "drug-like" "drug/vaccine"
 "DS/DL2" "dz1" "E-value" "E1-E7" "E289Oδ" "E290Oδ" "E292Oδ" "E301Oδ" "E343Oδ" "E344Oδ" "E7R"
 "E7Rspecific" "E?S" "E?½1" "easier/harder" "EBNA-1" "EBNA-2" "EBOV/MARV" "editorial_policies"
 "edu/" "edu/3Drefine/" "edu/chimera" "edu/ERRAT/" "edu/RaySoft/SimPlot" "edu/users/dml/Software/"
 "Egy/Var" "eIF2α-dependent" "eIF2α-independent" "eIF2α-phosphorylation" "eiF4GI" "eight-week"
 "elF4E" "elF4G" "ELISA-like" "EMC1" "EMC1-EMC6" "EMC4" "Emergencyplanning/DH_4069610"
 "encouragement/" "endosomal/lysosomal" "ENN/RENN" "ER2738" "ERstress-induced" "eu/" "EU/EEA"
 "eu/images" "European-like" "evidence^" "ew0" "excellent/good" "expression/activity" "F.S."
 "f0,1g" "F1-Score" "F19A" "F508del" "factor-kappa" "families/" "FAPs/fluorogen" "Fc-g"
 "features/cm 2" "feeding-•" "FFP2" "FFP3" "FG1" "FHV1" "fibrosis/hepatic stellate cell"
 "Filoviridae-like" "filovirus-like" "first-time" "FIV-like" "FIV-Z2" "FKPB12" "FLA3000"
 "flagella-like" "Floatage-based" "flow-cytometry" "flu-like" "Fmoc-8amino-3,6-dioxaoctanoic"
 "fmol/mm" "follov^ing" "Follov^ing" "follovs^ing" "follow^ing" "Food-borne" "foUow^ing" "FPL/01"
 "FR-E+" "Frankfurt-1" "from/to" "Fucα1-2" "function/dysfunction" "Fungus/Pneumocystis" "G+C" "G.L"
 "g/ml" "g/mL" "GA-20" "galactin-9" "galectin-like" "GalNAcα1-3" "Galβ1-4GlcNAc" "Gasterger-Hückel"
 "GB2626" "GCCTCGAGTTATTCATC-CCAATCACCGTCT" "GCF_001685135.1" "GCGGATCCACAACAACAAGTC-GAACGTGAAC"
 ...
 "Gru¨nwald-Giemsa" "GS1783" "GSE12487" "GSE124872" "Guandong" "Guillain-Barré" "G~" "H&E" "H+"
 "H+/A+" "H.J." "H.U." "H1N1/" "H1N1/2009" "H2N2" "H5N7" "H7N7" "H7N9" "H9N2" "H:L" "HA-USP15-WT"
 "hACE2" "HAL1166" "Hap3p" "Hardy-Weinberg" "Hasegawa-Kishino-Yano" "HATPase_c" "HBS-EP" "HCDR3"
 "HCoV229E" "hDPP4" "health/welfare" "HEK 293T cells" "Hela/" "Helsinki--costs" "Hereford-Angus"
 "HEV-3f" "hexanes/" "hexanes/EtOAc" "His-6" "his/" "HIV+" "HIV+/HIV+" "HKU-39849" "HKY+G" "HLA-A2"
 "HLA-A2-restricted" "HLA-A2restricted" "HLA-B8" "HLADRB1*1501" "hov\\^" "Hov^ever" "How^ever"
 "hRL-TK" "Hsieh-Wilson" "HT29" "htm#ctv" "html#terms" "http://biorxiv" "http://bonsai"
 "http://europa" "http://pymol" "http://sysbio" "http://usa" "http://userweb" "http://www"
 "https://blast" "https://cgenff" "https://doi" "https://ecco-ibd" "https://en" "https://github"
 "https://pypi" "https://stackoverflow" "https://www" "https://zinc15" "Humaita-Tubiacanga" "HuN4"
 "Hybond-ECL" "hydrolysis/condensation" "h~maxf2dk" "I/S" "I:C" "IBV-like" "id:1KQR" "iden-•"
 "IDF0571" "IFITM3_1_F" "IFITM3_2_R" "Ifitm3e/e" "IFN--induced" "IFN--producing" "IFN-1b" "IFN-α/β"
 "IFN-β1a" "IFN-␤" "IFN-␥" "IFN1" "IFNAR1/2" "IgA+" "IgG+" "IgG1as well as" "IgGanti-ccv"
 "IL-10producing" "IL-12R2" "IL-28" "IL12p40" "ILSVRC-2012" "imipenem/cilastatin" "immunity/health"
 "In-vitro" "Inception-ResNetV2" "Inception-V3" "InceptionResNetV2" "India/" "infec-•"
 "infected/transformed" "infection/vaccination" "influenza-like" "inhibitor-protease" "injury/ARDS"
 "innate/adaptive" "InsTAclone™" "intention-to-treat-population" "interferon alpha/"
 ...
 "IU/ml" "IU/mL" "IVRI" "Iwata-Yoshikawa" "IZSSI_PA5632/19" "Iκ" "J.A.O." "J.M." "J/" "J/cm 2"
 "J558DJ" "Jak/STAT" "Javascript-enabled" "JEM-1200" "Jensen-Shannon" "job/school" "jp/"
 "JP/Iwate/2005" "JP/Wakayama" "JP/Wakayama/2003" "JQ065043" "JQ619485" "JQ619486" "JQ619487"
 "Jukes-Cantor" "Juul-Madsen" "JX087437.1" "K.P." "K340Nε" "K346Nε" "K347Nε" "Kaplan-Meier" "kcal/"
 "kcal/mol" "Kenner-type" "Ker-Optika" "KF94" "kg/dose" "kg/m" "Kinase-Glo™" "kinase/inhibitor"
 "kinase/signal" "kinetic-state" "Kleinschmidt-Demasters" "KM91-like" "KN95" "knob-like"
 "Kruskal-Wallis" "Kruskall-Wallis" "KZ7088" "k{1" "k{1zd" "k~2" "k~3" "L-cGlu-L" "L.K." "L.L."
 "L/h" "L/min" "L/s" "L/well" "L45A" "L5*" "Langer-Gould" "LCMV/PV" "LDL/110931" "LDL/97I"
 "LDL/97I-like" "LDT3"
 "legislation_summaries/economic_and_monetary_affairs/institutional_and_economic_framework/"
 "Leishman-Donovan" "Leu-Gln#" "Leu-X3-Gly-Asp" "leukemia/lymphoma" "lg/mL" "lidocaine/"
 ...
 "m=1" "mAb114" "mAb4400" "mAb4410" "macrophage-like" "Madin-Darby" "Maia-Elkhoury" "Mandin-Darby"
 "ManJav1.0" "Mann-Whitney" "Manα1-2Man" "MAP 1LC3" "MAR1-5A3" "Markovic-Plese" "Martínez-Sánchez"
 "masks/PPE" "masks/respirators" "MAVS/" "maxf2dk" "May-Gru¨nwald" "MBC/" "MD-82" "mdehoon/"
 "MEGA2" "mEq/L" "metallo-proteases" "method/route" "MG-11p" "MG-2p" "mg/" "mg/day" "MG/FAP"
 "mg/kg" "mg/L" "mg/L." "mg/ml" "MG197988" "MG3-35" "mice/" "mid-1990s" "mid-June" "mid-March"
 "mid-September" "min/cycle" "miR-125a-5p" "miR-125b" "miR-130b" "miR-130bdependent" "miR-15a"
 "miR-17-5p" "mir-17/92" "miR-17/92" "miR-199a-3p" "miR-20a" "miR-29a" "misfolded/unfolded" "ml-l"
 "ml/animal" "ml/kg" "ml/min" "mM/l" "mmol/L" "mol/l" "mole-FIQ" "molecule-protein" "molecules/ml"
 "mononucleosis-like" "Montanide™" "Mpro_Talampicillin" "Mpro_ZINC000015988935" "Mueller-Hinton"
 "multi-BH" "multi/bilateral" "mutagen-like" "MX97-8147" "Myc-USP15-WT" "myelopathy/tropical"
 "m~DE" "N-and" "N.G." "N/D" "N/k" "N/L" "N1H1" "N95/FFP3" "N95/Filtering" "n=" "n=3" "n=319" "N=5"
 "n=62" "Native/Native" "Navier-Stokes" "NBI-5788" "NC_002976" "NC_004461" "net/"
 "neutralizing-antibody" "NF-xB" "ng/dose" "NGI-1" "nH1N1" "nH1N1and" "NHS/" "nM/cm 2" "NM_006313"
 "NM_021034.2:c" "NMC-nCoV02" "NMK" "nmol/L" "nN1H1" "non-Bcl-2" "non-BH" "non-HCVimmune" "non-PAD"
 ...
 "nsp1a-Rluc" "nsp1α" "NSP1α-luciferase" "nsp1α-Rluc" "nucleic-acid-sequence-based" "Nε" "O/W"
 "O15393" "O157:H7" "o30" "OD1" "OD2" "of~20-23" "of~22" "OH-FD100" "OH-FD22" "OmpR-like"
 "oncomiR-addicted" "Oneday-old" "Only 2/196" "only 4/228" "or/and" "orf1a" "ORF1a/1b" "orf1ab"
 ...
 "patient/day" "PAXdeltaC20" "Paño-Pardo" "pBAC-based" "pBAC-rJHM" "pBAC-rJHMV" "pBeloBac11"
 "PBS/Tween" "pCAGGS-HA" "pCAGGS-MCS" "pCAGGS-Myc" "pcDNA3.1-Flag-Ub" "pCINeo-3xFLAG" "pCMV-Luc"
 "pCR2.1" "PD1-PD" "PDCoV-N-ELISA" "pDest14/" "pDest14/His 6" "pDONR207" "PE-anti-B220"
 "PE-antimouse" "PEanti-CD3" "pEF-Flag-RIG-I-N" "Pen-Strep" "penicillin/streptomycin" "people/km"
 "peptide-MHC" "peritonitis-like" "Perkin-Elmer" "person/km" "Personto-person" "pET-32a" "pET22b"
 "pET28a" "PF00452" "PF3" "PFU/cell" "pfu/ml" "pg/ml" "pg171" "pg254" "pg339" "pg407" "pg510"
 "pg52" "pg59" "pg659" "pg688" "pg697" "pg827" "PG9" "pGEX-6P-1" "pGEX-6p-1" "pGL4.74"
 "pGL4.74-hRL-TK" "pH7.4" "pharmaceutical/medical" "phosphate-buff" "phosphate/" "phRL-TK"
 "Phylip3.6" "physical/biochemical" "physical/chemical" "PI16" "pIICASV-GP2" "pIICASVGP2"
 "piperacillin/" "Piperacillin/tazobactam" "pISRE-Luc" "pJFK3" "pJFK4" "pleural/ascitic"
 "pNRLuc-nsp14" "Pohl-Koppe" "Poisson-Boltzmann" "police/fire" "polylactide/glycolide"
 "Polymerase™" "polynomial-time" "post-NP" "PPE/PRPS" "PRDIII-I" "pre-IND" "present-day" "PRESTO!"
 "problem/issue" "ProBond™" "projection-antibody" "promoter/enhancer" "Protein 4a" "Protein A+"
 "Protein A/" "protein A/G" "protein G3BP1" "protein!" "protein-calorie" "protein-phosphotungstate"
 "proteomic/NGS" "PS01259" "PSϪ3.2" "PSϪ4" "PS؊" "pTXB1-nsp14" "pUC19" "pUC19-FR-HuFulHEV3f"
 "pUL56" "Pune" "PV-3Dpol" "PXT1" "P~NP" "p≤0.05" "Q&A" "Q5®" "q6h" "Q8K459" "QA/QC"
 ...
 "RP62A" "rPD-CoV-N" "rPDCoV-N" "rPDCoV-N-ELISA" "RPN1/2" "RQ1a" "RQ1b" "RQ2" "RQ3" "RQ3a" "RQ3b"
 "RQ4" "rs12252" "rtRT-PCR" "rub-ber" "rubella-antibody" "RYDLS-20" "S-Gene 3-E-M-Gene"
 "S-rosettes" "S.A.U" "S/N" "S/P" "S1C" "S1c" "S1D" "S1E" "S1F" "S1G" "S2A" "S2B" "S\\fa"
 "saddle-like" "Santa-Cruz" "Sar55" "sarco/endoplasmic reticulum" "SARS-like" "SARS/MERS-CoV"
 "SARS_AAR07630" "SASRS-CoV-2" "SC-476" "SC10" "SC18" "SC20" "SC22-23" "SC22-SC23" "SC27" "SC28"
 "SD/Mean" "SD16" "SD=0.2" "SD=0.3" "SD=0.4" "SD=0.5" "SD=1.6" "SD=12" "SD=4" "SD=4.7" "SD=7.2"
 "Sec61α" "self-MHC" "sensors/inflammatory" "sequences/cm 2" "Ser14=" "SERCA2a" "Serpine1e/e"
 "serum/the" "Seven-μm" "sgRNA7" "Shapiro-Wilk" "show^" "Si-Pi" "Sialyl-Lex" "sic!" "Sigma-Aldrich"
 "Sima-Aldrich" "siUSP15-1" "SKMCH&RC" "small-envelope glycoprotein" "Smart-Lifesciences"
 "SMOTE+TL" "SNU01" "sources/reservoirs" "South_Korea" "so…" "space/gleaning" "SPECS_1"
 "sponge-like" "sponsor/investigator" "spots/cm" "spring/summer" "SrrB/SrrA" "stability/"
 "state-of-the-art" "state/central" "state/region" "states/regions" "steady-state" "Strep-nsp10"
 "Strep-Tactin" "Strep-Tactin-Sepharose" "Strep-tagged" "Strep-TagII" "STT3A/B" "sub-Saharan"
 "Sunway-1" "Superdex-75" "Susceptible-Exposed-Infected-Removed" "swab/organ" "Sybyl6.8" "SYBYL6.9"
 "symptomatic/unapparent" "System/HRP" "systems‖" "systems…" "SZ-16" "SZ-3" "Szent-Gyorgyi"
 "SZTH-001" "T-and" "T-cell-like" "T-or" "T92+G+I" "T:T:T:T" "T:T:T:T-in" "taylor@jtgconsulting"
 "TC1DS0" "TCD50/ml" "TCID50" "TCID50/pig" "TCIDS0 g-l" "TCRpeptide-MHC" "Tebu-Bio" "Teflon/epoxy"
 "Tejada-Simon" "temperature/RH" "Tennantq989" "tested，in" "TGF--producing" "TGF-β4" "Th17"
 "TH81A5" "THA280252" "The~supernatant" "TIB-MOL-BIOL" "TIP3P" "TM95" "TMEV-IDD" "TMP-SMX"
 "TMPRSS2_Rubitecan" "TMPRSS2_ZINC000000702323" "TMPSS2" "TO1" "TO1-2p" "train/test" "Trans_reg_C"
 "transfer/gene" "treaties_maastricht_en" "treatment~5-7%" "TRIM25-V5"
 "trimethoprim/sulfamethoxazole" "tris/glycine" "Tut7" "TW-JC2" "tw/aids/Molepi/" "TW10" "TW3"
 "tw^o" "TWC3" "Tween-20" "U&Es" "u-tokyo" "U.S" "U/L" "U/ml" "UC-230" "UC-330" "ug/ml"
 "uk/chembl/" "uk/en/Managingyourorganisation/" "uk/Tools/pfa/iprscan/" "UMD3.1"
 "unfolded/misfolded" "UNI60" "UNI60/UniProtKB" "units/milliliter" "units/ml" "units/well" "up!"
 "Ure2p" "urgent /emergency" "US$" "V /v" "V-bottom" "v/L" "v/v" "v^^ith" "v^arrants" "v^as"
 ...
 "~1000fold" "~100°C" "~11" "~12" "~13" "~16%" "~17" "~2" "~20-40-fold" "~254-351" "~30 %" "~30°C"
 "~4" "~4 g" "~5" "~50%" "~500,000" "~55" "~56" "~6%" "~6.5" "~64" "~65" "~65-fold" "~70%" "~80 %"
 "~96%" "~ENLYFQG~" "~t" "~V" "~~" "§3" "§3DV" "°C" "±SD" "½½I=ð½I" "¿=" "×3" "×5" "À1.106201"
 "À11.17" "À12.14" "À12.18" "À12.39" "À180" "À20°C." "À6.2" "À7.2" "À9.31" "À9.47" "ð1Þ" "ƒk{1"
 "Ͻ0.5" "Ͻ50%" "Ͼ25%" "Ͼ35-fold" "Ͼ4 h" "Ͼ50%" "Ͼ800" "Ͼ8000" "α-1,3fucosyl" "α-2,3-sialyl"
 "α-acyl" "α-helices" "α-ketoamide" "α-ketonamide" "α-mannosidase-like" "α/β" "α1" "α1β1FXYD1" "α2"
 "α3" "αhelical" "αhelix" "β-1,4-galactosyltransferase" "β-1,4galactosyltransferase" "β1" "βbarrel"
 "βFP" "βi" "βmercaptoethanol" "γGlu-Ala" "ΔC" "Δλ" "λ/p" "μg/ml" "μg/ml/1" "μl" "μL" "μTAS" "τ /τ"
 "ω-aminoacid" "ω-diisocyanatohexane" "ϩ/ϪsgRNA7" "ϩsgRNA7" "ϩsgRNA7-to-gRNA" "Ϫ/Ϫ" "Ϫ1" "Ϫ196°C"
 "Ϫ80°C" "ϪsgRNA7" "ϪΔCT" "ϳ1" "ϳ10%" "ϳ15-30" "ϳ15-fold" "ϳ2-log" "ϳ29.7" "ϳ40%" "ϳ50%" "ϳ70-kDa"
 "Յ0.05" "Յ50%" "Ն0.5" "‚abuse" "‚dependence" "…extremely" "…stronger" "…there" "∆C" "−80°" "∼10%"
 "∼3.6" "∼80%" "∼80°C." "∼8−9" "∼90%" "≈0.65" "≈0.83" "≈0.89" "≈100,000" "≈2.4" "≤100%" "≤1000"
 "≤30%" "≤60%" "≤85°C" "≤93%" "≤Age-contact" "≥1" "≥8 g/day" "≥95%" "≥98%" "␤-coronavirus" "␤-CoVs"
 "␥-32" "，23"))
    :test #'equalp))
...
("aasved" "abandoned" "abbreviated" "abclonal" "abdominal" "abhydrolase" "abided" "ablated"
 ...
 "magnification" "malariologist" "malaysian" "malfunctioning" "manageable" "managed" "management"
 "managingyourorganisation" "mandatory" "mandible" "manipulation" "manned" "manual" "manually"
 "manufacturing" "marginal" "marginalised" "margination" "marked" "marketed" "marketing" "markovic"
 "massive" "massively" "mated" "material" "maternal" "maternally" "maternity" "mathematical"
 "matriculated" "mattered" "maturation" "maturity" "maxillofacial" "maximisation" "maximize"
 "measlesvectored" "mechanical" "mechanics" "mechanistics" "medication" "medicinal" "mediumsized"
 "melancholic" "melioidosis" "melitensis" "membraneenclosed" "membranous" "memetic" "meningeal"
 "meningococcal" "mental" "mented" "mercaptohexadecanoic" "merging" "merial" "mesenteric"
 "messaging" "messling" "metaanalysis" "metabolomics" "metagenomic" "metallic" "metanalysis"
 "metered" "methodological" "meticulous" "metric" "metrics" "mhcrestricted" "microangiopathic"
 "microarrayed" "microbial" "microbiologic" "microbiological" "microbiologist" "microcephalic"
 "microcephaly" "microelectromechanical" "microenvironment" "microfabrication" "microfluidic"
 "microfluidics" "micromirror" "micropanned" "microscopic" "microscopically" "microthomic"
 "microtubuleassociated" "microvascular" "microwaving" "midsection" "migratory" "miliary"
 "military" "mimetic" "mimetics" "mimicking" "mineral" "mingled" "miniaturisation"
 "miniaturization" "miniaturized" "minimal" "minimisation" "minimised" "minimization" "minimize"
 "mining" "mirrored" "misannotation" "misclassification" "misclassified" "misconception"
...
("abandon" "abate" "abates" "abattoir" "abbreviation" "abbreviations" "abdomen" "abrasion"
 ...
 "brush" "bubble" "buddy" "budget" "bug" "bugs" "build" "buildings" "bulge" "bulges" "bulky" "bull"
 "bullet" "bulls" "bump" "bumps" "bundle" "burden" "burdensome" "burn" "burns" "burrow" "burrows"
 "burst" "burton" "bury" "bus" "business" "businessman" "busy" "butcher" "butter" "bypass"
 "bypasses" "byproduct" "byproducts" "bystander" "cabin" "cabinet" "cabinets" "cabins" "cable"
 "cafe" "calf" "calibrate" "calm" "came" "camel" "camels" "camera" "camp" "campaign" "campaigns"
 "campus" "candidacy" "canister" "canisters" "canopy" "cant" "capital" "capitals" "capsule"
 "capture" "car" "carbon" "carcass" "carcasses" "card" "care" "career" "careful" "carnivore"
 "carnivores" "carpenter" "carpenters" "carriage" "carrier" "carriers" "cars" "cart" "carter"
 "cartoon" "carts" "caseload" "casino" "cassette" "castle" "casualty" "cat" "catalogue" "catalyst"
 "catapult" "catapults" "catch" "cattle" "caught" "cave" "caveat" "caves" "ceiling" "ceilings"
 "census" "centrifuge" "century" "certificate" "certificates" "chain" "chair" "chairman" "chamber"
 "chamberlain" "chameleon" "channel" "chapter" "chapters" "character" "characters" "charge"
 "charities" "charity" "chart" "charter" "cheap" "cheaper" "check" "cheetah" "chemical" "chemicals"
 "chemist" "chemistry" "chemists" "cherry" "chest" "chic" "chick" "chicken" "chief" "child"
 "childhood" "chill" "chills" "chocolate" "choice" "choir" "choose" "chose" "church" "circle"
 "circles" "circuit" "circumscribe" "circumstance" "circumstances" "cite" "citizen" "citizens"
 "citizenship" "civet" "civil" "civilian" "civilians" "civilization" "civilizations" "claim"
 "claims" "clamp" "clan" "clandestine" "clans" "clash" "class" "classes" "clay" "clean" "cleaner"
 "clear" "clearance" "clearer" "cleft" "climate" "clip" "clips" "closure" "closures" "cloth"
 "clothe" "clothes" "club" "clubs" "clue" "coach" "coarse" "cocktail" "coefficient" "coefficients"
 "cognizant" "cohort" "coincide" "cold" "collaborate" "collaborator" "collaborators" "colleague"
 "colleagues" "collector" "collectors" "college" "colonies" "colony" "colorless" "column" "coma"
 "combat" "combine" "come" "comfort" "command" "commander" "commentaries" "commentary" "commit"
 "committee" "commonplace" "communicate" "communities" "community" "compact" "compartment"
 "compartments" "compass" "compassionate" "compilation" "compilations" "complain" "complaint"
 "complaints" "completeness" "compliance" "compliant" "complication" "complications" "composite"
 "compound" "computer" "concept" "concepts" "concise" "concomitant" "concordant" "concrete"
 "condemn" "confederate" "conference" "conferences" "conflict" "conflicts" "conform" "conforms"
 "confront" "conglomerate" "congregate" "congregates" "congress" "congresses" "conjecture"
 "connect" "conquest" "consciousness" "consensus" "conservancies" "conservancy" "consist"
 "consists" "consortium" "constant" "constants" "constituent" "constituents" "constrain"
 ...
 "zebras" "zone" "zoo" "zoos" "zucchini"))
    :test #'equalp))
ue" "visitation" "visitations" "visor" "visors"
 "vital" "vitamin" "vivid" "vogue" "voice" "voices" "void" "vole" "voles" "volume" "volunteer"
 "volunteers" "voter" "voters" "wager" "wagers" "waiver" "wake" "walker" "wall" "wallet" "wallets"
 "walls" "war" "warfare" "warhead" "warheads" "warm" "warn" "warnings" "warrant" "wary" "washout"
 "waste" "wasteful" "waterborne" "waterproof" "watertight" "watery" "watt" "watts" "wave"
