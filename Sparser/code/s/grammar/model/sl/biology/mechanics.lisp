...
(defun save-var->bio-nl-new-defs-file (var filename &key vl (if-exists :supersede))
  ...
  keyword varlist is given, then treat var as a list of
  global-variable names and print them each in the file the with a
  defparameter; the file will be saved in the new-defs directory under
  the bio-not-loaded directory -- can specify what happens if the file
  already exists"
