...
(define-category admit :specializes comlex-verb
     :binds
      ((INTO top)
       ...
       (TO top)
       (OF top))
     :realization (:verb "admit" :s SUBJECT :o OBJECT :into INTO :in IN :to TO :of OF))
...
(define-category agree :specializes comlex-verb
     :binds
      ((AMONG top)
       ...
       (ON top)
       (UPON top))
     :realization (:verb "agree" :s SUBJECT :o OBJECT :among AMONG :between BETWEEN :over OVER :with WITH :about ABOUT :to TO :on ON :upon UPON))
...
(define-category appal :specializes comlex-verb
     :realization (:verb "appal" :s SUBJECT :o OBJECT))
...
(define-category arise :specializes comlex-verb
     :binds
      ((IN top)
       (FROM top)
       (|OUT OF| top))
     :realization (:verb "arise" :s SUBJECT :in IN :from FROM :|OUT OF| |OUT OF|))
...
(define-category aver :specializes comlex-verb
     :realization (:verb "aver" :s SUBJECT :o OBJECT))
...
(define-category bag :specializes comlex-verb
     :binds
      ((WITH top))
     :realization (:verb "bag" :s SUBJECT :o OBJECT :with WITH))
...
(define-category ban :specializes comlex-verb
     :binds
      ((TO top)
       (FROM top))
     :realization (:verb "ban" :s SUBJECT :o OBJECT :to TO :from FROM))
...
(define-category bear :specializes comlex-verb
     :binds
      ((TO top)
       (UPON top)
       (ON top))
     :realization (:verb "bear" :s SUBJECT :o OBJECT :to TO :upon UPON :on ON))
...
(define-category begin :specializes comlex-verb
     :binds
      ((BY top)
       ...
       (UPON top)
       (WITH top))
     :realization (:verb "begin" :s SUBJECT :o OBJECT :by BY :after AFTER :before BEFORE :at AT :in IN :on ON :upon UPON :with WITH))
...
(define-category bespeak :specializes comlex-verb
     :realization (:verb "bespeak" :s SUBJECT :o OBJECT))

(define-category beware :specializes comlex-verb
     :binds
      ((OF top))
     :realization (:verb "beware" :s SUBJECT :o OBJECT :of OF))
...
(define-category bind :specializes comlex-verb
     :binds
      ((TO top)
       (WITH top))
     :realization (:verb "bind" :s SUBJECT :o OBJECT :to TO :with WITH))
...
(define-category blur :specializes comlex-verb
     :realization (:verb "blur" :s SUBJECT :o OBJECT))
...
(define-category break :specializes comlex-verb
     :binds
      ((FOR top)
       ...
       (INTO top)
       (TO top))
     :realization (:verb "break" :s SUBJECT :o OBJECT :for FOR :from FROM :|OUT OF| |OUT OF| :over OVER :in IN :with WITH :into INTO :to TO))
...
(define-category bring :specializes comlex-verb
     ...
     :binds
      ((ON top)
       ...
       (AGAINST top)
       (WITHIN top))
     :realization (:verb "bring" :s SUBJECT :o OBJECT :on ON :upon UPON :to TO :from FROM :|OUT OF| |OUT OF| :with WITH :against AGAINST :within WITHIN))
...
(define-category bud :specializes comlex-verb
     :realization (:verb "bud" :s SUBJECT :o OBJECT))
...
(define-category build-cl-verb :specializes comlex-verb
     :binds
      ((FOR top)
       ...
       (ON top)
       (UPON top))
     :realization (:verb "build" :s SUBJECT :o OBJECT :for FOR :around AROUND :from FROM :of OF :|OUT OF| |OUT OF| :into INTO :up UP :along ALONG :over OVER :onto ONTO :to TO :on ON :upon UPON))
...
(define-category bullshit :specializes comlex-verb
     :binds
      ((ABOUT top)
       (ON top)
       (WITH top))
     :realization (:verb "bullshit" :s SUBJECT :o OBJECT :about ABOUT :on ON :with WITH))
...
(define-category buy :specializes comlex-verb
     :binds
      ((INTO top))
     :realization (:verb "buy" :s SUBJECT :o OBJECT :into INTO))
...
(define-category can-cl-verb :specializes comlex-verb
     :realization (:verb "can" :s SUBJECT :o OBJECT))

(define-category cancel :specializes comlex-verb
     :realization (:verb "cancel" :s SUBJECT :o OBJECT))

(define-category cap :specializes comlex-verb
     :binds
      ((AT top)
       (WITH top))
     :realization (:verb "cap" :s SUBJECT :o OBJECT :at AT :with WITH))
...
(define-category cast :specializes comlex-verb
     :binds
      ((THROUGH top)
       ...
       (OVER top)
       (ON top))
     :realization (:verb "cast" :s SUBJECT :o OBJECT :through THROUGH :at AT :for FOR :in IN :into INTO :|OUT OF| |OUT OF| :to TO :toward TOWARD :upon UPON :with WITH :from FROM :over OVER :on ON))
...
(define-category catch :specializes comlex-verb
     :binds
      ((BEHIND top)
       ...
       (WITH top)
       (TO top))
     :realization (:verb "catch" :s SUBJECT :o OBJECT :behind BEHIND :in IN :into INTO :on ON :with WITH :to TO))
...
(define-category channel :specializes comlex-verb
     :binds
      ((INTO top)
       (THROUGH top))
     :realization (:verb "channel" :s SUBJECT :o OBJECT :into INTO :through THROUGH))
...
(define-category chat :specializes comlex-verb
     :binds
      ((ABOUT top)
       (WITH top))
     :realization (:verb "chat" :s SUBJECT :about ABOUT :with WITH))
...
(define-category choose :specializes comlex-verb
     :binds
      ((ABOVE top)
       (FOR top)
       (FROM top))
     :realization (:verb "choose" :s SUBJECT :o OBJECT :above ABOVE :for FOR :from FROM))
...
(define-category clam :specializes comlex-verb
     :realization (:verb "clam" :s SUBJECT :o OBJECT))
...
(define-category clip :specializes comlex-verb
     :binds
      ((IN top)
       ...
       (TO top)
       (OFF top))
     :realization (:verb "clip" :s SUBJECT :o OBJECT :in IN :from FROM :|OUT OF| |OUT OF| :on ON :to TO :off OFF))
...
(define-category clot :specializes comlex-verb
     :binds
      ((AROUND top))
     :realization (:verb "clot" :s SUBJECT :o OBJECT :around AROUND))
...
(define-category club :specializes comlex-verb
     :binds
      ((TO top)
       (ON top))
     :realization (:verb "club" :s SUBJECT :o OBJECT :to TO :on ON))
...
(define-category come :specializes comlex-verb
     :realization (:verb "come" :s SUBJECT))
...
(define-category commit :specializes comlex-verb
     :binds
      ((TO top))
     :realization (:verb "commit" :s SUBJECT :o OBJECT :to TO))
...
(define-category compel :specializes comlex-verb
     :realization (:verb "compel" :s SUBJECT :o OBJECT))
...
(define-category con :specializes comlex-verb
     :binds
      ((INTO top)
       (FROM top)
       (|OUT OF| top))
     :realization (:verb "con" :s SUBJECT :o OBJECT :into INTO :from FROM :|OUT OF| |OUT OF|))
...
(define-category concur :specializes comlex-verb
     :binds
      ((IN top)
       (WITH top))
     :realization (:verb "concur" :s SUBJECT :in IN :with WITH))
...
(define-category cop :specializes comlex-verb
     :realization (:verb "cop" :s SUBJECT :o OBJECT))
...
(define-category counsel :specializes comlex-verb
     :binds
      ((ABOUT top))
     :realization (:verb "counsel" :s SUBJECT :o OBJECT :about ABOUT))
...
(define-category cut :specializes comlex-verb
     :binds
      ((ON top)
       ...
       (|OUT OF| top)
       (TO top))
     :realization (:verb "cut" :s SUBJECT :o OBJECT :on ON :across ACROSS :around AROUND :through THROUGH :at AT :from FROM :into INTO :off OFF :in IN :|OUT OF| |OUT OF| :to TO))
...
(define-category deal :specializes comlex-verb
     :binds
      ((IN top)
       ...
       (AROUND top)
       (ACROSS top))
     :realization (:verb "deal" :s SUBJECT :o OBJECT :in IN :with WITH :to TO :among AMONG :around AROUND :across ACROSS))
...
(define-category debug :specializes comlex-verb
     :realization (:verb "debug" :s SUBJECT :o OBJECT))
...
(define-category decree :specializes comlex-verb
     :realization (:verb "decree" :s SUBJECT :o OBJECT))
...
(define-category defer :specializes comlex-verb
     :binds
      ((BEFORE top)
       ...
       (TILL top)
       (TO top))
     :realization (:verb "defer" :s SUBJECT :o OBJECT :before BEFORE :pending PENDING :till TILL :to TO))
...
(define-category dial :specializes comlex-verb
     :binds
      ((AT top))
     :realization (:verb "dial" :s SUBJECT :o OBJECT :at AT))
...
(define-category dip :specializes comlex-verb
     :binds
      ((INTO top)
       (IN top))
     :realization (:verb "dip" :s SUBJECT :o OBJECT :into INTO :in IN))
...
(define-category disagree :specializes comlex-verb
     :binds
      ((UPON top)
       ...
       (ON top)
       (WITH top))
     :realization (:verb "disagree" :s SUBJECT :o OBJECT :upon UPON :over OVER :about ABOUT :on ON :with WITH))
...
(define-category draw :specializes comlex-verb
     ...
     :binds
      ((INTO top)
       ...
       (TO top)
       (AT top))
     :realization (:verb "draw" :s SUBJECT :o OBJECT :into INTO :against AGAINST :for FOR :with WITH :near NEAR :on ON :upon UPON :from FROM :to TO :at AT))
...
(define-category drink :specializes comlex-verb
     :binds
      ((FROM top)
       (|OUT OF| top)
       (TO top))
     :realization (:verb "drink" :s SUBJECT :o OBJECT :from FROM :|OUT OF| |OUT OF| :to TO))
...
(define-category dun :specializes comlex-verb
     :binds
      ((FOR top))
     :realization (:verb "dun" :s SUBJECT :o OBJECT :for FOR))
...
(define-category eat :specializes comlex-verb
     :binds
      ((OFF top)
       ...
       (FROM top)
       (AT top))
     :realization (:verb "eat" :s SUBJECT :o OBJECT :off OFF :|OUT OF| |OUT OF| :from FROM :at AT))
...
(define-category embed :specializes comlex-verb
     :binds
      ((INTO top)
       (IN top))
     :realization (:verb "embed" :s SUBJECT :o OBJECT :into INTO :in IN))
...
(define-category enrol :specializes comlex-verb
     :binds
      ((IN top)
       (FOR top)
       (WITH top))
     :realization (:verb "enrol" :s SUBJECT :o OBJECT :in IN :for FOR :with WITH))
...
(define-category equal :specializes comlex-verb
     :binds
      ((IN top))
     :realization (:verb "equal" :s SUBJECT :o OBJECT :in IN))
...
(define-category equip :specializes comlex-verb
     :binds
      ((FOR top)
       (WITH top))
     :realization (:verb "equip" :s SUBJECT :o OBJECT :for FOR :with WITH))
...
(define-category excel :specializes comlex-verb
     :binds
      ((BEYOND top)
       ...
       (AT top)
       (IN top))
     :realization (:verb "excel" :s SUBJECT :o OBJECT :beyond BEYOND :over OVER :at AT :in IN))
...
(define-category fall-cl-verb :specializes comlex-verb
     ...
     :binds
      ((TO top)
       ...
       (UPON top)
       (|OFF OF| top))
     :realization (:verb "fall" :s SUBJECT :o OBJECT :to TO :with WITH :on ON :in IN :at AT :before BEFORE :under UNDER :for FOR :among AMONG :upon UPON :|OFF OF| |OFF OF|))
...
(define-category fee :specializes comlex-verb
     :realization (:verb "fee" :s SUBJECT :o OBJECT))
...
(define-category fight :specializes comlex-verb
     :binds
      ((IN top)
       ...
       (FOR top)
       (ON top))
     :realization (:verb "fight" :s SUBJECT :o OBJECT :in IN :into INTO :through THROUGH :to TO :with WITH :against AGAINST :for FOR :on ON))
...
(define-category find-cl-verb :specializes comlex-verb
     :binds
      ((ABOUT top)
       ...
       (UNDER top)
       (UP top))
     :realization (:verb "find" :s SUBJECT :o OBJECT :about ABOUT :into INTO :above ABOVE :across ACROSS :against AGAINST :along ALONG :among AMONG :amongst AMONGST :around AROUND :behind BEHIND :below BELOW :beneath BENEATH :beside BESIDE :between BETWEEN :beyond BEYOND :by BY :in IN :inside INSIDE :near NEAR :|NEXT TO| |NEXT TO| :|OFF OF| |OFF OF| :on ON :|OUT OF| |OUT OF| :outside OUTSIDE :throughout THROUGHOUT :under UNDER :up UP))
...
(define-category flag :specializes comlex-verb
     :binds
      ((FOR top))
     :realization (:verb "flag" :s SUBJECT :o OBJECT :for FOR))
...
(define-category flee :specializes comlex-verb
     ...
     :binds
      ((ACROSS top)
       (TO top)
       (FOR top))
     :realization (:verb "flee" :s SUBJECT :o OBJECT :across ACROSS :to TO :for FOR))
...
(define-category fly :specializes comlex-verb
     ...
     :binds
      ((BEHIND top)
       ...
       (AT top)
       (UNDER top))
     :realization (:verb "fly" :s SUBJECT :o OBJECT :behind BEHIND :from FROM :to TO :in IN :|CLOSE TO| |CLOSE TO| :above ABOVE :at AT :under UNDER))
...
(define-category forego :specializes comlex-verb
     :binds
      ((FOR top))
     :realization (:verb "forego" :s SUBJECT :o OBJECT :for FOR))

(define-category forgo :specializes comlex-verb
     :realization (:verb "forgo" :s SUBJECT :o OBJECT))
...
(define-category freeze :specializes comlex-verb
     :binds
      ((AROUND top)
       ...
       (|OUT OF| top)
       (TO top))
     :realization (:verb "freeze" :s SUBJECT :o OBJECT :around AROUND :into INTO :on ON :at AT :|OUT OF| |OUT OF| :to TO))
...
(define-category fuel :specializes comlex-verb
     :realization (:verb "fuel" :s SUBJECT :o OBJECT))

(define-category fulfil :specializes comlex-verb
     :realization (:verb "fulfil" :s SUBJECT :o OBJECT))
...
(define-category gad :specializes comlex-verb
     :realization (:verb "gad" :s SUBJECT))
...
(define-category grab :specializes comlex-verb
     :binds
      ((FOR top)
       ...
       (AT top)
       (BY top))
     :realization (:verb "grab" :s SUBJECT :o OBJECT :for FOR :from FROM :|OUT OF| |OUT OF| :at AT :by BY))
...
(define-category grind :specializes comlex-verb
     :binds
      ((AGAINST top)
       (INTO top))
     :realization (:verb "grind" :s SUBJECT :o OBJECT :against AGAINST :into INTO))
...
(define-category guarantee :specializes comlex-verb
     :realization (:verb "guarantee" :s SUBJECT :o OBJECT))
...
(define-category gun :specializes comlex-verb
     :realization (:verb "gun" :s SUBJECT :o OBJECT))

(define-category gut :specializes comlex-verb
     :realization (:verb "gut" :s SUBJECT :o OBJECT))
...
(define-category ham :specializes comlex-verb
     :realization (:verb "ham" :s SUBJECT :o OBJECT))
...
(define-category hang :specializes comlex-verb
     :binds
      ((|OUT OF| top)
       ...
       (WITH top)
       (FOR top))
     :realization (:verb "hang" :s SUBJECT :o OBJECT :|OUT OF| |OUT OF| :above ABOVE :off OFF :on ON :onto ONTO :over OVER :under UNDER :below BELOW :in IN :out OUT :around AROUND :to TO :from FROM :with WITH :for FOR))
...
(define-category hear :specializes comlex-verb
     :binds
      ((ABOUT top)
       (FROM top)
       (OF top))
     :realization (:verb "hear" :s SUBJECT :o OBJECT :about ABOUT :from FROM :of OF))
...
(define-category hide :specializes comlex-verb
     :binds
      ((|OUT OF| top)
       ...
       (FROM top)
       (UNDER top))
     :realization (:verb "hide" :s SUBJECT :o OBJECT :|OUT OF| |OUT OF| :among AMONG :amongst AMONGST :behind BEHIND :below BELOW :beneath BENEATH :beside BESIDE :between BETWEEN :inside INSIDE :in IN :from FROM :under UNDER))
...
(define-category hit :specializes comlex-verb
     :binds
      ((TO top)
       ...
       (ON top)
       (IN top))
     :realization (:verb "hit" :s SUBJECT :o OBJECT :to TO :toward TOWARD :for FOR :upon UPON :up UP :on ON :in IN))
...
(define-category hold :specializes comlex-verb
     :binds
      ((ABOUT top)
       ...
       (WITH top)
       (TO top))
     :realization (:verb "hold" :s SUBJECT :o OBJECT :about ABOUT :upon UPON :onto ONTO :against AGAINST :in IN :on ON :over OVER :under UNDER :with WITH :to TO))
...
(define-category hug :specializes comlex-verb
     :realization (:verb "hug" :s SUBJECT :o OBJECT))

(define-category hum :specializes comlex-verb
     :realization (:verb "hum" :s SUBJECT :o OBJECT))
...
(define-category hurt :specializes comlex-verb
     :binds
      ((BY top)
       (WITH top))
     :realization (:verb "hurt" :s SUBJECT :o OBJECT :by BY :with WITH))
...
(define-category incur :specializes comlex-verb
     :binds
      ((BY top)
       (THROUGH top)
       (WITH top))
     :realization (:verb "incur" :s SUBJECT :o OBJECT :by BY :through THROUGH :with WITH))
...
(define-category infer :specializes comlex-verb
     :realization (:verb "infer" :s SUBJECT :o OBJECT))
...
(define-category instil :specializes comlex-verb
     :binds
      ((IN top))
     :realization (:verb "instil" :s SUBJECT :o OBJECT :in IN))
...
(define-category institutionalize :specializes comlex-verb
     :binds
      ((FOR top))
     :realization (:verb "institutionalize" :s SUBJECT :o OBJECT :for FOR))
...
(define-category inter :specializes comlex-verb
     :binds
      ((BELOW top)
       ...
       (INTO top)
       (UNDER top))
     :realization (:verb "inter" :s SUBJECT :o OBJECT :below BELOW :in IN :into INTO :under UNDER))
...
(define-category job :specializes comlex-verb
     :realization (:verb "job" :s SUBJECT :o OBJECT))
...
(define-category jog :specializes comlex-verb
     ...
     :binds
      ((UNTO top)
       ...
       (AFTER top)
       (BESIDE top))
     :realization (:verb "jog" :s SUBJECT :o OBJECT :unto UNTO :with WITH :after AFTER :beside BESIDE))
...
(define-category jot :specializes comlex-verb
     :binds
      ((INTO top)
       (IN top)
       (ON top))
     :realization (:verb "jot" :s SUBJECT :o OBJECT :into INTO :in IN :on ON))
...
(define-category kid :specializes comlex-verb
     :binds
      ((ABOUT top)
       (FOR top))
     :realization (:verb "kid" :s SUBJECT :o OBJECT :about ABOUT :for FOR))
...
(define-category kit :specializes comlex-verb
     :realization (:verb "kit" :s SUBJECT :o OBJECT))
...
(define-category knit :specializes comlex-verb
     :realization (:verb "knit" :s SUBJECT :o OBJECT))
...
(define-category know-cl-verb :specializes comlex-verb
     :binds
      ((OF top)
       (ABOUT top))
     :realization (:verb "know" :s SUBJECT :o OBJECT :of OF :about ABOUT))
...
(define-category lag :specializes comlex-verb
     :binds
      ((BEHIND top))
     :realization (:verb "lag" :s SUBJECT :o OBJECT :behind BEHIND))
...
(define-category leave-cl-verb :specializes comlex-verb
     ...
     :binds
      ((FROM top)
       ...
       (|NEXT TO| top)
       (UNDER top))
     :realization (:verb "leave" :s SUBJECT :o OBJECT :from FROM :with WITH :without WITHOUT :at AT :near NEAR :beside BESIDE :for FOR :|NEXT TO| |NEXT TO| :under UNDER))

(define-category lend :specializes comlex-verb
     :binds
      ((INTO top)
       (TO top))
     :realization (:verb "lend" :s SUBJECT :o OBJECT :into INTO :to TO))
...
(define-category light :specializes comlex-verb
     :binds
      ((WITH top))
     :realization (:verb "light" :s SUBJECT :o OBJECT :with WITH))
...
(define-category log :specializes comlex-verb
     :binds
      ((ONTO top)
       (|OFF OF| top))
     :realization (:verb "log" :s SUBJECT :o OBJECT :onto ONTO :|OFF OF| |OFF OF|))
...
(define-category mean-cl-verb :specializes comlex-verb
     :binds
      ((FOR top)
       ...
       (BY top)
       (WITH top))
     :realization (:verb "mean" :s SUBJECT :o OBJECT :for FOR :to TO :by BY :with WITH))

(define-category meet :specializes comlex-verb
     :binds
      ((AT top)
       (WITH top))
     :realization (:verb "meet" :s SUBJECT :o OBJECT :at AT :with WITH))
...
(define-category mislead :specializes comlex-verb
     :binds
      ((INTO top))
     :realization (:verb "mislead" :s SUBJECT :o OBJECT :into INTO))

(define-category misread :specializes comlex-verb
     :realization (:verb "misread" :s SUBJECT :o OBJECT))
...
(define-category mistake :specializes comlex-verb
     :binds
      ((FOR top))
     :realization (:verb "mistake" :s SUBJECT :o OBJECT :for FOR))
...
(define-category misunderstand :specializes comlex-verb
     :realization (:verb "misunderstand" :s SUBJECT :o OBJECT))
...
(define-category model-cl-verb :specializes comlex-verb
     :binds
      ((INTO top)
       ...
       (FOR top)
       (ON top))
     :realization (:verb "model" :s SUBJECT :o OBJECT :into INTO :in IN :for FOR :on ON))
...
(define-category net :specializes comlex-verb
     :realization (:verb "net" :s SUBJECT :o OBJECT))
...
(define-category offset :specializes comlex-verb
     :realization (:verb "offset" :s SUBJECT :o OBJECT))

(define-category omit :specializes comlex-verb
     :realization (:verb "omit" :s SUBJECT :o OBJECT))
...
(define-category overcome :specializes comlex-verb
     :realization (:verb "overcome" :s SUBJECT :o OBJECT))
...
(define-category overlay :specializes comlex-verb
     :realization (:verb "overlay" :s SUBJECT :o OBJECT))

(define-category overlie :specializes comlex-verb
     :realization (:verb "overlie" :s SUBJECT :o OBJECT))
...
(define-category override :specializes comlex-verb
     :realization (:verb "override" :s SUBJECT :o OBJECT))
...
(define-category panic :specializes comlex-verb
     :binds
      ((INTO top)
       (|OUT OF| top))
     :realization (:verb "panic" :s SUBJECT :o OBJECT :into INTO :|OUT OF| |OUT OF|))
...
(define-category parallel-cl-verb :specializes comlex-verb
     :realization (:verb "parallel" :s SUBJECT :o OBJECT))

(define-category parcel :specializes comlex-verb
     :binds
      ((IN top)
       (TO top))
     :realization (:verb "parcel" :s SUBJECT :o OBJECT :in IN :to TO))

(define-category partake :specializes comlex-verb
     :binds
      ((IN top)
       (OF top))
     :realization (:verb "partake" :s SUBJECT :in IN :of OF))
...
(define-category pay :specializes comlex-verb
     :binds
      ((INTO top)
       ...
       (WITH top)
       (FOR top))
     :realization (:verb "pay" :s SUBJECT :o OBJECT :into INTO :in IN :|OUT OF| |OUT OF| :with WITH :for FOR))
...
(define-category permit :specializes comlex-verb
     :realization (:verb "permit" :s SUBJECT :o OBJECT))
...
(define-category pet :specializes comlex-verb
     :realization (:verb "pet" :s SUBJECT :o OBJECT))
...
(define-category plan :specializes comlex-verb
     :binds
      ((ON top)
       (FOR top))
     :realization (:verb "plan" :s SUBJECT :o OBJECT :on ON :for FOR))
...
(define-category plot :specializes comlex-verb
     :realization (:verb "plot" :s SUBJECT :o OBJECT))
...
(define-category prefer :specializes comlex-verb
     :binds
      ((FOR top)
       (OVER top)
       (TO top))
     :realization (:verb "prefer" :s SUBJECT :o OBJECT :for FOR :over OVER :to TO))
...
(define-category program :specializes comlex-verb
     :realization (:verb "program" :s SUBJECT :o OBJECT))
...
(define-category quit :specializes comlex-verb
     :binds
      ((OVER top))
     :realization (:verb "quit" :s SUBJECT :o OBJECT :over OVER))

(define-category quiz :specializes comlex-verb
     :binds
      ((ABOUT top)
       (ON top))
     :realization (:verb "quiz" :s SUBJECT :o OBJECT :about ABOUT :on ON))
...
(define-category rag :specializes comlex-verb
     :binds
      ((FOR top)
       (ON top))
     :realization (:verb "rag" :s SUBJECT :for FOR :on ON))
...
(define-category rap :specializes comlex-verb
     :binds
      ((AGAINST top)
       ...
       (FOR top)
       (TO top))
     :realization (:verb "rap" :s SUBJECT :o OBJECT :against AGAINST :on ON :into INTO :for FOR :to TO))
...
(define-category rebel :specializes comlex-verb
     :binds
      ((AGAINST top))
     :realization (:verb "rebel" :s SUBJECT :against AGAINST))
...
(define-category rebut :specializes comlex-verb
     :binds
      ((ON top)
       (WITH top))
     :realization (:verb "rebut" :s SUBJECT :o OBJECT :on ON :with WITH))
...
(define-category refer :specializes comlex-verb
     :binds
      ((LIKE top)
       (FOR top)
       (TO top))
     :realization (:verb "refer" :s SUBJECT :o OBJECT :like LIKE :for FOR :to TO))
...
(define-category relay :specializes comlex-verb
     :binds
      ((IN top)
       ...
       (ON top)
       (TO top))
     :realization (:verb "relay" :s SUBJECT :o OBJECT :in IN :onto ONTO :on ON :to TO))
...
(define-category remit :specializes comlex-verb
     :binds
      ((WITH top)
       (TO top))
     :realization (:verb "remit" :s SUBJECT :o OBJECT :with WITH :to TO))
...
(define-category rerun :specializes comlex-verb
     :binds
      ((FOR top)
       (ON top))
     :realization (:verb "rerun" :s SUBJECT :o OBJECT :for FOR :on ON))
...
(define-category reset :specializes comlex-verb
     :binds
      ((AT top)
       ...
       (ON top)
       (TO top))
     :realization (:verb "reset" :s SUBJECT :o OBJECT :at AT :for FOR :past PAST :on ON :to TO))
...
(define-category rethink :specializes comlex-verb
     :realization (:verb "rethink" :s SUBJECT :o OBJECT))
...
(define-category rid :specializes comlex-verb
     :binds
      ((OF top))
     :realization (:verb "rid" :s SUBJECT :o OBJECT :of OF))
...
(define-category rim :specializes comlex-verb
     :realization (:verb "rim" :s SUBJECT :o OBJECT))
...
(define-category rise :specializes comlex-verb
     :binds
      ((ON top)
       ...
       (FROM top)
       (TO top))
     :realization (:verb "rise" :s SUBJECT :o OBJECT :on ON :over OVER :above ABOVE :against AGAINST :|OUT OF| |OUT OF| :toward TOWARD :from FROM :to TO))
...
(define-category rival :specializes comlex-verb
     :binds
      ((WITH top)
       (IN top)
       (FOR top))
     :realization (:verb "rival" :s SUBJECT :o OBJECT :with WITH :in IN :for FOR))
...
(define-category rub :specializes comlex-verb
     :binds
      ((ACROSS top)
       ...
       (FOR top)
       (WITH top))
     :realization (:verb "rub" :s SUBJECT :o OBJECT :across ACROSS :|OFF OF| |OFF OF| :over OVER :onto ONTO :on ON :against AGAINST :for FOR :with WITH))
...
(define-category scan :specializes comlex-verb
     :mixins (with-p-dir)
     :realization (:verb "scan" :s SUBJECT :o OBJECT))
...
(define-category scrap :specializes comlex-verb
     :realization (:verb "scrap" :s SUBJECT :o OBJECT))
...
(define-category see-cl-verb :specializes comlex-verb
     :binds
      ((BEFORE top)
       ...
       (ABOUT top)
       (THROUGH top))
     :realization (:verb "see" :s SUBJECT :o OBJECT :before BEFORE :in IN :about ABOUT :through THROUGH))

(define-category seek :specializes comlex-verb
     :binds
      ((FOR top)
       (AFTER top))
     :realization (:verb "seek" :s SUBJECT :o OBJECT :for FOR :after AFTER))
...
(define-category sell-cl-verb :specializes comlex-verb
     :binds
      ((IN top)
       ...
       (FOR top)
       (ON top))
     :realization (:verb "sell" :s SUBJECT :o OBJECT :in IN :to TO :at AT :for FOR :on ON))
...
(define-category send :specializes comlex-verb
     ...
     :binds
      ((INTO top)
       (TO top)
       (FOR top))
     :realization (:verb "send" :s SUBJECT :o OBJECT :into INTO :to TO :for FOR))
...
(define-category shake :specializes comlex-verb
     ...
     :binds
      ((IN top)
       ...
       (AT top)
       (WITH top))
     :realization (:verb "shake" :s SUBJECT :o OBJECT :in IN :over OVER :at AT :with WITH))
...
(define-category shin :specializes comlex-verb
     :binds
      ((DOWN top))
     :realization (:verb "shin" :s SUBJECT :o OBJECT :down DOWN))
...
(define-category ship :specializes comlex-verb
     :binds
      ((INTO top)
       ...
       (FROM top)
       (TO top))
     :realization (:verb "ship" :s SUBJECT :o OBJECT :into INTO :through THROUGH :across ACROSS :over OVER :from FROM :to TO))
...
(define-category shoe :specializes comlex-verb
     :realization (:verb "shoe" :s SUBJECT :o OBJECT))
...
(define-category shoot :specializes comlex-verb
     ...
     :binds
      ((THROUGH top)
       ...
       (AT top)
       (FOR top))
     :realization (:verb "shoot" :s SUBJECT :o OBJECT :through THROUGH :into INTO :past PAST :beyond BEYOND :among AMONG :from FROM :to TO :near NEAR :|AWAY FROM| |AWAY FROM| :at AT :for FOR))

(define-category shop :specializes comlex-verb
     :binds
      ((TO top)
       (FOR top))
     :realization (:verb "shop" :s SUBJECT :o OBJECT :to TO :for FOR))
...
(define-category shrink :specializes comlex-verb
     :binds
      ((INTO top)
       ...
       (TO top)
       (FROM top))
     :realization (:verb "shrink" :s SUBJECT :o OBJECT :into INTO :|OUT OF| |OUT OF| :to TO :from FROM))

(define-category shun :specializes comlex-verb
     :binds
      ((|IN FAVOR OF| top))
     :realization (:verb "shun" :s SUBJECT :o OBJECT :|IN FAVOR OF| |IN FAVOR OF|))

(define-category shut :specializes comlex-verb
     :binds
      ((INSIDE top)
       (IN top))
     :realization (:verb "shut" :s SUBJECT :o OBJECT :inside INSIDE :in IN))
...
(define-category signal-cl-verb :specializes comlex-verb
     :binds
      ((TO top)
       (FOR top))
     :realization (:verb "signal" :s SUBJECT :o OBJECT :to TO :for FOR))
...
(define-category sin :specializes comlex-verb
     :binds
      ((AGAINST top))
     :realization (:verb "sin" :s SUBJECT :against AGAINST))
...
(define-category sink :specializes comlex-verb
     :binds
      ((FROM top)
       ...
       (ON top)
       (TO top))
     :realization (:verb "sink" :s SUBJECT :o OBJECT :from FROM :at AT :through THROUGH :in IN :into INTO :on ON :to TO))
...
(define-category sip :specializes comlex-verb
     :binds
      ((FROM top)
       (|OUT OF| top)
       (THROUGH top))
     :realization (:verb "sip" :s SUBJECT :o OBJECT :from FROM :|OUT OF| |OUT OF| :through THROUGH))
...
(define-category sit :specializes comlex-verb
     :binds
      ((BEFORE top)
       ...
       (IN top)
       (ON top))
     :realization (:verb "sit" :s SUBJECT :o OBJECT :before BEFORE :beside BESIDE :by BY :near NEAR :over OVER :around AROUND :along ALONG :behind BEHIND :at AT :through THROUGH :to TO :in IN :on ON))
...
(define-category sleep :specializes comlex-verb
     :binds
      ((AT top)
       ...
       (UNDER top)
       (WITH top))
     :realization (:verb "sleep" :s SUBJECT :o OBJECT :at AT :in IN :on ON :through THROUGH :under UNDER :with WITH))
...
(define-category slide :specializes comlex-verb
     ...
     :binds
      ((BESIDE top)
       ...
       (AGAINST top)
       (UNDER top))
     :realization (:verb "slide" :s SUBJECT :o OBJECT :beside BESIDE :onto ONTO :down DOWN :from FROM :into INTO :over OVER :to TO :against AGAINST :under UNDER))
...
(define-category slur :specializes comlex-verb
     :binds
      ((ON top)
       (THROUGH top)
       (OVER top))
     :realization (:verb "slur" :s SUBJECT :o OBJECT :on ON :through THROUGH :over OVER))
...
(define-category smell :specializes comlex-verb
     :binds
      ((AT top)
       ...
       (OF top)
       (ON top))
     :realization (:verb "smell" :s SUBJECT :o OBJECT :at AT :like LIKE :of OF :on ON))
...
(define-category snap :specializes comlex-verb
     ...
     :binds
      ((OF top)
       ...
       (OFF top)
       (|OUT OF| top))
     :realization (:verb "snap" :s SUBJECT :o OBJECT :of OF :in IN :past PAST :to TO :at AT :off OFF :|OUT OF| |OUT OF|))
...
(define-category speak :specializes comlex-verb
     :binds
      ((THROUGH top)
       ...
       (ON top)
       (OF top))
     :realization (:verb "speak" :s SUBJECT :o OBJECT :through THROUGH :at AT :with WITH :against AGAINST :for FOR :to TO :about ABOUT :on ON :of OF))
...
(define-category speed :specializes comlex-verb
     ...
     :binds
      ((AFTER top)
       (AT top))
     :realization (:verb "speed" :s SUBJECT :o OBJECT :after AFTER :at AT))
...
(define-category spend :specializes comlex-verb
     :binds
      ((AT top)
       (ON top)
       (FOR top))
     :realization (:verb "spend" :s SUBJECT :o OBJECT :at AT :on ON :for FOR))
...
(define-category spin :specializes comlex-verb
     :binds
      ((TO top)
       ...
       (FROM top)
       (INTO top))
     :realization (:verb "spin" :s SUBJECT :o OBJECT :to TO :through THROUGH :around AROUND :|OUT OF| |OUT OF| :toward TOWARD :from FROM :into INTO))
...
(define-category split :specializes comlex-verb
     :binds
      ((AMONG top)
       ...
       (FROM top)
       (INTO top))
     :realization (:verb "split" :s SUBJECT :o OBJECT :among AMONG :on ON :down DOWN :to TO :along ALONG :in IN :over OVER :with WITH :between BETWEEN :from FROM :into INTO))
...
(define-category spot :specializes comlex-verb
     :realization (:verb "spot" :s SUBJECT :o OBJECT))
...
(define-category spread :specializes comlex-verb
     ...
     :binds
      ((THROUGH top)
       ...
       (UPON top)
       (UNDER top))
     :realization (:verb "spread" :s SUBJECT :o OBJECT :through THROUGH :above ABOVE :with WITH :among AMONG :against AGAINST :near NEAR :beside BESIDE :|NEXT TO| |NEXT TO| :upon UPON :under UNDER))
...
(define-category stand :specializes comlex-verb
     :binds
      ((BENEATH top)
       ...
       (FOR top)
       (ON top))
     :realization (:verb "stand" :s SUBJECT :o OBJECT :beneath BENEATH :near NEAR :|NEXT TO| |NEXT TO| :above ABOVE :at AT :|OUT OF| |OUT OF| :behind BEHIND :before BEFORE :by BY :between BETWEEN :beside BESIDE :upon UPON :|UP TO| |UP TO| :among AMONG :over OVER :against AGAINST :to TO :in IN :from FROM :for FOR :on ON))
...
(define-category star-cl-verb :specializes comlex-verb
     :binds
      ((IN top))
     :realization (:verb "star" :s SUBJECT :o OBJECT :in IN))
...
(define-category stem :specializes comlex-verb
     :binds
      ((FROM top))
     :realization (:verb "stem" :s SUBJECT :o OBJECT :from FROM))
...
(define-category step :specializes comlex-verb
     ...
     :binds
      ((FROM top)
       ...
       (INTO top)
       (|INSIDE OF| top))
     :realization (:verb "step" :s SUBJECT :o OBJECT :from FROM :on ON :to TO :into INTO :|INSIDE OF| |INSIDE OF|))
...
(define-category stop :specializes comlex-verb
     :binds
      ((FROM top)
       ...
       (OVER top)
       (FOR top))
     :realization (:verb "stop" :s SUBJECT :o OBJECT :from FROM :off OFF :at AT :before BEFORE :in IN :inside INSIDE :on ON :over OVER :for FOR))
...
(define-category strap :specializes comlex-verb
     :binds
      ((AROUND top)
       ...
       (ONTO top)
       (TO top))
     :realization (:verb "strap" :s SUBJECT :o OBJECT :around AROUND :into INTO :onto ONTO :to TO))
...
(define-category strike :specializes comlex-verb
     :binds
      ((IN top)
       ...
       (WITH top)
       (AT top))
     :realization (:verb "strike" :s SUBJECT :o OBJECT :in IN :on ON :below BELOW :for FOR :to TO :with WITH :at AT))
...
(define-category strip :specializes comlex-verb
     :binds
      ((FROM top)
       ...
       (|OFF OF| top)
       (OF top))
     :realization (:verb "strip" :s SUBJECT :o OBJECT :from FROM :off OFF :|OUT OF| |OUT OF| :to TO :|OFF OF| |OFF OF| :of OF))

(define-category strive :specializes comlex-verb
     :binds
      ((FOR top))
     :realization (:verb "strive" :s SUBJECT :for FOR))
...
(define-category stud :specializes comlex-verb
     :binds
      ((WITH top))
     :realization (:verb "stud" :s SUBJECT :o OBJECT :with WITH))
...
(define-category stun :specializes comlex-verb
     :realization (:verb "stun" :s SUBJECT :o OBJECT))
...
(define-category stymie :specializes comlex-verb
     :realization (:verb "stymie" :s SUBJECT :o OBJECT))

(define-category sub :specializes comlex-verb
     :binds
      ((FOR top))
     :realization (:verb "sub" :s SUBJECT :o OBJECT :for FOR))

(define-category submit :specializes comlex-verb
     :binds
      ((FOR top)
       (TO top))
     :realization (:verb "submit" :s SUBJECT :o OBJECT :for FOR :to TO))
...
(define-category sum :specializes comlex-verb
     :realization (:verb "sum" :s SUBJECT :o OBJECT))

(define-category sun :specializes comlex-verb
     :binds
      ((AT top)
       (ON top))
     :realization (:verb "sun" :s SUBJECT :o OBJECT :at AT :on ON))
...
(define-category sup :specializes comlex-verb
     :binds
      ((AT top)
       ...
       (ON top)
       (UPON top))
     :realization (:verb "sup" :s SUBJECT :at AT :off OFF :on ON :upon UPON))
...
(define-category swab :specializes comlex-verb
     :realization (:verb "swab" :s SUBJECT :o OBJECT))
...
(define-category swear :specializes comlex-verb
     :binds
      ((BEFORE top)
       ...
       (UNTO top)
       (TO top))
     :realization (:verb "swear" :s SUBJECT :o OBJECT :before BEFORE :at AT :by BY :on ON :unto UNTO :to TO))
...
(define-category sweep :specializes comlex-verb
     :binds
      ((ACROSS top)
       ...
       (OFF top)
       (UNDER top))
     :realization (:verb "sweep" :s SUBJECT :o OBJECT :across ACROSS :through THROUGH :past PAST :down DOWN :from FROM :into INTO :|OUT OF| |OUT OF| :over OVER :to TO :|OFF OF| |OFF OF| :off OFF :under UNDER))
...
(define-category swing :specializes comlex-verb
     ...
     :binds
      ((THROUGH top)
       ...
       (AT top)
       (WITH top))
     :realization (:verb "swing" :s SUBJECT :o OBJECT :through THROUGH :over OVER :onto ONTO :|OUT OF| |OUT OF| :by BY :past PAST :|CLOSE TO| |CLOSE TO| :across ACROSS :on ON :in IN :off OFF :behind BEHIND :to TO :into INTO :toward TOWARD :towards TOWARDS :from FROM :within WITHIN :before BEFORE :against AGAINST :at AT :with WITH))
...
(define-category take :specializes comlex-verb
     :realization (:verb "take" :s SUBJECT))
...
(define-category tan :specializes comlex-verb
     :realization (:verb "tan" :s SUBJECT :o OBJECT))
...
(define-category tap :specializes comlex-verb
     :binds
      ((AGAINST top)
       ...
       (FOR top)
       (ON top))
     :realization (:verb "tap" :s SUBJECT :o OBJECT :against AGAINST :through THROUGH :into INTO :for FOR :on ON))
...
(define-category teach :specializes comlex-verb
     :realization (:verb "teach" :s SUBJECT :o OBJECT))
...
(define-category throw :specializes comlex-verb
     ...
     :binds
      ((ACROSS top)
       ...
       (UNTO top)
       (UNDER top))
     :realization (:verb "throw" :s SUBJECT :o OBJECT :across ACROSS :from FROM :over OVER :to TO :onto ONTO :on ON :at AT :upon UPON :with WITH :against AGAINST :above ABOVE :near NEAR :|OFF OF| |OFF OF| :|NEXT TO| |NEXT TO| :unto UNTO :under UNDER))
...
(define-category tie :specializes comlex-verb
     :binds
      ((ABOUT top)
       ...
       (IN top)
       (TO top))
     :realization (:verb "tie" :s SUBJECT :o OBJECT :about ABOUT :around AROUND :behind BEHIND :on ON :over OVER :with WITH :into INTO :in IN :to TO))
...
(define-category total :specializes comlex-verb
     :binds
      ((TO top))
     :realization (:verb "total" :s SUBJECT :o OBJECT :to TO))
...
(define-category towel :specializes comlex-verb
     :realization (:verb "towel" :s SUBJECT :o OBJECT))
...
(define-category traffic :specializes comlex-verb
     :binds
      ((IN top)
       (WITH top))
     :realization (:verb "traffic" :s SUBJECT :o OBJECT :in IN :with WITH))
...
(define-category transmit :specializes comlex-verb
     :binds
      ((ACROSS top)
       ...
       (THROUGH top)
       (TO top))
     :realization (:verb "transmit" :s SUBJECT :o OBJECT :across ACROSS :over OVER :through THROUGH :to TO))
...
(define-category travel :specializes comlex-verb
     ...
     :binds
      ((FROM top)
       ...
       (AT top)
       (WITH top))
     :realization (:verb "travel" :s SUBJECT :o OBJECT :from FROM :to TO :at AT :with WITH))
...
(define-category trim :specializes comlex-verb
     :binds
      ((BY top)
       ...
       (OFF top)
       (WITH top))
     :realization (:verb "trim" :s SUBJECT :o OBJECT :by BY :to TO :from FROM :|OFF OF| |OFF OF| :off OFF :with WITH))

(define-category trip :specializes comlex-verb
     :binds
      ((ON top)
       (OVER top))
     :realization (:verb "trip" :s SUBJECT :o OBJECT :on ON :over OVER))
...
(define-category undergo-cl-verb :specializes comlex-verb
     :realization (:verb "undergo" :s SUBJECT :o OBJECT))
...
(define-category underpin :specializes comlex-verb
     :binds
      ((AGAINST top))
     :realization (:verb "underpin" :s SUBJECT :o OBJECT :against AGAINST))
...
(define-category undertake :specializes comlex-verb
     :realization (:verb "undertake" :s SUBJECT :o OBJECT))
...
(define-category unravel :specializes comlex-verb
     :realization (:verb "unravel" :s SUBJECT :o OBJECT))
...
(define-category uphold :specializes comlex-verb
     :binds
      ((AGAINST top))
     :realization (:verb "uphold" :s SUBJECT :o OBJECT :against AGAINST))

(define-category upset :specializes comlex-verb
     :realization (:verb "upset" :s SUBJECT :o OBJECT))
...
(define-category wake :specializes comlex-verb
     :binds
      ((FROM top)
       (TO top))
     :realization (:verb "wake" :s SUBJECT :o OBJECT :from FROM :to TO))
...
(define-category war :specializes comlex-verb
     :binds
      ((AGAINST top)
       (OVER top)
       (WITH top))
     :realization (:verb "war" :s SUBJECT :against AGAINST :over OVER :with WITH))
...
(define-category wear :specializes comlex-verb
     :binds
      ((IN top)
       (THROUGH top)
       (TO top))
     :realization (:verb "wear" :s SUBJECT :o OBJECT :in IN :through THROUGH :to TO))
...
(define-category whip :specializes comlex-verb
     ...
     :binds
      ((AT top)
       (INTO top))
     :realization (:verb "whip" :s SUBJECT :o OBJECT :at AT :into INTO))
...
(define-category win :specializes comlex-verb
     :binds
      ((FROM top)
       (TO top)
       (AGAINST top))
     :realization (:verb "win" :s SUBJECT :o OBJECT :from FROM :to TO :against AGAINST))
...
(define-category withdraw :specializes comlex-verb
     :binds
      ((TO top)
       (INTO top)
       (FROM top))
     :realization (:verb "withdraw" :s SUBJECT :o OBJECT :to TO :into INTO :from FROM))
...
(define-category worship :specializes comlex-verb
     :realization (:verb "worship" :s SUBJECT :o OBJECT))
...
(define-category wrap :specializes comlex-verb
     :binds
      ((IN top)
       (ABOUT top)
       (AROUND top))
     :realization (:verb "wrap" :s SUBJECT :o OBJECT :in IN :about ABOUT :around AROUND))
...
(define-category write :specializes comlex-verb
     :binds
      ((FOR top)
       ...
       (ABOUT top)
       (TO top))
     :realization (:verb "write" :s SUBJECT :o OBJECT :for FOR :of OF :on ON :about ABOUT :to TO))
