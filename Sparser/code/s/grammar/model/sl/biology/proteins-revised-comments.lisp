...
;(define-protein "P10995" ("AMPK-alpha2"))
;(define-protein "P96787" ("AR3"))
;(define-protein "P31751" ("Akt-2"))
;(define-protein "Q9Y243" ("Akt-3"))
;(define-protein "Q15389" ("Angiopoietin-1"))
;(define-protein "Q38813" ("B1"))
;(define-protein "Q9LTG0" ("B2"))
;(define-protein "Q7L3V2" ("BH3-only protein"))
;(define-protein "Q16611" ("Bak"))
;(define-protein "Q07812" ("Bax"))
;(define-protein "P10415" ("Bcl-2"))
;(define-protein "Q07817" ("Bcl-x L"))
;(define-protein "P04626" ("erbB2" "Her2neu" "Her-2" "C-erbB-2"))
;(define-protein "P48730" ("CK1delta"))
;(define-protein "P19784" ("CK2alpha'"))
;(define-protein "Q075B4" ("Caspase-12"))
;(define-protein "P42575" ("Caspase-2"))
;(define-protein "P06650" ("Cath-D"))
;(define-protein "Q03135" ("Cav1"))
;(define-protein "Q00535" ("Cdk5"))
;(define-protein "P10909" ("Clusterin"))
;(define-protein "P42751" ("CyclinD1 protein"))
;(define-protein "Q9T1Q8" ("D2-40"))  bad definition, it's a monoclonal antibody for podoplanin, but I can't find any real uniprot or other grounding
;(define-protein "P56177" ("Dlx1"))
;(define-protein "O75923" ("Dysferlin"))
;(define-protein "P12830" ("E-cadherin"))
...
;(define-protein "O42037" ("EphA2 receptor")) bad def
;(define-protein "P42566" ("Eps15"))
;(define-protein "P14921" ("Ets1" "Ets-1"))
;(define-protein "P15036" ("Ets-2"))
;(define-protein "P15311" ("Ezrin"))
;(define-protein "Q05295" ("F4-80")) bad
;(define-protein "Q8JTG9" ("FANCD2-L")) bad
;(define-protein "Q9T1U4" ("FGF receptors")) bad
;(define-protein "O75084" ("FZD-7"))
;(define-protein "P48023" ("Fas-ligand"))
;(define-protein "Q00942" ("Fbw7gamma")) bad
;(define-protein "Q00987" ("myc-Mdm2" "Hdm2" "Flag-Mdm2"))
;(define-protein "O43524" ("FoxO3A"))
;(define-protein "Q797E6" ("Fra"))
;(define-protein "P15407" ("Fra1" "Fra-1"))
...
;(define-protein "Q4R1J6" ("Survivin"))
