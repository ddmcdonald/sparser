...
#|
(with-open-file (stream "~/projects/r3/code/vocabulary-discovery/python-uniprot-utilities/Mar2018-reach-prot-cands.json"
...
(with-open-file (stream "~/projects/r3/code/vocabulary-discovery/python-uniprot-utilities/Mar2018-reach-redo-prot-cands.json"
                        :direction :output :if-exists :supersede
                        :if-does-not-exist :create
                        :external-format :UTF-8)
  (format stream "{~%")
