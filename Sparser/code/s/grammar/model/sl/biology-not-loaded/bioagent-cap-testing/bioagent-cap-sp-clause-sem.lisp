...
'(("What genes does mir-128 regulate?"
  ...
  ("What pathways involve SOARING?"
   (:VAR MV5004 :ISA WH-QUESTION ;:STATEMENT
                                        ;(#<soar 93552> (PRESENT #<ref-category PRESENT>))
    :VAR NIL :WH WHAT))
  ...
  ("What is PI3K?"
   ...
   (:VAR MV7275 :ISA WHAT)
   (:VAR MV7274 :ISA PROTEIN-FAMILY :RAW-TEXT "PI3K" :NAME "PI3-kinase" :COUNT
    4 :FAMILY-MEMBERS
  ...
  ("Remove STAT3 from the model."
   (:VAR MV7346 :ISA REMOVE :OBJECT MV7345 :PRESENT "PRESENT" :RAW-TEXT
    "Remove")
   (:VAR MV7345 :ISA PROTEIN :RAW-TEXT "STAT3" :UID "UP:P40763" :NAME
    "STAT3_HUMAN"))
  ("Remove the last interaction from the model."
   (:VAR MV7351 :ISA REMOVE :OBJECT MV7354 :PRESENT "PRESENT" :RAW-TEXT
    "Remove")
   (:VAR MV7354 :ISA INTERACT :HAS-DETERMINER "THE" :PREDICATION MV7353
    :RAW-TEXT "interaction")
   (:VAR MV7353 :ISA LAST-SEQUENCE :NAME "last"))
  ("IL10 activates STAT3"
   (:VAR MV7361 :ISA BIO-ACTIVATE :AGENT MV7359 :OBJECT MV7360 :PRESENT
    "PRESENT" :RAW-TEXT "activates")
  ...
  ("How many interactions are in the model?"
   (:VAR MV7372 :ISA COPULAR-PREDICATION-OF-PP :ITEM MV7364 :VALUE MV7371 :PREP
    "IN" :PREDICATE MV7365)
   (:VAR MV7364 :ISA INTERACT :HAS-DETERMINER "HOW" :QUANTIFIER MV7363
  ...
  ("Does tofacitinib decrease the amount of phosphorylated MAP2K2?"
   ...
   (:VAR MV7382 :ISA PHOSPHORYLATE :SUBSTRATE MV7374 :RAW-TEXT
    "phosphorylated"))
  ("What kinases does ERK1 activate?"
   (:VAR MV7390 :ISA BIO-ACTIVATE :OBJECT MV7388 :AGENT MV7386 :PRESENT
    "PRESENT" :RAW-TEXT "activate")
  ...
  ("What kinases does MEK1 activate?"
   (:VAR MV7395 :ISA BIO-ACTIVATE :OBJECT MV7393 :AGENT MV7391 :PRESENT
    "PRESENT" :RAW-TEXT "activate")
  ...
  ("What does ERK1 activate?"
   (:VAR MV7399 :ISA BIO-ACTIVATE :OBJECT MV7397 :AGENT MV7396 :PRESENT
    "PRESENT" :RAW-TEXT "activate")
   (:VAR MV7397 :ISA WHAT)
  ...
  ("What pathways involve SRF and what does SRF bind?"
   ...
   (:VAR MV7412 :ISA PROTEIN :RAW-TEXT "SRF" :UID "UP:P11831" :NAME
    "SRF_HUMAN")
  ...
  ("What pathways involve SRF?"
   ...
   (:VAR MV7422 :ISA PROTEIN :RAW-TEXT "SRF" :UID "UP:P11831" :NAME
    "SRF_HUMAN"))
  ("What does SRF bind?"
  ...
  ("Which kinases activate MEK2?"
   (:VAR MV7458 :ISA BIO-ACTIVATE :AGENT MV7457 :OBJECT MV7455 :PRESENT
    "PRESENT" :RAW-TEXT "activate")
  ...
  ("Which kinases are in the FAKE signaling pathway?"
   ...
   (:VAR MV7529 :ISA KINASE :CONTEXT-OR-IN-PATHWAY MV7520 :HAS-DETERMINER
    "WHICH" :RAW-TEXT "kinases")
  ...
  ("Remove the fact that ELk1 transcribes FAKE in the model."
   (:VAR MV7555 :ISA REMOVE :OBJECT MV7565 :PRESENT "PRESENT" :RAW-TEXT
    "Remove")
  ...
  ("ELK1 transcribes FOS"
   ...
   (:VAR MV7566 :ISA PROTEIN :RAW-TEXT "ELK1" :UID "UP:P19419" :NAME
    "ELK1_HUMAN")
   (:VAR MV7568 :ISA PROTEIN :RAW-TEXT "FOS" :UID "UP:P01100" :NAME
    "FOS_HUMAN"))
  ("Remove the fact that ELK1 transcribes FOS in the model."
   (:VAR MV7570 :ISA REMOVE :OBJECT MV7580 :PRESENT "PRESENT" :RAW-TEXT
    "Remove")
  ...
  ("What transcription factors are shared by CXCL8 and FAKE10?"
   (:VAR MV7593 :ISA SHARE :OBJECT MV7581 :PARTICIPANT MV7592 :PRESENT
    "PRESENT" :RAW-TEXT "shared")
  ...
  ("What transcription factors are shared by CXCL8 and CXCL10?"
   (:VAR MV7604 :ISA SHARE :OBJECT MV7595 :PARTICIPANT MV7603 :PRESENT
    "PRESENT" :RAW-TEXT "shared")
  ...
  ("What mechanisms can I ask about?"
   (:VAR MV7642 :ISA ASK :PATIENT MV7635 :MODAL MV7636 :AGENT MV7637 :PRESENT
    "PRESENT")
   (:VAR MV7635 :ISA BIO-MECHANISM :HAS-DETERMINER "WHAT")
   (:VAR MV7636 :ISA CAN) (:VAR MV7637 :ISA INTERLOCUTOR :NAME "speaker"))
  ...
  ("Do any of these regulate IL2?"
   ...
   (:VAR MV7688 :ISA PROTEIN :RAW-TEXT "IL2" :UID "UP:P60568" :NAME
    "IL2_HUMAN"))
  ...
  ("What are the targets of NG25?"
   ...
   (:VAR MV7705 :ISA WHAT)
   (:VAR MV7708 :ISA TARGET-PROTEIN :AGENT MV7704 :HAS-DETERMINER "THE"
    :RAW-TEXT "targets")
  ...
  ("Tofacitinib inhibits JAK1 and active STAT3 transcribes IL2."
   (:VAR MV7768 :ISA INHIBIT :AGENT MV7767 :OBJECT MV7772 :PRESENT "PRESENT"
    :RAW-TEXT "inhibits")
   (:VAR MV7767 :ISA DRUG :RAW-TEXT "Tofacitinib" :NAME "tasocitinib" :UID
    "NCIT:C95800")
   (:VAR MV7772 :ISA COLLECTION :RAW-TEXT "JAK1 and active STAT3" :TYPE PROTEIN
    :NUMBER 2 :ITEMS (MV7764 MV7765))
   (:VAR MV7764 :ISA PROTEIN :RAW-TEXT "JAK1" :UID "UP:P23458" :NAME
    "JAK1_HUMAN")
   (:VAR MV7765 :ISA PROTEIN :PREDICATION MV7770 :RAW-TEXT "STAT3" :UID
    "UP:P40763" :NAME "STAT3_HUMAN")
   (:VAR MV7770 :ISA ACTIVE))
  ("JAK1 activates STAT3"
   (:VAR MV7775 :ISA BIO-ACTIVATE :AGENT MV7773 :OBJECT MV7774 :PRESENT
    "PRESENT" :RAW-TEXT "activates")
  ...
  ("I want to find out how Jak1 activates IL2"
   ...
   (:VAR MV7787 :ISA BIO-ACTIVATE :AGENT MV7776 :OBJECT MV7777 :PRESENT
    "PRESENT" :RAW-TEXT "activates")
   (:VAR MV7776 :ISA PROTEIN :RAW-TEXT "Jak1" :UID "UP:P23458" :NAME
    "JAK1_HUMAN")
   (:VAR MV7777 :ISA PROTEIN :RAW-TEXT "IL2" :UID "UP:P60568" :NAME
    "IL2_HUMAN"))
  ("I want to find out how ERBB3 activates JUN in SKBR3 cells."
   ...
   (:VAR MV7803 :ISA BIO-ACTIVATE :AGENT MV7792 :OBJECT MV7804 :PRESENT
    "PRESENT" :RAW-TEXT "activates")
  ...
  ("Mek phosphorylates MAPK; MapK phosphorylates RSK"
   (:VAR MV7818 :ISA PHOSPHORYLATE :AGENT MV7817 :SUBSTRATE MV7819 :PRESENT
    "PRESENT" :RAW-TEXT "phosphorylates")
   (:VAR MV7817 :ISA PROTEIN-FAMILY :RAW-TEXT "Mek" :NAME "MEK" :COUNT 2
    :FAMILY-MEMBERS
    ((PROTEIN (:NAME "MP2K2_HUMAN") (:UID "UP:P36507"))
     (PROTEIN (:NAME "MP2K1_HUMAN") (:UID "UP:Q02750")))
    :UID "FPLX:MEK")
   (:VAR MV7819 :ISA PROTEIN-FAMILY :RAW-TEXT "MAPK" :NAME
    "mitogen activated protein kinase" :COUNT 13 :FAMILY-MEMBERS
    ((PROTEIN (:NAME "MK15_HUMAN") (:UID "UP:Q8TD08"))
     (PROTEIN (:NAME "MK06_HUMAN") (:UID "UP:Q16659"))
     (PROTEIN (:NAME "MK14_HUMAN") (:UID "UP:Q16539"))
  ...
  ("What kinases regulate IL2?"
   ...
   (:VAR MV7823 :ISA PROTEIN :RAW-TEXT "IL2" :UID "UP:P60568" :NAME
    "IL2_HUMAN"))
  ("What positively regulates IL2?"
   ...
   (:VAR MV7829 :ISA WHAT)
   (:VAR MV7828 :ISA PROTEIN :RAW-TEXT "IL2" :UID "UP:P60568" :NAME
    "IL2_HUMAN"))
  ("What can have the effect of activation on STAT3?"
   ...
   (:VAR MV7830 :ISA PROTEIN :RAW-TEXT "STAT3" :UID "UP:P40763" :NAME
    "STAT3_HUMAN")
   (:VAR MV7838 :ISA BIO-ACTIVATE :RAW-TEXT "activation")
   (:VAR MV7832 :ISA CAN))
  ...
  ("What are transcription factors that bind the IL15 and IL2 genes?"
   ...
   (:VAR MV7870 :ISA GENE :HAS-DETERMINER "THE" :EXPRESSES MV7871 :RAW-TEXT
    "genes")
   (:VAR MV7871 :ISA COLLECTION :RAW-TEXT "IL15 and IL2" :TYPE PROTEIN :NUMBER
    2 :ITEMS (MV7862 MV7863))
   (:VAR MV7862 :ISA PROTEIN :RAW-TEXT "IL15" :UID "UP:P40933" :NAME
    "IL15_HUMAN")
   (:VAR MV7863 :ISA PROTEIN :RAW-TEXT "IL2" :UID "UP:P60568" :NAME
    "IL2_HUMAN"))
  ("What kinases regulate the IL15 and IL2?"
   ...
   (:VAR MV7872 :ISA PROTEIN :RAW-TEXT "IL15" :UID "UP:P40933" :NAME
    "IL15_HUMAN")
   (:VAR MV7873 :ISA PROTEIN :RAW-TEXT "IL2" :UID "UP:P60568" :NAME
    "IL2_HUMAN"))
  ("What factors from the literature regulate IL15 and IL2?"
   (:VAR MV7883 :ISA FACTOR :HAS-DETERMINER "WHAT"))
  ("What relations in the literature match tofacitinib inhibits IL15?"
   (:VAR MV7893 :ISA RELATION :HAS-DETERMINER "WHAT"))
  ("What is MAP3K7?"
  ...
  ("What relations in the literature match tofacitinib?"
   ...
   (:VAR MV7930 :ISA DRUG :HAS-DETERMINER "THE" :MODIFIER MV7927 :MODIFIER
    MV7929 :RAW-TEXT "tofacitinib" :NAME "tasocitinib" :UID "NCIT:C95800")
   (:VAR MV7927 :ISA LITERATURE) (:VAR MV7929 :ISA MATCH-ENDURANT))
  ("What relations in the literature match STAT3 regulates IL15 ?"
   (:VAR MV7936 :ISA RELATION :HAS-DETERMINER "WHAT"))))
