...
(defparameter *ID-MISMATCH-REDEF* '(("upcase" "ATG16L1" "UP:Q676U5"
                                 ...
                                 #|   ("upcase" "IFNA2" "UP:P01563"
                                    ...
                                    #+ignore("upcase" "IFNAR1" "UP:P17181"
...
(defparameter *ID-AND-CAT-MISMATCH* '(("orig" "ribonuclease" "UP:Q8CAV0"
                                       :OLD-CAT PROTEIN :NEW-CAT PROTEIN-FAMILY
                                       ("ribonuclease" "ONT:PROTEIN-FAMILY" :ID
                                        "GO:0004540" :NAME
                                        "ribonuclease activity"))
                                      ("upcase" "BR1" "UP:P08724" :OLD-CAT
...
(defparameter *NAME-ID-MISMATCHES* '((DRUG "dexamethasone" "PUBCHEM:5743"
                                      :NEWUID "NCIT:C422" :WORD "dexamethason")
                                     (MOLECULE "chloroform" "NCIT:C29815"
...
(defparameter *PLURALS-OF-EXISTING-WORDS* '((BACTERIUM "rhodococci"
                                             "NCIT:C76378" :NAME "rhodococcus")
                                            ...
                                            (ORGANISM "plasmodia" "NCIT:C98268"
                                             :NAME "plasmodium")
                                            (BACTERIUM "peptostreptococci"
                                             "NCIT:C86644" :NAME
                                             "peptostreptococcus")
                                            (BACTERIUM "enterococci"
                                             "NCIT:C76311" :NAME
                                             "enterococcus")
                                            (BIO-ORGAN "cysticerci"
                                             "BTO:0003168" :NAME "cysticercus")
                                            (ORGANISM "cryptococci"
                                             "NCIT:C77184" :NAME
                                             "cryptococcus")
                                            (BACTERIUM "Lactobacilli"
                                             "NCIT:C76352" :NAME
                                             "lactobacillus")
                                            (BACTERIUM "Bifidobacteria"
                                             "NCIT:C86194" :NAME
                                             "bifidobacterium")))

(defparameter *DIFF-POS-OF-EXISTING-WORDS* 'NIL)

(defparameter *SYNONYM-FOR-EXISTING-WORDS* '((DISEASE "pneumothoraces"
                                              "NCIT:C38006" "pneumothorax")
                                             (CELL-TYPE "haemocytoblast"
                                              "BTO:0000125" "blast cell")
                                             (VIRUS "HHV3" "NCIT:C71091"
                                              "varicella zoster virus")
                                             (MOLECULE "Ch4" "CHEBI:16183"
                                              "methane")
                                             (VIRUS "DENV3" "NCIT:C112268"
                                              "dengue virus 3")
                                             (VIRUS "DENV4" "NCIT:C112269"
                                              "dengue virus 4")
                                             (VIRUS "EVD68" "NCIT:C125639"
                                              "enterovirus D68")
                                             (VIRUS "HPIV1" "NCIT:C14254"
                                              "human parainfluenza virus 1")
                                             (CELL-LINE "Neuro2a" "CVCL:0470"
                                              "Neuro-2a")
                                             (CELL-LINE "PK15" "CVCL:2160"
                                              "PK-15")
                                             (BIO-METHOD "RTqPCR" "NCIT:C18136"
                                              "reverse transcriptase-polymerase chain reaction")
                                             (VIRUS "Morbillivus" "NCIT:C14309"
                                              "morbillivirus")
                                             (VIRUS "Morbilivirus"
                                              "NCIT:C14309" "morbillivirus")
                                             (DRUG "Lipofectatimine"
                                              "MESH:C086724" "Lipofectamine")
                                             (BACTERIUM "Lisleria"
                                              "NCIT:C76359" "listeria")
                                             (DISEASE "Inflenza" "EFO:0007328"
                                              "influenza")
                                             (BACTERIUM "Heficobacter"
                                              "NCIT:C14296" "helicobacter")
                                             (VIRUS "Flaviriridae"
                                              "NCIT:C113201" "flaviviridae")
                                             (BACTERIUM "Eseherichia"
                                              "NCIT:C77208" "escherichia")
                                             (DRUG "Daunorubicine"
                                              "NCIT:C62091" "daunorubicin")
                                             (ORGANISM "Crysptosporidium"
                                              "NCIT:C77214" "cryptosporidium")
                                             (ORGANISM "Cryptosporidiurn"
                                              "NCIT:C77214" "cryptosporidium")
                                             (ORGANISM "Cryprosporidiurn"
                                              "NCIT:C77214" "cryptosporidium")
                                             (ORGANISM "Cryprosporidium"
                                              "NCIT:C77214" "cryptosporidium")
                                             (BACTERIUM "Corynybacterium"
                                              "NCIT:C76308" "corynebacterium")
                                             (BACTERIUM "Coriobacteriacaee"
                                              "NCIT:C85927"
                                              "coriobacteriaceae")
                                             (VIRUS "Apthovirus" "NCIT:C112229"
                                              "aphthovirus")
                                             (DISEASE "Agammaglobuliniemia"
                                              "ORPHANET:183669"
                                              "Agammaglobulinemia")
                                             (VIRUS "oliovirus" "NCIT:C14259"
                                              "poliovirus")
                                             (MOLECULE "oliognucleotides"
                                              "CHEBI:7754" "oligonucleotide")
                                             (MOLECULE "oligonucteotide"
                                              "CHEBI:7754" "oligonucleotide")
                                             (VIRUS "metapnemovirus"
                                              "NCIT:C125956" "metapneumovirus")
                                             (DRUG "lipoplysaccharide"
                                              "NCIT:C101788"
                                              "lipopolysaccharide")
                                             (DISEASE "keratitits"
                                              "NCIT:C26805" "keratitis")
                                             (MOLECULE "isothiocynate"
                                              "CHEBI:52221" "isothiocyanate")
                                             (DISEASE "immunodeficieny"
                                              "NCIT:C3131"
                                              "immunodeficiency syndrome")
                                             (DISEASE "hyponatriemia"
                                              "HP:0002902" "Hyponatremia")
                                             (DRUG "hydroxycholorquine"
                                              "NCIT:C557" "hydroxychloroquine")
                                             (DRUG "hydroxycholoroquine"
                                              "NCIT:C557" "hydroxychloroquine")
                                             (MOLECULE "flouoride"
                                              "CHEBI:17051" "fluoride")
                                             (MOLECULE "floride" "CHEBI:17051"
                                              "fluoride")
                                             (DISEASE "endopthalmitis"
                                              "NCIT:C34586" "endophthalmitis")
                                             (MOLECULE "disufide" "CHEBI:48343"
                                              "disulfide")
                                             (MOLECULE "dichlormethane"
                                              "CHEBI:15767" "dichloromethane")
                                             (DRUG "dexmedetomidime"
                                              "NCIT:C47479" "dexmedetomidine")
                                             (DRUG "dexamethason" "NCIT:C422"
                                              "dexamethasone")
                                             (DRUG "delaverdine" "NCIT:C65366"
                                              "delavirdine")
                                             (DRUG "cyclophophamide"
                                              "NCIT:C405" "cyclophosphamide")
                                             (DISEASE "rhinosinusitus"
                                              "NCIT:C128434" "rhinosinusitis")
                                             (VIRUS "rinovirus" "NCIT:C77200"
                                              "rhinovirus")
                                             (DISEASE "varicelle" "EFO:0007204"
                                              "chickenpox")
                                             (DRUG "telaprivir" "NCIT:C81603"
                                              "telaprevir")
                                             (MOLECULE "sulphone" "CHEBI:35850"
                                              "sulfone")
                                             (MOLECULE "sulphonamide"
                                              "CHEBI:35358" "sulfonamide")
                                             (BACTERIUM "Streptococus"
                                              "NCIT:C76383" "streptococcus")
                                             (BACTERIUM "Staphilococcus"
                                              "NCIT:C62583" "staphylococcus")
                                             (DRUG "Remedesivir" "NCIT:C152185"
                                              "remdesivir")
                                             (CELL-LINE "AH1" "CVCL:L878"
                                              "GMK-AH-1")
...
(defparameter *CATEGORY-MISMATCH-EXISTING-WORDS* '((:ORIG-CAT TISSUE :NEW-CAT
                                                    CELL-TYPE :NAME
                                                    "endothelial cell" :NEWUID
                                                    "CO:0000115" :WORD
                                                    "endotheliocyte")
...
(defparameter *SUPPRESSED-REDEFS* '(("decarboxylase"
                                     ("decarboxylase" "ONT:PROTEIN-FAMILY" :ID
                                      "GO:0016831" :NAME
