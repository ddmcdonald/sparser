...
(defparameter *ID-AND-CAT-MISMATCH* '(("upcase" "ATO" "UP:P48987" :OLD-CAT
                                      ...
                                      ("upcase" "CAL" "UP:Q9HD26" :OLD-CAT
                                       ...
                                       ("cal" "ONT:CELL-LINE" :ID "CVCL:E514"
                                        :NAME "CAL"))
                                      ("upcase" "CBS" "UP:P35520" :OLD-CAT
                                       PROTEIN :NEW-CAT CELL-LINE
                                       ("cbs" "ONT:CELL-LINE" :ID "CVCL:D298"
                                        :NAME "CBS"))
                                      ("upcase" "CCMB" "UP:P93280" :OLD-CAT
                                       PROTEIN :NEW-CAT PROTEIN-FAMILY
                                       ("ccmb" "ONT:PROTEIN-FAMILY" :ID
                                        "XFAM:PF03379" :NAME "CcmB"))
                                      ("upcase" "COI" "UP:P00395" :OLD-CAT
                                       PROTEIN :NEW-CAT PROTEIN-FAMILY
                                      ...
                                      ("orig" "gonad" "NCIT:C12725" :OLD-CAT
                                       ...
                                       ("gonad" "ONT:CELL-LINE" :ID "CVCL:WY78"
                                        :NAME "GON"))
                                      ("upcase" "IGB" "UP:P40259" :OLD-CAT
                                       PROTEIN :NEW-CAT PROTEIN-FAMILY
                                       ("igb" "ONT:GENE" :ID "NCIT:C97425"
                                        :NAME "CD79B"))
                                      ("upcase" "LAT" "UP:O43561" :OLD-CAT
                                       PROTEIN :NEW-CAT CELL-LINE
                                       ("lat" "ONT:CELL-LINE" :ID "CVCL:2101"
                                        :NAME "LAT"))
                                      ("upcase" "LCF" "UP:Q14005" :OLD-CAT
                                       PROTEIN :NEW-CAT CELL-LINE
                                       ("lcf" "ONT:CELL-LINE" :ID "CVCL:S938"
                                        :NAME "LCF"))
                                      ("upcase" "REG" "UP:P05451" :OLD-CAT
                                       PROTEIN :NEW-CAT PROTEIN-FAMILY
...
(defparameter *NAME-ID-MISMATCHES* '((CELL-LINE "CCRF-CEM" "NCIT:C117114"
                                     ...
                                     (VIRUS "epstein-barr virus" "TI:10376"
                                     ...
                                     (PROTEIN-DOMAIN "RTC" "XFAM:PF01137.19"
                                      :NEWUID "XFAM:PF01137" :WORD "RCT")
                                     (PROTEIN-DOMAIN "furin-like"
