...
;(define-protein "UP:Q90977" nil) ;chicken
...
;(define-protein "UP:P22387" ("ET1")) ;mouse
...
;(define-protein "UP:P83099" nil) dros
...
;; iffy all the ones after the first are endogenous retrovirus proteinases
...
;(define-protein "UP:Q6TJY3" ("Ribosomal protein S6 kinase beta-1" "p70S6K1" "p70S6k1")) ;bovine
...
;(define-protein "UP:Q28260" ("VCAM1")) ;canlf
...
;;(define-protein "UP:P0CY46" nil) ;apime
...
;UP:Q5R3F8 not really fibronectin
...
;(define-protein "UP:P0CA05" nil) ;swine flu
