...
(define-mixin-category conjecture-29.5-2
  ...
  :realization (:VERB ("feel") (:S AGENT :SENTENTIAL THEME)))
...
(define-mixin-category long-32.2
  ...
  :binds ((SPARSER::INSTRUMENT OBJECT))
  :realization (:VERB NIL (:S INSTRUMENT :SC_TO_INF THEME)))
...
(define-mixin-category require-103-2
  ...
  :realization (:VERB ("need") (:S THEME :SC_TO_INF PREDICATE)))
...
(define-mixin-category see-30.1
  ...
  :binds ((SPARSER::EXPERIENCER PHYSICAL-AGENT))
  :realization (:VERB ("tell") (:S EXPERIENCER :THAT_COMP STIMULUS)))
...
(define-mixin-category seem-109-1
  ...
  :realization (:VERB ("act") (:S THEME :SENTENTIAL ATTRIBUTE)))
...
(define-mixin-category succeed-74-3-1-1
  ...
  :realization (:VERB ("fail") (:S AGENT :SC_TO_INF THEME) (:S AGENT :IN THEME)))
