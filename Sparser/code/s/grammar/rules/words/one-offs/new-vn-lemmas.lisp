...
(define-mixin-category swarm-47.5.1-2
  ...
  :realization (:verb ("throng") (:definite theme :l location)
                (:s theme :l location)))
...
(define-mixin-category sound_existence-47.4
  ...
  :realization (:verb
                ...
                (:s location :with theme) (:s location :o theme)
                (:definite theme) (:s theme :l location) (:s theme)))
...
(define-mixin-category slide-11.2
  ...
  :realization (:verb ("pull" "scoot" "move")
                ...
                (:s theme :to destination) (:s theme)))
...
(define-mixin-category mine-10.9
  ...
  :binds ((sparser::destination location) (sparser::source location)
          ...
          (sparser::agent (:or physical-agent company)))
  :realization (:verb ("quarry" "mine") (:s agent :o theme)))
...
(define-mixin-category leave-51.2
  ...
  :realization (:verb ("abandon") (:s theme :o source)))
...
(define-mixin-category exist-47.1-1
  ...
  :realization (:verb ("survive" "live" "endure") (:s theme)
                (:s theme :o cause)))
...
(define-mixin-category linger-53.1
  ...
  :realization (:verb
                ("tarry" "putter" "procrastinate" "potter" "pause" "loiter"
                 ...
                 "dally")
                (:s agent :over theme) (:s agent :l location)))
...
(define-mixin-category swarm-47.5.1-1
  ...
  :realization (:verb
                ("pullulate" "teem" "swim" "swarm" "hop" "creep" "crawl"
                 "bustle")
                (:s location :with theme) (:s location :o theme)
                (:definite theme :l location) (:s theme :l location)))
...
(define-mixin-category eat-39.1-2
  ...
  :realization (:verb ("drink") (:s agent) (:s agent :o patient)))
...
(define-mixin-category nonvehicle-51.4.2
  ...
  :realization (:verb ("row" "ride" "pedal" "paddle" "oar")
                (:s agent :l location) (:s agent :o theme) (:s agent)))
...
(define-mixin-category light_emission-43.1
  ...
  :realization (:verb
                ...
                (:s agent :o theme) (:s location :o theme)
                (:o theme :l location) (:s location :with theme)
                (:s theme :l location) (:s theme)))
...
(define-mixin-category concealment-16-1
  ...
  :realization (:verb ("hide") (:s agent :l location)
...
(define-mixin-category orbit-51.9.2
  ...
  :binds ((sparser::instrument object))
  :realization (:verb ("twirl" "rotate" "revolve" "orbit") (:s theme)))
...
(define-mixin-category clear-10.3-1
  ...
  :realization (:verb ("empty" "drain" "clear") (:s theme) (:s source)))
...
(define-mixin-category concealment-16
  ...
  :realization (:verb
                ("suppress" "shelter" "sequester" "seclude" "screen" "repress"
                 ...
                 "cloister" "block")
                (:s agent :o patient) (:s agent :o patient :l location)
...
(define-mixin-category chase-51.6
  ...
  :realization (:verb
                ...
                (:s agent :after theme) (:s agent :o theme)))
...
(define-mixin-category vehicle-51.4.1
  ...
  :realization (:verb
                ...
                (:s agent :io theme :o result) (:s agent :o theme) (:s theme)))
...
(define-mixin-category funnel-9.3
  ...
  :realization (:verb
                ("channelize" "sop" "siphon" "scoop" "hoe" "ladle" "dunk"
                 "dip")
                (:s agent :o theme) (:s agent :io theme :adv_loc destination)))
...
(define-mixin-category put_direction-9.4
  ...
  :realization (:verb
                ("back" "raise" "lower" "lift" "hoist" "heel" "elevate" "drive"
                 "drop")
                (:s agent :io theme :adv_loc destination) (:s agent :o theme)))
...
(define-mixin-category coil-9.6
  ...
  :realization (:verb
                ...
                (:s theme :m adverb) (:s theme) (:s agent :o theme)))
...
(define-mixin-category substance_emission-43.4-1
  ...
  :realization (:verb
                ("trickle" "sweat" "stream" "steam" "squirt" "spurt" "sprout"
                 ...
                 "bead")
                (:s theme) (:o source :l location) (:s location :o source)
                (:s location :with theme) (:s theme :l location)
...
(define-mixin-category rob-10.6.4
  ...
  :realization (:verb ("cull" "milk" "strip" "bleed" "rob")
                (:s agent :o theme :for beneficiary) (:s agent :o theme)))
...
(define-mixin-category wink-40.3.1
  ...
  :realization (:verb
                ("wink" "wave" "squint" "shrug" "point" "nod" "gesture" "clap"
                 "blink" "beckon")
                (:s agent :o theme) (:s agent :in theme) (:s agent)
...
(define-mixin-category ferret-35.6
  ...
  :binds ((sparser::agent physical-agent))
  :realization (:verb ("tease" "nose" "ferret") (:s agent :o theme)))
...
(define-mixin-category spank-18.3
  ...
  :realization (:verb
                ...
                (:s agent :o patient)
                (:s agent :o patient :l location :with instrument)
                (:s agent :o patient :l location)
...
(define-mixin-category body_motion-49.2-1
  ...
  :realization (:verb ("extend") (:s agent :io path :o theme) (:s agent)
                (:s agent :o goal) (:s agent :io theme :o goal)))
...
(define-mixin-category hunt-35.1
  ...
  :realization (:verb
                ("seek" "scrounge" "poach" "pan" "mine" "hunt" "fish" "feel"
                 "dig")
                (:s agent) (:s agent :o theme) (:s agent :o theme :l location)
                (:s agent :l location :for theme)
                (:s agent :for theme :l location)))
...
(define-mixin-category keep-15.2
  ...
  :realization (:verb
                ...
                (:s agent :o theme) (:s agent :o theme :l location)))
...
(define-mixin-category attend-107.4-2
  ...
  :realization (:verb ("belong" "go") (:s theme)))
...
(define-mixin-category spray-9.7-1
  ...
  :realization (:verb
                ("wrap" "spurt" "swash" "swab" "string" "strew" "stick"
                 ...
                 "brush" "baste")
                (:s agent :io theme :o destination) (:s theme)))
...
(define-mixin-category nonverbal_expression-40.2
  ...
  :realization (:verb
                ("hem" "yawn" "whistle" "weep" "titter" "sob" "snort" "snore"
                 ...
                 "beam")
                (:s agent) (:s agent :in theme) (:s agent :o theme)))
...
(define-mixin-category manner_speaking-37.3
  ...
  :realization (:verb
                ...
                (:s agent :o recipient :oc_to_inf topic)
                (:s agent :o recipient :wh_inf topic)
                (:s agent :o recipient :thatcomp topic)
                (:s agent :ac_to_inf topic) (:s agent :wh_inf topic)
                (:s agent :thatcomp topic) (:s agent :o topic)
                (:s agent :about topic) (:s agent)))
...
(define-mixin-category sound_emission-43.2
  ...
  :realization (:verb
                ...
                (:s agent :o theme) (:o theme :l location)
                (:s location :o theme) (:s location :with theme)
                (:s theme :l location) (:s theme)))
...
(define-mixin-category run-51.3.2
  ...
  :realization (:verb
                ...
                (:s source :o theme) (:definite theme :o source)
                (:o source :definite theme) (:s theme)
                (:s theme :to destination :towards destination)))
...
(define-mixin-category crane-40.3.2
  ...
  :realization (:verb
                ("wrinkle" "wring" "wiggle" "waggle" "wag" "twitch" "twiddle"
                 ...
                 "arch")
                (:s agent :o patient :in topic) (:s agent :o patient)))
...
(define-mixin-category meander-47.7
  ...
  :realization (:verb
                ...
                (:o theme :l location) (:l location :o theme)
                (:s location :o theme) (:s theme :l location)))
...
(define-mixin-category escape-51.1
  ...
  :realization (:verb (("make" :prep "it") "get" "cut") (:s theme)))
...
(define-mixin-category rummage-35.5
  ...
  :realization (:verb
                ("scratch" "scrabble" "poke" "page" "look" "listen" "leaf" "go"
                 "fumble" "burrow" "bore")
                (:s agent :l location :for theme) (:s agent :l location)))
...
(define-mixin-category spatial_configuration-47.6
  ...
  :realization (:verb
                ("yaw" "tower" "swag" "stoop" "squat" "suspend" "slump"
                 ...
                 "hover" "crouch" "bow")
                (:s location :o theme) (:l location :definite theme)
                (:s theme :l location) (:s theme)))
...
(define-mixin-category modes_of_being_with_motion-47.3
  ...
  :realization (:verb
                ("roil" "writhe" "worm" "wobble" "wiggle" "waver" "wave" "waft"
                 ...
                 "bob")
                (:s agent :o theme) (:s location :o theme) (:definite theme)
                (:s theme :l location) (:s theme)))
