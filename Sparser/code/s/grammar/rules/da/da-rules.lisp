...
(defparameter *unreliable-da-rules*
  (list
   ...
   (da-rule-named 'attach-trailing-participle-to-clause-with-comma)
   (da-rule-named 'adjunctive-pp-on-transitive-clause-without-object)
   (da-rule-named 'adjunctive-pp-on-vp)
   (da-rule-named 'np-conj-pp)
   (da-rule-named 'np-adjective)
   (da-rule-named 'pp-comma-subj-relative)
   (da-rule-named 'ps-comma-subj-relative)
   (da-rule-named 'pp-comma-obj-relative)
   (da-rule-named 'pp-vg+ed)
   (da-rule-named 's-with-np-conj-pp)
   (da-rule-named 's-comma-subj-relative)
   (da-rule-named 's-with-np-conj-pp)
